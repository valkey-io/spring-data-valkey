...
/**
        ...
        public ValkeyGlideClientConfigurationBuilder useOpenTelemetry(
            @Nullable OpenTelemetryConfiguration openTelemetryConfig
        ) {
            if (openTelemetryConfig == null) {
                return this;
            }

            String tracesEndpoint = openTelemetryConfig.tracesEndpoint();
            String metricsEndpoint = openTelemetryConfig.metricsEndpoint();
            Integer samplePercentage = openTelemetryConfig.samplePercentage();
            Long flushIntervalMs = openTelemetryConfig.flushIntervalMs();
