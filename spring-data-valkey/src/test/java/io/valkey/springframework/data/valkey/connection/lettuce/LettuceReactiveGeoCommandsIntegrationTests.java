...
public class LettuceReactiveGeoCommandsIntegrationTests extends LettuceReactiveCommandsTestSupport {
    ...
    void geoAddShouldAddMultipleGeoLocationsCorrectly() {
        assertThat(
                        connection
                                .geoCommands()
                                .geoAdd(KEY_1_BBUFFER, Arrays.asList(ARIGENTO, CATANIA, PALERMO))
                                .block())
                .isEqualTo(3L);
    }
    ...
    void geoDistShouldReturnDistanceInMetersByDefault() {
        ...
        nativeCommands.geoadd(
                KEY_1, PALERMO.getPoint().getX(), PALERMO.getPoint().getY(), PALERMO_MEMBER_NAME);
        nativeCommands.geoadd(
                KEY_1, CATANIA.getPoint().getX(), CATANIA.getPoint().getY(), CATANIA_MEMBER_NAME);

        assertThat(
                        connection
                                .geoCommands()
                                .geoDist(KEY_1_BBUFFER, PALERMO.getName(), CATANIA.getName())
                                .block()
                                .getValue())
    ...
    void geoDistShouldReturnDistanceInDesiredMetric() {
        ...
        assertThat(
                        connection
                                .geoCommands()
                                .geoDist(KEY_1_BBUFFER, PALERMO.getName(), CATANIA.getName(), Metrics.KILOMETERS)
                                .block()
                                .getValue())
                .isCloseTo(166.27415156960033D, offset(0.005));
    }
    ...
    void geoHash() {
        ...
        assertThat(
                        connection
                                .geoCommands()
                                .geoHash(KEY_1_BBUFFER, Arrays.asList(PALERMO.getName(), CATANIA.getName()))
                                .block())
    ...
    void geoHashNotExisting() {
        ...
        assertThat(
                        connection
                                ...
                                .geoHash(
                                        KEY_1_BBUFFER,
                                        Arrays.asList(PALERMO.getName(), ARIGENTO.getName(), CATANIA.getName()))
                                .block())
    ...
    void geoPos() {
        ...
        List<Point> result =
                connection
                        .geoCommands()
                        .geoPos(KEY_1_BBUFFER, Arrays.asList(PALERMO.getName(), CATANIA.getName()))
                        .block();
    ...
    void geoRadiusShouldReturnMembersCorrectly() {
        ...
        nativeCommands.geoadd(
                KEY_1, CATANIA.getPoint().getX(), CATANIA.getPoint().getY(), CATANIA_MEMBER_NAME);
        nativeCommands.geoadd(
                KEY_1, ARIGENTO.getPoint().getX(), ARIGENTO.getPoint().getY(), ARIGENTO_MEMBER_NAME);
        ...
        connection
                .geoCommands()
                .geoRadius(KEY_1_BBUFFER, new Circle(new Point(15D, 37D), new Distance(150D, KILOMETERS)))
                .as(StepVerifier::create) //
                .expectNextCount(2) //
                .expectComplete();
    }
    ...
    void geoRadiusByMemberShouldReturnMembersCorrectly() {
        ...
        connection
                .geoCommands()
                .geoRadiusByMember(KEY_1_BBUFFER, ARIGENTO.getName(), new Distance(100, KILOMETERS))
                .as(StepVerifier::create) //
                .consumeNextWith(
                        actual -> {
    ...
    void geoSearchShouldReturnMembersCorrectly() {
        ...
        connection
                ...
                .geoSearch(
                        KEY_1_BBUFFER,
                        GeoReference.fromMember(PALERMO.getName()),
    ...
    void geoSearchStoreShouldStoreMembersCorrectly() {
        ...
        nativeCommands.geoadd(
                SAME_SLOT_KEY_1, PALERMO.getPoint().getX(), PALERMO.getPoint().getY(), PALERMO_MEMBER_NAME);
        nativeCommands.geoadd(
                SAME_SLOT_KEY_1, CATANIA.getPoint().getX(), CATANIA.getPoint().getY(), CATANIA_MEMBER_NAME);
        nativeCommands.geoadd(
                SAME_SLOT_KEY_1,
                ARIGENTO.getPoint().getX(),
                ARIGENTO.getPoint().getY(),
