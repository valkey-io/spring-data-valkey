...
public class DefaultHashOperationsIntegrationTests<K, HK, HV> {
	...
	void testBoundHashOperationsGetAndExpire() {
		...
		BoundHashOperations<K, HK, HV> boundHashOps = valkeyTemplate.boundHashOps(key);
	...
	void testGetAndDelete() {
		...
		assertThat(valkeyTemplate.hasKey(keyForDeletion)).isTrue(); // Key should exist
		...
		assertThat(valkeyTemplate.hasKey(keyForDeletion)).isFalse(); // Key should be deleted when last field is removed
	}
	...
	void testPutAndExpire() {
		...
		Boolean result1 = hashOps.putAndExpire(key, fieldMap1, ValkeyHashCommands.HashFieldSetOption.upsert(),
		...
		Boolean result2 = hashOps.putAndExpire(key, fieldMap2, ValkeyHashCommands.HashFieldSetOption.ifNoneExist(),
		...
		Boolean result3 = hashOps.putAndExpire(key, fieldMap3, ValkeyHashCommands.HashFieldSetOption.ifAllExist(),
		...
		Boolean result4 = hashOps.putAndExpire(key, fieldMap4, ValkeyHashCommands.HashFieldSetOption.ifAllExist(),
				Expiration.seconds(60));
	...
	void testBoundHashOperationsPutAndExpire() {
		...
		// Test UPSERT condition - should always set fields
		Map<HK, HV> fieldMap1 = Map.of(key1, val1, key2, val2);
		boundHashOps.putAndExpire(fieldMap1, ValkeyHashCommands.HashFieldSetOption.upsert(), Expiration.seconds(60));
		...
		// Test IF_NONE_EXIST condition - should not change existing fields
		Map<HK, HV> fieldMap2 = Map.of(key1, val3, key3, val3);
		boundHashOps.putAndExpire(fieldMap2, ValkeyHashCommands.HashFieldSetOption.ifNoneExist(), Expiration.seconds(120));
		...
		// Test IF_ALL_EXIST condition - should succeed because all fields exist
		Map<HK, HV> fieldMap3 = Map.of(key1, val3, key2, val3);
		boundHashOps.putAndExpire(fieldMap3, ValkeyHashCommands.HashFieldSetOption.ifAllExist(), Expiration.seconds(180));
		...
		HK nonExistentKey = hashKeyFactory.instance();
		Map<HK, HV> fieldMap4 = Map.of(key1, val1, nonExistentKey, val1);
		boundHashOps.putAndExpire(fieldMap4, ValkeyHashCommands.HashFieldSetOption.ifAllExist(), Expiration.seconds(60));
	...
	void testPutAndExpireWithDifferentExpirationPolicies() {
		...
		Boolean result2 = hashOps.putAndExpire(key, fieldMap2, ValkeyHashCommands.HashFieldSetOption.upsert(),
		...
		Boolean result3 = hashOps.putAndExpire(key, fieldMap3, ValkeyHashCommands.HashFieldSetOption.upsert(),
		...
		Boolean result4 = hashOps.putAndExpire(key, fieldMap4, ValkeyHashCommands.HashFieldSetOption.upsert(),
		...
		Boolean result5 = hashOps.putAndExpire(key, fieldMap5, ValkeyHashCommands.HashFieldSetOption.upsert(),
				Expiration.keepTtl());
