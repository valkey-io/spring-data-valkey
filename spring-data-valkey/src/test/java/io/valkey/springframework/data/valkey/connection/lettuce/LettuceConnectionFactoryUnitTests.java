...
class LettuceConnectionFactoryUnitTests {
    ...
    void shouldInitClientCorrectlyWhenClusterConfigPresent() {
        ...
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(
                        clusterConfig, LettuceTestClientConfiguration.defaultConfiguration());
    ...
    void portShouldBeReturnedProperlyBasedOnConfiguration() {
        ...
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(
                        valkeyConfiguration, LettuceTestClientConfiguration.defaultConfiguration());
    ...
    void credentialsProviderShouldBeSetCorrectlyOnClusterClient() {
        ...
        LettuceClientConfiguration clientConfiguration =
                LettuceTestClientConfiguration.builder()
                        .valkeyCredentialsProviderFactory(new ValkeyCredentialsProviderFactory() {})
                        .build();
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(clusterConfig, clientConfiguration);
        connectionFactory.afterPropertiesSet();
        ConnectionFactoryTracker.add(connectionFactory);
    ...
    void credentialsProviderShouldBeSetCorrectlyOnStandaloneClient() {
        ...
        LettuceClientConfiguration clientConfiguration =
                LettuceTestClientConfiguration.builder()
                        ...
                        .build();
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(config, clientConfiguration);
        connectionFactory.afterPropertiesSet();
        ConnectionFactoryTracker.add(connectionFactory);
    ...
    void sentinelPasswordShouldBeSetOnSentinelClient() {
        ...
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(config, LettuceTestClientConfiguration.defaultConfiguration());
        connectionFactory.setPassword("o_O");
        connectionFactory.afterPropertiesSet();
        ConnectionFactoryTracker.add(connectionFactory);
    ...
    void sslOptionsShouldBeDisabledByDefaultOnClient() {
        ...
        assertThat(
                connectionFactory.getClientConfiguration().getVerifyMode().equals(SslVerifyMode.FULL));
    }
    ...
    void verifyPeerOptionShouldBeSetCorrectlyOnClient() {
        ...
        assertThat(
                connectionFactory.getClientConfiguration().getVerifyMode().equals(SslVerifyMode.NONE));
    }
    ...
    void sslShouldBeSetCorrectlyOnSentinelClient() {
        ...
        ValkeySentinelConfiguration sentinelConfiguration =
                new ValkeySentinelConfiguration("myMaster", Collections.singleton("localhost:1234"));
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(
    ...
    void socketShouldBeSetOnStandaloneClient() {
        ...
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(
                        new ValkeySocketConfiguration(), LettuceTestClientConfiguration.defaultConfiguration());
        connectionFactory.afterPropertiesSet();
        ConnectionFactoryTracker.add(connectionFactory);
    ...
    void shouldReadStandalonePassword() {
        ...
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(
                        envConfig, LettuceTestClientConfiguration.defaultConfiguration());
    ...
    void shouldApplyClientConfiguration() {
        ...
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(new ValkeyStandaloneConfiguration(), configuration);
    ...
    void shouldReturnStandaloneConfiguration() {
        ...
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(
                        configuration, LettuceTestClientConfiguration.defaultConfiguration());
    ...
    void shouldShareNativeConnectionWithCluster() {
        ...
        StatefulRedisClusterConnection<byte[], byte[]> connectionMock =
    ...
    void shouldValidateSharedClusterConnection() {
        ...
        StatefulRedisClusterConnection<byte[], byte[]> connectionMock =
                mock(StatefulRedisClusterConnection.class);
        RedisAdvancedClusterCommands<byte[], byte[]> syncMock =
    ...
    void shouldTranslateConnectionException() {
        ...
        assertThatExceptionOfType(ValkeyConnectionFailureException.class)
                .isThrownBy(() -> connectionFactory.getConnection().ping())
                .withCauseInstanceOf(PoolException.class);
    }

    @Test // DATAREDIS-1027
    void shouldDisposeConnectionProviders() throws Exception {

        LettuceConnectionProvider connectionProviderMock =
                mock(LettuceConnectionProvider.class, withSettings().extraInterfaces(DisposableBean.class));
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory() {
                    @Override
                    protected LettuceConnectionProvider doCreateConnectionProvider(
    ...
    void databaseShouldBeSetCorrectlyOnSentinelClient() {
        ...
        ValkeySentinelConfiguration valkeySentinelConfiguration =
                new ValkeySentinelConfiguration("mymaster", Collections.singleton("host:1234"));
        valkeySentinelConfiguration.setDatabase(1);
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(
                        valkeySentinelConfiguration, LettuceTestClientConfiguration.defaultConfiguration());
        connectionFactory.setPassword("o_O");
        connectionFactory.afterPropertiesSet();
        ConnectionFactoryTracker.add(connectionFactory);
    ...
    void maxRedirectsShouldBeSetOnClientOptions() {
        ...
        LettuceConnectionFactory connectionFactory =
                new LettuceConnectionFactory(
                        clusterConfiguration, LettuceTestClientConfiguration.builder().build());
        connectionFactory.afterPropertiesSet();
        ConnectionFactoryTracker.add(connectionFactory);
    ...
    void getNativeClientShouldFailIfNotInitialized() {
        ...
        assertThatIllegalStateException()
                .isThrownBy(connectionFactory::getRequiredNativeClient)
    ...
    void createMinimalValkeyStandaloneConfiguration() {
        ...
        ValkeyConfiguration configuration =
                LettuceConnectionFactory.createValkeyConfiguration(redisURI);
    ...
    void createMinimalValkeySocketConfiguration() {
        ...
        ValkeyConfiguration socketConfiguration =
                LettuceConnectionFactory.createValkeyConfiguration(redisURI);
    ...
    void createFullValkeySocketConfiguration() {
        ...
        RedisURI redisURI =
                RedisURI.Builder.socket("mysocket")
    ...
    void createMinimalValkeySentinelConfiguration() {
        ...
        ValkeyConfiguration sentinelConfiguration =
                LettuceConnectionFactory.createValkeyConfiguration(redisURI);
    ...
    void createFullValkeySentinelConfiguration() {
        ...
        RedisURI redisURI =
                RedisURI.create(
                        "redis-sentinel://fooUser:fooPass@myserver1:111,myserver2:222/7?sentinelMasterId=5150");
        // Set the passwords directly on the sentinels so that it gets picked up by converter
        char[] sentinelPass = "changeme".toCharArray();
        redisURI
                .getSentinels()
                .forEach(sentinelValkeyUri -> sentinelValkeyUri.setPassword(sentinelPass));
    ...
    void createValkeyConfigurationWithValidValkeyUriString() {
        ...
        ValkeyConfiguration valkeyConfiguration =
                LettuceConnectionFactory.createValkeyConfiguration("redis://skullbox:6789");

        assertThat(valkeyConfiguration).isInstanceOf(ValkeyStandaloneConfiguration.class);

        assertThat(valkeyConfiguration)
                .asInstanceOf(InstanceOfAssertFactories.type(ValkeyStandaloneConfiguration.class))
                .extracting(ValkeyStandaloneConfiguration::getHostName)
                .isEqualTo("skullbox");

        assertThat(valkeyConfiguration)
                .asInstanceOf(InstanceOfAssertFactories.type(ValkeyStandaloneConfiguration.class))
                .extracting(ValkeyStandaloneConfiguration::getPort)
                .isEqualTo(6789);
    }
