...
/**
 * Unit tests for {@link ValkeyMessageConverters}.
 *
 * @author Mark Paluch
 */
class ValkeyMessageConvertersUnitTests {

	@Test // GH-3357
	void serializesObjectToJson() {

		MessageConverter messageConverter = ValkeyMessageConverters.createMessageConverter();
	...
	void deserializesJsonToObject() {
		...
		String json = "{\"@class\":\"io.valkey.springframework.data.valkey.serializer.ValkeyMessageConvertersUnitTests$Hey\",\"name\":\"Walter\"}";
		MessageHeaders messageHeaders = new MessageHeaders(Map.of(MessageHeaders.CONTENT_TYPE, "application/json"));
