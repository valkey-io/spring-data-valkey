...
/**
 * Comprehensive low-level integration tests for {@link ValkeyGlideConnection} list functionality
 * using the ValkeyListCommands interface directly.
 *
 * <p>These tests validate the implementation of all ValkeyListCommands methods: - Basic list
 * operations (rPush, lPush, rPushX, lPushX) - List position operations (lPos variants) - List size
 * operations (lLen) - List range operations (lRange, lTrim) - List index operations (lIndex, lSet)
 * - List insertion operations (lInsert) - List movement operations (lMove, bLMove) - List removal
 * operations (lRem, lPop, rPop with count variants) - Blocking operations (bLPop, bRPop) - Pop and
 * push operations (rPopLPush, bRPopLPush)
 *
...
public class ValkeyGlideConnectionListCommandsIntegrationTests
    ...
    protected String[] getTestKeyPatterns() {
        return new String[] {
            "test:list:pushpop",
            "test:list:pushx:existing",
            "test:list:pushx:nonexistent",
            "test:list:lpos",
            "test:list:len:range",
            "test:list:trim",
            "test:list:index",
            "test:list:insert",
            "test:list:move:source",
            "test:list:move:dest",
            "test:list:blmove:source",
            "test:list:blmove:dest",
            "test:list:rem",
            "test:list:pop",
            "test:list:blpop:key1",
            "test:list:blpop:key2",
            "test:list:rpoplpush:source",
            "test:list:rpoplpush:dest",
            "test:list:brpoplpush:source",
            "test:list:brpoplpush:dest",
            "test:list:error:string",
            "test:list:empty",
            "test:list:binary",
            "non:existent:key"
        };
    ...
    void testRPushXAndLPushX() {
        ...
        try {
            ...
            Long lPushXResult1 =
                    connection.listCommands().lPushX(existingKey.getBytes(), "newhead".getBytes());
    ...
    void testLInsert() {
        ...
        try {
            ...
            Long insertNonExistent =
                    connection.listCommands().lInsert(keyBytes, Position.BEFORE, value1, beforeValue);
            ...
            // Test lInsert BEFORE
            Long insertBefore =
                    connection.listCommands().lInsert(keyBytes, Position.BEFORE, value2, beforeValue);
            ...
            // Test lInsert AFTER
            Long insertAfter =
                    connection.listCommands().lInsert(keyBytes, Position.AFTER, value2, afterValue);
        ...
        try {
            ...
            byte[] movedValue =
                    connection
                            .listCommands()
                            .bLMove(
                                    sourceKey.getBytes(), destKey.getBytes(), Direction.LEFT, Direction.RIGHT, 1.0);
    ...
    void testBLPopAndBRPop() {
        ...
        try {
            ...
            List<byte[]> blPopResult =
                    connection.listCommands().bLPop(1, key1.getBytes(), key2.getBytes());
            ...
            List<byte[]> brPopResult =
                    connection.listCommands().bRPop(1, key1.getBytes(), key2.getBytes());
    ...
    void testRPopLPush() {
        ...
        try {
            ...
            byte[] nonExistentResult =
                    connection.listCommands().rPopLPush(sourceKey.getBytes(), destKey.getBytes());
    ...
    void testBRPopLPush() {
        ...
        try {
            ...
            byte[] poppedValue =
                    connection.listCommands().bRPopLPush(1, sourceKey.getBytes(), destKey.getBytes());
    ...
    void testListOperationsOnNonListTypes() {
        ...
        try {
            ...
            assertThatThrownBy(
                            () -> connection.listCommands().lPush(stringKey.getBytes(), "value".getBytes()))
    ...
    void testListPositionCommandsInPipelineMode() {
        ...
        try {
            ...
            assertThat(connection.listCommands().lInsert(keyBytes, Position.BEFORE, value2, insertValue))
                    .isNull();
    ...
    void testListMovementCommandsInPipelineMode() {
        ...
        try {
            ...
            assertThat(
                            connection
                                    .listCommands()
                                    .lMove(sourceKeyBytes, destKeyBytes, Direction.LEFT, Direction.RIGHT))
                    .isNull();
    ...
    void testListAdvancedCommandsInPipelineMode() {
        ...
        try {
            ...
            assertThat(
                            connection
                                    .listCommands()
                                    .bLMove(sourceKey1Bytes, destKey1Bytes, Direction.LEFT, Direction.RIGHT, 0.1))
                    .isNull();
