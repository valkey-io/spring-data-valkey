...
public class BoundKeyOperationsIntegrationTests {
    ...
    @SuppressWarnings("rawtypes")
    public BoundKeyOperationsIntegrationTests(
            BoundKeyOperations<Object> keyOps,
            ObjectFactory<Object> objFactory,
    ...
    void testExpire() throws Exception {
        ...
        assertThat(keyOps.getExpire())
                .as(keyOps.getClass().getName() + " -> " + keyOps.getKey())
    ...
    void testPersist() throws Exception {
        ...
        keyOps.persist();
        assertThat(keyOps.getExpire().longValue())
                .as(keyOps.getClass().getName() + " -> " + keyOps.getKey())
                .isEqualTo(-1);
    }
