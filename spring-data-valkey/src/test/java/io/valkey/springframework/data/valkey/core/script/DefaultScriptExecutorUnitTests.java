...
class DefaultScriptExecutorUnitTests {
    ...
    private final DefaultValkeyScript<String> SCRIPT =
            new DefaultValkeyScript<>("return KEYS[0]", String.class);
        ...
        when(valkeyConnectionMock.evalSha(anyString(), any(ReturnType.class), anyInt()))
                .thenThrow(
                        new ValkeySystemException(
                                "NOSCRIPT No matching script; Please use EVAL.", new Exception()));
    ...
    void excuteShouldThrowExceptionInCaseEvalShaFailsWithOtherThanValkeySystemException() {
        ...
        assertThatExceptionOfType(UnsupportedOperationException.class)
                .isThrownBy(() -> executor.execute(SCRIPT, null));
    }
