...
public abstract class ValkeyRepositoryIntegrationTestBase {
    ...
    void simpleFindAndSort() {
        ...
        assertThat(repo.findByLastname("al'vere", Sort.by(Sort.Direction.ASC, "firstname")))
                .containsSequence(egwene, marin);
        assertThat(repo.findByLastname("al'vere", Sort.by(Sort.Direction.DESC, "firstname")))
                .containsSequence(marin, egwene);
    ...
    void simpleFindAllWithSort() {
        ...
        assertThat(repo.findAll(Sort.by(Sort.Direction.ASC, "firstname")))
                .containsSequence(egwene, marin);
        assertThat(repo.findAll(Sort.by(Sort.Direction.DESC, "firstname")))
                .containsSequence(marin, egwene);
    }
    ...
    void nearQueryShouldReturnResultsCorrectly() {
        ...
        List<City> result =
                cityRepo.findByLocationNear(new Point(15D, 37D), new Distance(200, Metrics.KILOMETERS));
        assertThat(result).contains(palermo, catania);

        result =
                cityRepo.findByLocationNear(new Point(15D, 37D), new Distance(100, Metrics.KILOMETERS));
    ...
    void nearQueryShouldFindNothingIfOutOfRange() {
        ...
        List<City> result =
                cityRepo.findByLocationNear(new Point(15D, 37D), new Distance(10, Metrics.KILOMETERS));
    ...
    void nearQueryShouldReturnResultsCorrectlyOnNestedProperty() {
        ...
        List<Person> result =
                repo.findByHometownLocationNear(new Point(15D, 37D), new Distance(200, Metrics.KILOMETERS));
        assertThat(result).contains(p1, p2);

        result =
                repo.findByHometownLocationNear(new Point(15D, 37D), new Distance(100, Metrics.KILOMETERS));
    ...
    void nearQueryShouldConsiderLimit() {
        ...
        Slice<Person> result =
                repo.findByHometownLocationNear(
                        new Point(15D, 37D), new Distance(200, Metrics.KILOMETERS), Pageable.ofSize(1));
    ...
    public static class Person {
        ...
        public int hashCode() {
            return Objects.hash(
                    getId(), getFirstname(), getLastname(), getAlive(), getCity(), getHometown());
        }
    }
    ...
    static final class Immutable {
        ...
        public String toString() {
            ...
            return "ValkeyRepositoryIntegrationTestBase.Immutable(id="
                    + this.getId()
                    + ", name="
                    + this.getName()
                    + ", nested="
