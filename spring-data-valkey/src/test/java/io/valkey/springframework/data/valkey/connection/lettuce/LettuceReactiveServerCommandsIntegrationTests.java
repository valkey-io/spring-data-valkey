 ...
 */
public class LettuceReactiveServerCommandsIntegrationTests
    ...
    void setConfigShouldRespondCorrectly() {
        ...
        if (!(connection instanceof LettuceReactiveValkeyClusterConnection)) {
            ...
            connection
                    .serverCommands()
                    .setConfig("notify-keyspace-events", "") //
                    .as(StepVerifier::create) //
                    .expectNext("OK")
                    .verifyComplete();
