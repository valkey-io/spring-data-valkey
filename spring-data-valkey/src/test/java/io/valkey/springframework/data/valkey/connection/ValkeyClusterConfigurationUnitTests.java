...
class ValkeyClusterConfigurationUnitTests {
    ...
    void shouldCreateValkeyClusterConfigurationCorrectly() {
        ...
        ValkeyClusterConfiguration config =
                new ValkeyClusterConfiguration(Collections.singleton(HOST_AND_PORT_1));
    ...
    void shouldCreateValkeyClusterConfigurationForIPV6Correctly() {
        ...
        ValkeyClusterConfiguration config =
                new ValkeyClusterConfiguration(Collections.singleton("[aaa:bbb:ccc::dd1]:123"));
    ...
    void shouldThrowExceptionWhenListOfHostAndPortIsNull() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> new ValkeyClusterConfiguration(Collections.singleton(null)));
    }
    ...
    void shouldThrowExceptionGivenNullPropertySource() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> ValkeyClusterConfiguration.of((PropertySource<?>) null));
    }
    ...
    void shouldBeCreatedCorrectlyGivenValidPropertySourceWithMultipleIPv6AddressesAndPorts() {
        ...
        propertySource.setProperty(
                "spring.valkey.cluster.nodes",
                StringUtils.collectionToCommaDelimitedString(
                        Arrays.asList(HOST_AND_PORT_4, HOST_AND_PORT_5)));
        ...
        assertThat(configuration.getClusterNodes())
                .contains(
                        new ValkeyNode("fe80::a00:27ff:fe4b:ee48", 6379),
