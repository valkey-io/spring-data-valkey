...
public class LettuceReactiveListCommandIntegrationTests extends LettuceReactiveCommandsTestSupport {
    ...
    void rPushShouldAppendValuesCorrectly() {
        ...
        assertThat(
                        connection
                                .listCommands()
                                .rPush(KEY_1_BBUFFER, Arrays.asList(VALUE_2_BBUFFER, VALUE_3_BBUFFER))
                                .block())
                .isEqualTo(3L);
    ...
    void lPushShouldPrependValuesCorrectly() {
        ...
        assertThat(
                        connection
                                .listCommands()
                                .lPush(KEY_1_BBUFFER, Arrays.asList(VALUE_2_BBUFFER, VALUE_3_BBUFFER))
                                .block())
                .isEqualTo(3L);
    ...
    void rPushXShouldAppendValuesCorrectly() {
        ...
        assertThat(connection.listCommands().rPushX(KEY_1_BBUFFER, VALUE_2_BBUFFER).block())
                .isEqualTo(2L);
    ...
    void lPushXShouldPrependValuesCorrectly() {
        ...
        assertThat(connection.listCommands().lPushX(KEY_1_BBUFFER, VALUE_2_BBUFFER).block())
                .isEqualTo(2L);
                        ...
                        () ->
                                connection
                                        ...
                                        .push(
                                                Mono.just(
                                                        PushCommand.right()
                                                                .values(Arrays.asList(VALUE_1_BBUFFER, VALUE_2_BBUFFER))
                                                                .to(KEY_1_BBUFFER)
                                                                .ifExists()))
                                        .blockFirst());
    }
    ...
    void lRangeShouldReturnValuesCorrectly() {
        ...
        assertThat(connection.listCommands().lRange(KEY_1_BBUFFER, 1, 2).toIterable())
                .containsExactly(VALUE_2_BBUFFER, VALUE_3_BBUFFER);
    }
    ...
    void lRangeShouldReturnValuesCorrectlyWithMinUnbounded() {
        ...
        RangeCommand rangeCommand =
                RangeCommand.key(KEY_1_BBUFFER).within(Range.of(unbounded(), inclusive(1L)));

        connection
                .listCommands()
                .lRange(Mono.just(rangeCommand))
    ...
    void lRangeShouldReturnValuesCorrectlyWithMaxUnbounded() {
        ...
        RangeCommand rangeCommand =
                RangeCommand.key(KEY_1_BBUFFER).within(Range.of(inclusive(1L), unbounded()));
    ...
    void lIndexShouldReturnValueCorrectly() {
        ...
        assertThat(connection.listCommands().lIndex(KEY_1_BBUFFER, 1).block())
                .isEqualTo(VALUE_2_BBUFFER);
    }
    ...
    void lInsertShouldAddValueCorrectlyBeforeExisting() {
        ...
        assertThat(
                        connection
                                .listCommands()
                                .lInsert(KEY_1_BBUFFER, Position.BEFORE, VALUE_2_BBUFFER, VALUE_3_BBUFFER)
                                .block())
                .isEqualTo(3L);
    ...
    void lInsertShouldAddValueCorrectlyAfterExisting() {
        ...
        assertThat(
                        connection
                                .listCommands()
                                .lInsert(KEY_1_BBUFFER, Position.AFTER, VALUE_2_BBUFFER, VALUE_3_BBUFFER)
                                .block())
                .isEqualTo(3L);
        assertThat(nativeCommands.lrange(KEY_1, 0, -1)).containsExactly(VALUE_1, VALUE_2, VALUE_3);
    }
    ...
    void lMoveShouldMoveValueCorrectly() {
        ...
        connection
                .listCommands()
                .lMove(
                        SAME_SLOT_KEY_1_BBUFFER,
                        SAME_SLOT_KEY_2_BBUFFER,
        ...
        assertThat(nativeCommands.lrange(SAME_SLOT_KEY_2, 0, -1))
                .containsExactly(VALUE_3, VALUE_2, VALUE_3);
    }
    ...
    void lRemSouldRemoveAllValuesCorrectly() {
        ...
        assertThat(connection.listCommands().lRem(KEY_1_BBUFFER, VALUE_1_BBUFFER).block())
                .isEqualTo(2L);
    ...
    void lRemSouldRemoveFirstValuesCorrectly() {
        ...
        assertThat(connection.listCommands().lRem(KEY_1_BBUFFER, 1L, VALUE_1_BBUFFER).block())
                .isEqualTo(1L);
    ...
    void blPopShouldReturnFirstAvailable() {
        ...
        PopResult result =
                connection
                        .listCommands()
                        .blPop(Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER), Duration.ofSeconds(1L))
                        .block();
    ...
    void brPopShouldReturnLastAvailable() {
        ...
        PopResult result =
                connection
                        .listCommands()
                        .brPop(Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER), Duration.ofSeconds(1L))
                        .block();
        assertThat(result.getKey()).isEqualTo(KEY_1_BBUFFER);
    ...
    void brPopLPushShouldWorkCorrectly() {
        ...
        ByteBuffer result =
                connection
                        .listCommands()
                        .bRPopLPush(KEY_1_BBUFFER, KEY_2_BBUFFER, Duration.ofSeconds(1))
                        .block();
    ...
    void lPos() {
        ...
        connection
                .listCommands()
                .lPos(KEY_1_BBUFFER, ByteBuffer.wrap("c".getBytes(StandardCharsets.UTF_8))) //
                .as(StepVerifier::create) //
                .expectNext(2L) //
                .verifyComplete();
    }
    ...
    void lPosRank() {
        ...
        connection
                .listCommands()
                .lPos(
                        LPosCommand.lPosOf(ByteBuffer.wrap("c".getBytes(StandardCharsets.UTF_8)))
                                .from(KEY_1_BBUFFER)
                                .rank(2)) //
                .as(StepVerifier::create) //
                .expectNext(6L) //
