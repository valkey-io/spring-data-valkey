...
/**
 * Comprehensive low-level integration tests for {@link ValkeyGlideConnection} string functionality
 * using the ValkeyStringCommands interface directly.
 *
 * <p>These tests validate the implementation of all ValkeyStringCommands methods: - Basic string
 * operations (get, set, getSet, etc.) - Multi-key operations (mGet, mSet, mSetNX) -
 * Expiration-related operations (setEx, pSetEx, getEx, getDel) - Increment/decrement operations
 * (incr, incrBy, decr, decrBy) - String manipulation (append, getRange, setRange, strLen) - Bit
 * operations (getBit, setBit, bitCount, bitField, bitOp, bitPos)
 *
...
public class ValkeyGlideConnectionStringCommandsIntegrationTests
    ...
    protected String[] getTestKeyPatterns() {
        return new String[] {
            "test:string:getset",
            "test:string:getset:old",
            "new:key",
            "test:string:getdel",
            "test:string:getex",
            "test:string:setoptions",
            "test:string:setget",
            "test:string:setex",
            "test:string:psetex",
            "test:string:mget:key1",
            "test:string:mget:key2",
            "test:string:mget:key3",
            "test:string:msetnx:key1",
            "test:string:msetnx:key2",
            "test:string:msetnx:existing",
            "test:string:msetnx:new1",
            "test:string:msetnx:new2",
            "test:string:incrdecr",
            "test:string:incrby:int",
            "test:string:incrby:float",
            "test:string:append",
            "test:string:range",
            "test:string:bit",
            "test:string:bitcount",
            "test:string:bitpos",
            "test:string:bitop:key1",
            "test:string:bitop:key2",
            "test:string:bitop:dest",
            "test:string:bitfield",
            "test:string:error:list",
            "test:string:empty"
        };
    }
    ...
    void testGetSetWithOldValue() {
        ...
        try {
            ...
            byte[] nonExistentOld =
                    connection.stringCommands().getSet("new:key".getBytes(), "value".getBytes());
    ...
    void testGetExPersistent() {
        ...
        try {
            ...
            connection
                    .stringCommands()
                    .set(key.getBytes(), value, Expiration.seconds(60), SetOption.upsert());
            ...
            byte[] retrievedValue =
                    connection.stringCommands().getEx(key.getBytes(), Expiration.persistent());
            assertThat(retrievedValue).isEqualTo(value);
    ...
    void testGetExKeepTtl() {
        ...
        try {
            ...
            byte[] retrievedValue =
                    connection.stringCommands().getEx(key.getBytes(), Expiration.keepTtl());
            assertThat(retrievedValue).isEqualTo(value);
            ...
            assertThat(ttlAfter)
                    .isLessThanOrEqualTo(ttlBefore); // Should be same or slightly less due to time passage
    ...
    void testMSetNX() {
        ...
        try {
            ...
            assertThat(connection.stringCommands().get(key1.getBytes())).isNull();
            assertThat(connection.stringCommands().get(key2.getBytes())).isNull();
            assertThat(connection.stringCommands().get(key3.getBytes()))
                    .isEqualTo("existing_value".getBytes());
            ...
            assertThat(connection.stringCommands().get(key4.getBytes()))
                    .isEqualTo("newvalue1".getBytes());
            assertThat(connection.stringCommands().get(key5.getBytes()))
                    .isEqualTo("newvalue2".getBytes());
        } finally {
            cleanupKey(key1);
            cleanupKey(key2);
            cleanupKey(key3);
    ...
    void testBitOp() {
        ...
        try {
            ...
            Long notResult =
                    connection.stringCommands().bitOp(BitOperation.NOT, destKey.getBytes(), key1.getBytes());
    ...
    void testBitFieldWithNonZeroBasedOffset() {
        ...
        try {
            ...
            BitFieldSubCommands getCommands =
                    BitFieldSubCommands.create()
    ...
    void testBasicStringOperationsInPipelineMode() {
        ...
        try {
            ...
            assertThat(connection.stringCommands().get(key1.getBytes())).isNull();
            assertThat(connection.stringCommands().getSet(key1.getBytes(), "newvalue1".getBytes()))
                    .isNull();
            assertThat(connection.stringCommands().getDel(key1.getBytes())).isNull();
            assertThat(connection.stringCommands().setEx(key3.getBytes(), 60, "expiring".getBytes()))
                    .isNull();
            assertThat(
                            connection.stringCommands().pSetEx(key4.getBytes(), 60000, "expiring_ms".getBytes()))
                    .isNull();
    ...
    void testBasicStringOperationsInTransactionMode() {
        ...
        try {
            ...
            assertThat(connection.stringCommands().setNX(key2.getBytes(), "txvalue2".getBytes()))
                    .isNull();
            assertThat(connection.stringCommands().get(key1.getBytes())).isNull();
            assertThat(connection.stringCommands().getSet(key1.getBytes(), "newtxvalue1".getBytes()))
                    .isNull();
            assertThat(connection.stringCommands().getDel(key1.getBytes())).isNull();
            assertThat(connection.stringCommands().setEx(key3.getBytes(), 60, "expiring".getBytes()))
                    .isNull();
    ...
    void testStringManipulationInTransactionMode() {
        ...
        try {
            ...
            assertThat(results.get(4))
                    .isEqualTo("TxValkey Valkey".getBytes()); // GET result after setrange
    ...
    void testTransactionWithWatchedKeys() {
        ...
        try {
            ...
            assertThat(connection.stringCommands().get(valueKey.getBytes()))
                    .isEqualTo("conditional_set".getBytes());
        } finally {
    ...
    void testMixedStringOperationsInTransaction() {
        ...
        try {
            ...
            // Verify final state
            assertThat(connection.stringCommands().get((baseKey + ":1").getBytes()))
                    .isEqualTo("101.5".getBytes());
            assertThat(connection.stringCommands().get((baseKey + ":2").getBytes()))
                    .isEqualTo("new_value".getBytes());
        } finally {
