 ...
 */
public abstract class AbstractValkeyZSetTestIntegration<T>
    ...
    void testLexCountBounded() {
        ...
        assertThat(zSet.lexCount(Range.rightUnbounded(Range.Bound.exclusive(t1.toString()))))
    ...
    private ValkeyZSet<T> createZSetFor(String key) {
        return new DefaultValkeyZSet<>(
                (BoundZSetOperations<String, T>) zSet.getOperations().boundZSetOps(key));
    }
    ...
    void testRangeByLexBoundedWithLimit() {
        ...
        assumeThat(factory)
                .isOfAnyClassIn(
                        DoubleObjectFactory.class, LongAsStringObjectFactory.class, LongObjectFactory.class);
        ...
        Set<T> tuples =
                zSet.rangeByLex(
                        Range.rightUnbounded(Range.Bound.inclusive(t1.toString())),
    ...
    void testRangeAndStoreByLex() {
        ...
        zSet.add(t3, 3);
        ValkeyZSet<T> tuples =
                zSet.rangeAndStoreByLex("dest", Range.closed(t2.toString(), t3.toString()));
    ...
    void testRangeAndStoreRevByLex() {
        ...
        zSet.add(t3, 3);
        ValkeyZSet<T> tuples =
                zSet.reverseRangeAndStoreByLex(
                        "dest", Range.closed(t1.toString(), t3.toString()), Limit.limit().count(2).offset(1));
    ...
    void testRangeAndStoreRevByScore() {
        ...
        zSet.add(t3, 3);
        ValkeyZSet<T> tuples =
                zSet.reverseRangeAndStoreByScore(
                        "dest", Range.closed(1, 3), Limit.limit().count(2).offset(0));
    ...
    void testDifference() {
        ...
        assertThat(zSet.diffWithScores(Arrays.asList(set1, set2)))
                .containsOnly(new DefaultTypedTuple<>(t1, 1d));
    }
