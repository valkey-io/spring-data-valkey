...
class EnabledOnCommandCondition implements ExecutionCondition {
    ...
    private static final ConditionEvaluationResult ENABLED_BY_DEFAULT =
            enabled("@EnabledOnCommand is not present");
    ...
    public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
        ...
        Optional<EnabledOnCommand> optional =
                AnnotationUtils.findAnnotation(context.getElement(), EnabledOnCommand.class);
        ...
        return hasCommand
                ? enabled("Enabled on command " + command)
                : disabled(
                        "Disabled, command "
                                + command
                                + " not available on Valkey version "
