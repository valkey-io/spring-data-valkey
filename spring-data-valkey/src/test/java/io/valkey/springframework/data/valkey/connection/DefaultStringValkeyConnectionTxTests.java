...
public class DefaultStringValkeyConnectionTxTests extends DefaultStringValkeyConnectionTests {
    ...
    public void testLPopCountBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(barBytes)))
    ...
    public void testGeoDistBytes() {
        ...
        doReturn(Collections.singletonList(new Distance(102121.12d, DistanceUnit.METERS)))
                .when(nativeConnection)
                .exec();
    ...
    public void testGeoHashBytes() {
        ...
        doReturn(Collections.singletonList(Collections.singletonList(bar)))
                .when(nativeConnection)
                .exec();
