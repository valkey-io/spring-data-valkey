 ...
 * functionality using the RedisScriptingCommands interface directly.
 *
 * <p>These tests validate the implementation of all RedisScriptingCommands methods: - eval: Execute
 * Lua scripts directly - evalSha: Execute Lua scripts by SHA hash - scriptLoad: Load scripts into
 * cache - scriptExists: Check script existence in cache - scriptFlush: Clear script cache -
 * scriptKill: Kill running scripts
 *
 * <p>Tests cover all three invocation modes: - Immediate mode: Direct execution with results -
 * Pipeline mode: Commands return null, results collected in closePipeline() - Transaction mode:
 * Commands return null, results collected in exec()
 *
 * @author Ilia Kolominsky
 * @since 2.0
 */
public class ValkeyGlideConnectionScriptingCommandsIntegrationTests
    ...
    private static final byte[] ARITHMETIC_SCRIPT =
            "return tonumber(ARGV[1]) + tonumber(ARGV[2])".getBytes();
    private static final byte[] SET_KEY_SCRIPT =
            "redis.call('set', KEYS[1], ARGV[1]); return 'OK'".getBytes();
    private static final byte[] BOOLEAN_SCRIPT = "return tonumber(ARGV[1]) > 0".getBytes();
    private static final byte[] MULTI_RETURN_SCRIPT =
            "return {KEYS[1], ARGV[1], 'static'}".getBytes();
    ...
    protected String[] getTestKeyPatterns() {
        return new String[] {
            ...
            "test:script:set:key",
            "test:script:get:key",
            "test:script:pipeline:key1",
            "test:script:pipeline:key2",
            "test:script:pipeline:set",
            "test:script:transaction:key1",
            "test:script:transaction:key2",
            "test:script:transaction:set",
            "test:script:workflow:counter",
            "test:script:workflow:data",
            "test:script:workflow:result"
        };
    }
    ...
    void testEvalBasicScripts() {
        try {
            ...
            byte[] result1 =
                    connection.scriptingCommands().eval(SIMPLE_RETURN_SCRIPT, ReturnType.VALUE, 0);
    ...
    void testEvalWithKeysAndArgs() {
        ...
        try {
            ...
            byte[] result1 =
                    connection.scriptingCommands().eval(KEY_VALUE_SCRIPT, ReturnType.VALUE, 1, testKeyBytes);
            ...
            // Note, the docs for ReturnType.STATUS is probably incorrect by stating that STATUS should
            // return byte[]
            String result2 =
                    connection
                            .scriptingCommands()
        ...
        try {
            ...
            Object[] result =
                    connection
                            .scriptingCommands()
                            .eval(
                                    MULTI_RETURN_SCRIPT, ReturnType.MULTI, 1, "mykey".getBytes(), "myarg".getBytes());
    ...
    @Test
    @EnabledOnValkeyVersion(
            "7.0") // Error handling for scriptExists() with no args differs in Redis < 7.0
    ...
    void testScriptingWithBinaryData() {
        ...
        byte[] setBinaryScript =
                "redis.call('set', KEYS[1], ARGV[1]); return redis.call('get', KEYS[1])".getBytes();
    ...
    void testScriptingErrorHandling() {
        try {
            ...
            assertThatThrownBy(
                            () -> connection.scriptingCommands().eval(invalidScript, ReturnType.VALUE, 0))
                    .isInstanceOf(DataAccessException.class);
            ...
            Object result =
                    connection.scriptingCommands().eval(keyScript, ReturnType.VALUE, 1, "key1".getBytes());
    ...
    void testEvalShaWithoutPreLoadingScript() {
        ...
        try {
            ...
            assertThat(caughtException)
                    .as("Expected NOSCRIPT exception when calling evalSha with uncached script")
                    .isNotNull();
        } finally {
            connection.scriptingCommands().scriptFlush();
        }
        ...
        try {
            ...
            assertThat(
                            (Object)
                                    connection.scriptingCommands().eval(SIMPLE_RETURN_SCRIPT, ReturnType.VALUE, 0))
                    .isNull();
            assertThat((Object) connection.scriptingCommands().evalSha(sha1, ReturnType.VALUE, 0))
                    .isNull();
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .eval(
                                                    ARITHMETIC_SCRIPT, ReturnType.INTEGER, 0, "7".getBytes(), "3".getBytes()))
                    .isNull();
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .evalSha(sha2, ReturnType.INTEGER, 0, "10".getBytes(), "5".getBytes()))
                    .isNull();
    ...
    void testEvalShaByteArrayInPipelineMode() {
        try {
            ...
            assertThat(
                            (Object) connection.scriptingCommands().evalSha(sha1.getBytes(), ReturnType.VALUE, 0))
                    .isNull();
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .evalSha(
                                                    sha2.getBytes(), ReturnType.INTEGER, 0, "9".getBytes(), "3".getBytes()))
                    .isNull();
        ...
        try {
            ...
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .eval(KEY_VALUE_SCRIPT, ReturnType.VALUE, 1, key1.getBytes()))
                    .isNull();
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .eval(KEY_VALUE_SCRIPT, ReturnType.VALUE, 1, key2.getBytes()))
                    .isNull();
            assertThat(
                            (Object)
                                    connection
            ...
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .eval(KEY_VALUE_SCRIPT, ReturnType.VALUE, 1, setKey.getBytes()))
                    .isNull();
            ...
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .eval(
                                                    ARITHMETIC_SCRIPT, ReturnType.INTEGER, 0, "8".getBytes(), "4".getBytes()))
                    .isNull();
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .evalSha(sha2, ReturnType.INTEGER, 0, "12".getBytes(), "6".getBytes()))
                    .isNull();
            assertThat((Object) connection.scriptingCommands().scriptExists(sha1, sha2)).isNull();
            ...
            assertThat(
                            (Object)
                                    connection
                                            .scriptingCommands()
                                            .evalSha(
                                                    sha2.getBytes(), ReturnType.INTEGER, 0, "11".getBytes(), "4".getBytes()))
                    .isNull();
    ...
    void testWatchWithScriptingCommandsTransaction() throws InterruptedException {
        ...
        try {
            ...
            connection
                    .scriptingCommands()
                    .eval(KEY_VALUE_SCRIPT, ReturnType.VALUE, 1, otherKey.getBytes());
