 ...
 * @author dengliming
 */
public class DefaultStringValkeyConnectionPipelineTxTests
        extends DefaultStringValkeyConnectionTxTests {
    ...
    public void testAppend() {
        doReturn(Collections.singletonList(Collections.singletonList(1L)))
    ...
    public void testBlPopBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(bytesList)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testBrPopLPushBytes() {
        doReturn(Collections.singletonList(Arrays.asList(new Object[] {barBytes})))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testCopy() {
        doReturn(Collections.singletonList(Arrays.asList(Boolean.TRUE)))
                .when(nativeConnection)
                .closePipeline();
        super.testCopy();
    }
    ...
    public void testDbSize() {
        doReturn(Collections.singletonList(Collections.singletonList(3L)))
                .when(nativeConnection)
                .closePipeline();
        super.testDbSize();
    }
    ...
    public void testExistsBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(true)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testGetConfig() {
        ...
        doReturn(Collections.singletonList(Collections.singletonList(results)))
                .when(nativeConnection)
                .closePipeline();
        super.testGetConfig();
    }
    ...
    public void testGetNativeConnection() {
        doReturn(Collections.singletonList(Collections.singletonList("foo")))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testHGetAllBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(bytesMap)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testHIncrByDoubleBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(3d)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testHKeysBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(bytesSet)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testIncrBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(2L)))
                .when(nativeConnection)
                .closePipeline();
        super.testIncrBytes();
    }
    ...
    public void testIncrByDoubleBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(2d)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testInfo() {
        ...
        props.put("foo", "bar");
        doReturn(Collections.singletonList(Collections.singletonList(props)))
                .when(nativeConnection)
                .closePipeline();
        super.testInfo();
    }
    ...
    public void testLastSave() {
        doReturn(Collections.singletonList(Collections.singletonList(6L)))
                .when(nativeConnection)
                .closePipeline();
        super.testLastSave();
    }
    ...
    public void testLInsertBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(8L)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testPing() {
        doReturn(Collections.singletonList(Collections.singletonList("pong")))
                .when(nativeConnection)
                .closePipeline();
        super.testPing();
    }
    ...
    public void testRandomKey() {
        doReturn(Collections.singletonList(Arrays.asList(new Object[] {fooBytes})))
                .when(nativeConnection)
                .closePipeline();
        super.testRandomKey();
    }
    ...
    public void testRPushBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(4L)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testStrLenBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(5L)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testTypeBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(DataType.HASH)))
                .when(nativeConnection)
                .closePipeline();
        super.testTypeBytes();
    }
    ...
    public void testZRangeByScoreWithScoresOffsetCountBytes() {
        doReturn(Collections.singletonList(Collections.singletonList(tupleSet)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testZMScore() {
        ...
        doReturn(Collections.singletonList(Collections.singletonList(Arrays.asList(1d, 3d))))
                .when(nativeConnection)
                .closePipeline();
        super.testZMScore();
    }
    ...
    public void testTxResultsNotSameSizeAsResults() {
        ...
        // while tx is open
        doReturn(Collections.singletonList(Arrays.asList(barBytes, 3L)))
                .when(nativeConnection)
                .closePipeline();
    ...
    void testTwoTxs() {
        doReturn(
                        Arrays.asList(
                                Arrays.asList(new Object[] {barBytes}), Arrays.asList(new Object[] {fooBytes})))
                .when(nativeConnection)
                .closePipeline();
        connection.get(foo);
        connection.exec();
        ...
        assertThat(results)
                .isEqualTo(Arrays.asList(Collections.singletonList(bar), Collections.singletonList(foo)));
    }
    ...
    public void testGeoDistBytes() {
        ...
        doReturn(
                        Collections.singletonList(
                                Collections.singletonList(new Distance(102121.12d, DistanceUnit.METERS))))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testGeoPosBytes() {
        ...
        doReturn(Collections.singletonList(Collections.singletonList(points)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void testGeoRadiusWithoutParamBytes() {
        ...
        doReturn(Collections.singletonList(Collections.singletonList(geoResults)))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void xAddShouldAppendRecordCorrectly() {
        ...
        doReturn(Collections.singletonList(Collections.singletonList(RecordId.of("1-1"))))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void xGroupCreateShouldDelegateAndConvertCorrectly() {
        ...
        doReturn(Collections.singletonList(Collections.singletonList("OK")))
                .when(nativeConnection)
                .closePipeline();
    ...
    public void xGroupDelConsumerShouldDelegateAndConvertCorrectly() {
        ...
        doReturn(Collections.singletonList(Collections.singletonList(Boolean.TRUE)))
                .when(nativeConnection)
                .closePipeline();
