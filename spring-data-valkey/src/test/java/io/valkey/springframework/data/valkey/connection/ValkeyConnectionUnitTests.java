...
class ValkeyConnectionUnitTests {
    ...
    private final ValkeyNode SENTINEL_1 =
            new ValkeyNodeBuilder().listeningAt("localhost", 23679).build();
    ...
    void setUp() {
        ...
        connection =
                new AbstractDelegatingValkeyConnectionStub(
                        mock(AbstractValkeyConnection.class, CALLS_REAL_METHODS));
        connection.setSentinelConfiguration(
                new ValkeySentinelConfiguration().master("mymaster").sentinel(SENTINEL_1));
    ...
    static class AbstractDelegatingValkeyConnectionStub extends AbstractValkeyConnection {
        ...
        public GeoResults<GeoLocation<byte[]>> geoRadius(
                byte[] key, Circle within, GeoRadiusCommandArgs param) {
        ...
        @Override
        public GeoResults<GeoLocation<byte[]>> geoRadiusByMember(
                byte[] key, byte[] member, Distance radius, GeoRadiusCommandArgs param) {
        ...
        @Override
        public void migrate(
                byte[] key, ValkeyNode target, int dbIndex, MigrateOption option, long timeout) {
