...
class LettuceClientConfigurationUnitTests {
    ...
    void shutdownQuietPeriodShouldDefaultInitialValue() {
        ...
        LettuceClientConfiguration configuration =
                LettuceClientConfiguration.builder().shutdownTimeout(Duration.ofSeconds(42)).build();
    ...
    void clientConfigurationThrowsExceptionForNullClientName() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> LettuceClientConfiguration.builder().clientName(null));
    }

    @Test // DATAREDIS-576
    void clientConfigurationThrowsExceptionForEmptyClientName() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> LettuceClientConfiguration.builder().clientName(" "));
    }
    ...
    void shouldApplySettingsFromValkeyURI() {
        ...
        LettuceClientConfiguration configuration =
                LettuceClientConfiguration.builder() //
                        .apply(RedisURI.create("rediss://foo?verifyPeer=FULL&clientName=bar&timeout=10s"))
                        .build();
    ...
    void emptySettingsRetainClientConfiguration() {
        ...
        LettuceClientConfiguration configuration =
                LettuceClientConfiguration.builder() //
                        ...
                        .apply(RedisURI.create("rediss://foo"))
                        .build();
