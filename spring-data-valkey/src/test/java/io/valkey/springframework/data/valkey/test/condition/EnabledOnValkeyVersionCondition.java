 ...
 */
class EnabledOnValkeyVersionCondition extends ValkeyTestExtensionSupport implements ExecutionCondition {
	...
	public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
		...
		if (requiredVersionMet) {
			return enabled(
					"Enabled on version %s; actual version: %s".formatted(requiredVersion, conditions.getValkeyVersion()));
		}
