...
public class ValkeyRepositoryIntegrationTests extends ValkeyRepositoryIntegrationTestBase {
    ...
    static class Config {
        ...
        @Bean
        public MappingValkeyConverter valkeyConverter(
                ValkeyMappingContext mappingContext,
                ValkeyCustomConversions customConversions,
                ReferenceResolver referenceResolver) {

            MappingValkeyConverter mappingValkeyConverter =
                    new MappingValkeyConverter(mappingContext, null, referenceResolver, customTypeMapper());
        ...
        private ValkeyTypeMapper customTypeMapper() {
            ...
            return new DefaultValkeyTypeMapper(
                    DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY, Collections.singletonList(mapper));
        }
    }
