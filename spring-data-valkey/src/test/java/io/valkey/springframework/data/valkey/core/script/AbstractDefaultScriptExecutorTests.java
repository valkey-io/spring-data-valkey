...
public abstract class AbstractDefaultScriptExecutorTests {
    ...
    void testExecuteLongResult() {
        ...
        assertThat(scriptExecutor.execute(script, Collections.singletonList("mykey")))
    ...
    void testExecuteBooleanResult() {
        ...
        assertThat(scriptExecutor.execute(script, Collections.singletonList("counter"), 0, 3))
                .isFalse();
    }
    ...
    void testExecuteMixedListResult() {
        ...
        assertThat(scriptExecutor.execute(script, Collections.singletonList("mylist")))
                .isEqualTo(Arrays.asList("a", 1L));
    }
