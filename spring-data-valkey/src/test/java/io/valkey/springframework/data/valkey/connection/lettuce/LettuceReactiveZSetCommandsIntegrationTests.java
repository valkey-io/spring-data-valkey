 ...
 */
public class LettuceReactiveZSetCommandsIntegrationTests
    ...
    void zAddShouldAddValuesWithScores() {
        assertThat(connection.zSetCommands().zAdd(KEY_1_BBUFFER, 3.5D, VALUE_1_BBUFFER).block())
                .isEqualTo(1L);
    }
    ...
    void zAddShouldConsiderAbsentPresentUpsertFlags() {
        ...
        zAdd(KEY_1_BBUFFER, tuple, Function.identity())
                .map(Number::intValue) //
        ...
        // NX
        zAdd(KEY_1_BBUFFER, tuple, ZAddCommand::nx)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(0) //
                .verifyComplete();

        zAdd(KEY_2_BBUFFER, tuple, ZAddCommand::nx)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(1) //
                .verifyComplete();
        ...
        // XX
        zAdd(KEY_1_BBUFFER, Tuple.of(VALUE_1_BYTES, 3.0D), ZAddCommand::xx)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(0) //
                .verifyComplete();
        ...
        connection
                .zSetCommands()
                .zScore(KEY_1_BBUFFER, VALUE_1_BBUFFER)
                .map(Number::doubleValue) //
                .as(StepVerifier::create) //
                .expectNext(3.0) //
                .verifyComplete();

        zAdd(KEY_3_BBUFFER, tuple, ZAddCommand::xx)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(0) //
                .verifyComplete();
    ...
    void zAddShouldConsiderLessThan() {
        ...
        zAdd(KEY_1_BBUFFER, Tuple.of(VALUE_1_BYTES, 6D), ZAddCommand::lt)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(0) //
                .verifyComplete();
        ...
        zAdd(KEY_1_BBUFFER, Tuple.of(VALUE_1_BYTES, 1D), ZAddCommand::lt)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(0) //
                .verifyComplete();
    ...
    void zAddShouldConsiderGreaterThan() {
        ...
        zAdd(KEY_1_BBUFFER, Tuple.of(VALUE_1_BYTES, 1D), ZAddCommand::gt)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(0) //
                .verifyComplete();
        ...
        zAdd(KEY_1_BBUFFER, Tuple.of(VALUE_1_BYTES, 6D), ZAddCommand::gt)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(0) //
                .verifyComplete();
    ...
    void zAddShouldConsiderIncrFlag() {
        ...
        zAdd(KEY_1_BBUFFER, tuple, ZAddCommand::incr)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(7) //
                .verifyComplete();
    ...
    void zAddShouldConsiderChFlag() {
        ...
        zAdd(KEY_1_BBUFFER, tuple, ZAddCommand::ch)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(0) //
                .verifyComplete();

        zAdd(KEY_1_BBUFFER, Tuple.of(VALUE_1_BYTES, 3.0D), ZAddCommand::ch)
                .map(Number::intValue) //
                .as(StepVerifier::create) //
                .expectNext(1) //
                .verifyComplete();
    ...
    private Flux<Number> zAdd(
            ByteBuffer key, Tuple tuple, Function<ZAddCommand, ZAddCommand> commandCustomizer) {
        return connection
                .zSetCommands()
                .zAdd(Mono.just(commandCustomizer.apply(ZAddCommand.tuple(tuple).to(key))))
    ...
    void zRemShouldRemoveValuesFromSet() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRem(KEY_1_BBUFFER, Arrays.asList(VALUE_1_BBUFFER, VALUE_3_BBUFFER))
                                .block())
                .isEqualTo(2L);
    }
    ...
    void zIncrByShouldInreaseAndReturnScore() {
        ...
        assertThat(connection.zSetCommands().zIncrBy(KEY_1_BBUFFER, 3.5D, VALUE_1_BBUFFER).block())
                .isEqualTo(4.5D);
    }
    ...
    void zRankShouldReturnIndexCorrectly() {
        ...
        assertThat(connection.zSetCommands().zRank(KEY_1_BBUFFER, VALUE_3_BBUFFER).block())
                .isEqualTo(2L);
    }
    ...
    void zRevRankShouldReturnIndexCorrectly() {
        ...
        assertThat(connection.zSetCommands().zRevRank(KEY_1_BBUFFER, VALUE_3_BBUFFER).block())
                .isEqualTo(0L);
    }
    ...
    void zRangeShouldReturnValuesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRange(KEY_1_BBUFFER, ONE_TO_TWO)
                .as(StepVerifier::create) //
    ...
    void zRangeWithScoreShouldReturnTuplesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRangeWithScores(KEY_1_BBUFFER, ONE_TO_TWO)
                .as(StepVerifier::create) //
                .expectNext(
    ...
    void zRevRangeShouldReturnValuesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRevRange(KEY_1_BBUFFER, ONE_TO_TWO)
                .as(StepVerifier::create) //
    ...
    void zRevRangeWithScoreShouldReturnTuplesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRevRangeWithScores(KEY_1_BBUFFER, ONE_TO_TWO)
                .as(StepVerifier::create) //
                .expectNext(
                        new DefaultTuple(VALUE_2_BBUFFER.array(), 2D),
    ...
    void zRangeByScoreShouldReturnValuesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRangeByScore(KEY_1_BBUFFER, Range.closed(2D, 3D))
                .as(StepVerifier::create) //
                .expectNext(VALUE_2_BBUFFER, VALUE_3_BBUFFER) //
                .verifyComplete();
    }
    ...
    void zRangeByScoreShouldReturnValuesCorrectlyWithMinUnbounded() {
        ...
        connection
                .zSetCommands()
                .zRangeByScore(KEY_1_BBUFFER, Range.of(Range.Bound.unbounded(), Range.Bound.inclusive(3D)))
                .as(StepVerifier::create) //
    ...
    void zRangeByScoreShouldReturnValuesCorrectlyWithMaxUnbounded() {
        ...
        connection
                .zSetCommands()
                .zRangeByScore(KEY_1_BBUFFER, Range.of(Range.Bound.inclusive(0D), Range.Bound.unbounded()))
                .as(StepVerifier::create) //
                .expectNext(VALUE_1_BBUFFER, VALUE_2_BBUFFER, VALUE_3_BBUFFER) //
                .verifyComplete();
    }
    ...
    void zRangeByScoreShouldReturnValuesCorrectlyWithMinExclusion() {
        ...
        connection
                .zSetCommands()
                .zRangeByScore(KEY_1_BBUFFER, TWO_EXCLUSIVE_TO_THREE_INCLUSIVE)
                .as(StepVerifier::create) //
    ...
    void zRangeByScoreShouldReturnValuesCorrectlyWithMaxExclusion() {
        ...
        connection
                .zSetCommands()
                .zRangeByScore(KEY_1_BBUFFER, TWO_INCLUSIVE_TO_THREE_EXCLUSIVE)
                .as(StepVerifier::create) //
    ...
    void zRangeByScoreWithScoreShouldReturnTuplesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRangeByScoreWithScores(KEY_1_BBUFFER, TWO_TO_THREE_ALL_INCLUSIVE)
                .as(StepVerifier::create) //
                .expectNext(
                        new DefaultTuple(VALUE_2_BBUFFER.array(), 2D),
                        new DefaultTuple(VALUE_3_BBUFFER.array(), 3D)) //
    ...
    void zRangeByScoreWithScoreShouldReturnTuplesCorrectlyWithMinExclusion() {
        ...
        connection
                .zSetCommands()
                .zRangeByScoreWithScores(KEY_1_BBUFFER, TWO_EXCLUSIVE_TO_THREE_INCLUSIVE)
                .as(StepVerifier::create) //
    ...
    void zRangeByScoreWithScoreShouldReturnTuplesCorrectlyWithMaxExclusion() {
        ...
        connection
                .zSetCommands()
                .zRangeByScoreWithScores(KEY_1_BBUFFER, TWO_INCLUSIVE_TO_THREE_EXCLUSIVE)
                .as(StepVerifier::create) //
    ...
    void zRevRangeByScoreShouldReturnValuesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRevRangeByScore(KEY_1_BBUFFER, TWO_TO_THREE_ALL_INCLUSIVE)
                .as(StepVerifier::create) //
    ...
    void zRevRangeByScoreShouldReturnValuesCorrectlyWithMinExclusion() {
        ...
        connection
                .zSetCommands()
                .zRevRangeByScore(KEY_1_BBUFFER, TWO_EXCLUSIVE_TO_THREE_INCLUSIVE)
                .as(StepVerifier::create) //
                .expectNext(VALUE_3_BBUFFER) //
                .verifyComplete();
    }
    ...
    void zRevRangeByScoreShouldReturnValuesCorrectlyWithMaxExclusion() {
        ...
        connection
                .zSetCommands()
                .zRevRangeByScore(KEY_1_BBUFFER, TWO_INCLUSIVE_TO_THREE_EXCLUSIVE)
                .as(StepVerifier::create) //
                .expectNext(VALUE_2_BBUFFER) //
                .verifyComplete();
    }
    ...
    void zRevRangeByScoreWithScoreShouldReturnTuplesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRevRangeByScoreWithScores(KEY_1_BBUFFER, TWO_TO_THREE_ALL_INCLUSIVE)
                .as(StepVerifier::create) //
                .expectNext(
                        new DefaultTuple(VALUE_3_BBUFFER.array(), 3D),
                        new DefaultTuple(VALUE_2_BBUFFER.array(), 2D)) //
    ...
    void zRevRangeByScoreWithScoreShouldReturnTuplesCorrectlyWithMinExclusion() {
        ...
        connection
                .zSetCommands()
                .zRevRangeByScoreWithScores(KEY_1_BBUFFER, TWO_EXCLUSIVE_TO_THREE_INCLUSIVE)
                .as(StepVerifier::create) //
                .expectNext(new DefaultTuple(VALUE_3_BBUFFER.array(), 3D)) //
                .verifyComplete();
    }
    ...
    void zRevRangeByScoreWithScoreShouldReturnTuplesCorrectlyWithMaxExclusion() {
        ...
        connection
                .zSetCommands()
                .zRevRangeByScoreWithScores(KEY_1_BBUFFER, TWO_INCLUSIVE_TO_THREE_EXCLUSIVE)
                .as(StepVerifier::create) //
                .expectNext(new DefaultTuple(VALUE_2_BBUFFER.array(), 2D)) //
                .verifyComplete();
    }
    ...
    void zScanShouldIterateOverSortedSet() {
        ...
        connection
                .zSetCommands()
                .zScan(KEY_1_BBUFFER, ScanOptions.scanOptions().count(1).build())
                .as(StepVerifier::create) //
                .expectNextCount(3)
                .verifyComplete();
        ...
        connection
                .zSetCommands()
                .zScan(KEY_1_BBUFFER, ScanOptions.scanOptions().match(VALUE_2).build())
                .as(StepVerifier::create) //
                .expectNext(new DefaultTuple(VALUE_2_BBUFFER.array(), 2D)) //
                .verifyComplete();
    }
    ...
    void zCountShouldCountValuesInRange() {
        ...
        assertThat(connection.zSetCommands().zCount(KEY_1_BBUFFER, TWO_TO_THREE_ALL_INCLUSIVE).block())
                .isEqualTo(2L);
    }
    ...
    void zCountShouldCountValuesInRangeWithMinExlusion() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zCount(KEY_1_BBUFFER, TWO_EXCLUSIVE_TO_THREE_INCLUSIVE)
                                .block())
                .isEqualTo(1L);
    }
    ...
    void zCountShouldCountValuesInRangeWithMaxExlusion() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zCount(KEY_1_BBUFFER, TWO_INCLUSIVE_TO_THREE_EXCLUSIVE)
                                .block())
                .isEqualTo(1L);
    }
    ...
    void zCountShouldCountValuesInRangeWithNegativeInfinity() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zCount(KEY_1_BBUFFER, Range.leftUnbounded(inclusive(2D)))
                                .block())
                .isEqualTo(2L);
    }
    ...
    void zCountShouldCountValuesInRangeWithPositiveInfinity() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zCount(KEY_1_BBUFFER, Range.rightUnbounded(inclusive(2D)))
                                .block())
                .isEqualTo(2L);
    }
    ...
    void zPopMinShouldReturnCorrectly() {
        ...
        connection
                .zSetCommands()
                .zPopMin(KEY_1_BBUFFER)
                .as(StepVerifier::create)
                .expectNext(new DefaultTuple(VALUE_1_BYTES, 1D))
                .verifyComplete();

        connection
                .zSetCommands()
                .zPopMin(KEY_1_BBUFFER, 2)
                .as(StepVerifier::create)
                .expectNext(new DefaultTuple(VALUE_2_BYTES, 2D))
                .expectNext(new DefaultTuple(VALUE_3_BYTES, 3D))
                .verifyComplete();
    }
    ...
    void bzPopMinShouldReturnCorrectly() {
        ...
        connection
                .zSetCommands()
                .bZPopMin(KEY_1_BBUFFER, Duration.ofSeconds(1))
                .as(StepVerifier::create)
                .expectNext(new DefaultTuple(VALUE_1_BYTES, 1D))
                .verifyComplete();
    }
    ...
    void bzPopMaxShouldReturnCorrectly() {
        ...
        connection
                .zSetCommands()
                .bZPopMax(KEY_1_BBUFFER, Duration.ofSeconds(1))
                .as(StepVerifier::create)
                .expectNext(new DefaultTuple(VALUE_3_BYTES, 3D))
                .verifyComplete();
    }
    ...
    void zScoreShouldReturnScoreCorrectly() {
        ...
        assertThat(connection.zSetCommands().zScore(KEY_1_BBUFFER, VALUE_2_BBUFFER).block())
                .isEqualTo(2D);
    }
    ...
    void zMScoreShouldReturnScoreCorrectly() {
        ...
        connection
                .zSetCommands()
                .zMScore(KEY_1_BBUFFER, Arrays.asList(VALUE_1_BBUFFER, VALUE_2_BBUFFER))
                .as(StepVerifier::create)
                .expectNext(Arrays.asList(1D, 2D))
                .verifyComplete();
    }
    ...
    void zRemRangeByRankShouldRemoveValuesCorrectly() {
        ...
        assertThat(connection.zSetCommands().zRemRangeByRank(KEY_1_BBUFFER, ONE_TO_TWO).block())
                .isEqualTo(2L);
    }
    ...
    void zRemRangeByLexRemovesValuesCorrectly() {
        ...
        connection
                .zSetCommands()
                .zRemRangeByLex(KEY_1_BBUFFER, Range.closed("alpha", "omega")) //
                .as(StepVerifier::create) //
                .expectNext(6L) //
                .verifyComplete();
    }
    ...
    void zRemRangeByScoreShouldRemoveValuesCorrectly() {
        ...
        assertThat(
                        connection.zSetCommands().zRemRangeByScore(KEY_1_BBUFFER, Range.closed(1D, 2D)).block())
                .isEqualTo(2L);
    }
    ...
    void zRemRangeByScoreShouldRemoveValuesCorrectlyWithNegativeInfinity() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRemRangeByScore(KEY_1_BBUFFER, Range.leftUnbounded(inclusive(2D)))
                                .block())
                .isEqualTo(2L);
    }
    ...
    void zRemRangeByScoreShouldRemoveValuesCorrectlyWithPositiveInfinity() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRemRangeByScore(KEY_1_BBUFFER, Range.rightUnbounded(inclusive(2D)))
                                .block())
                .isEqualTo(2L);
    }
    ...
    void zRemRangeByScoreShouldRemoveValuesCorrectlyWithExcludingMinRange() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRemRangeByScore(KEY_1_BBUFFER, TWO_EXCLUSIVE_TO_THREE_INCLUSIVE)
                                .block())
                .isEqualTo(1L);
    }
    ...
    void zRemRangeByScoreShouldRemoveValuesCorrectlyWithExcludingMaxRange() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRemRangeByScore(KEY_1_BBUFFER, TWO_INCLUSIVE_TO_THREE_EXCLUSIVE)
                                .block())
                .isEqualTo(1L);
    }
    ...
    void zDiffShouldWorkCorrectly() {
        ...
        connection
                .zSetCommands()
                .zDiff(Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER)) //
                .collectList() //
                .as(StepVerifier::create) //
                .assertNext(
                        actual -> {
        ...
        connection
                .zSetCommands()
                .zDiffWithScores(Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER)) //
                .collectList() //
                .as(StepVerifier::create) //
                .assertNext(
                        actual -> {
    ...
    void zDiffStoreShouldWorkCorrectly() {
        ...
        connection
                .zSetCommands()
                .zDiffStore(KEY_3_BBUFFER, Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER)) //
                .as(StepVerifier::create) //
                .expectNext(1L)
                .verifyComplete();
    }
    ...
    void zInterShouldWorkCorrectly() {
        ...
        connection
                .zSetCommands()
                .zInter(Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER)) //
                .collectList() //
                .as(StepVerifier::create) //
                .assertNext(
                        actual -> {
        ...
        connection
                .zSetCommands()
                .zInterWithScores(Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER), Arrays.asList(2D, 3D)) //
                .collectList() //
                .as(StepVerifier::create) //
                .assertNext(
                        actual -> {
                            assertThat(actual)
                                    .contains(
                                            new DefaultTuple(VALUE_1_BYTES, 5D), new DefaultTuple(VALUE_2_BYTES, 10D));
                        })
                .verifyComplete();
    }
    ...
    void zInterStoreShouldWorkCorrectly() {
        ...
        assertThat(
                        connection
                                ...
                                .zInterStore(
                                        KEY_3_BBUFFER,
                                        Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER),
                                        Arrays.asList(2D, 3D))
                                .block())
                .isEqualTo(2L);
    }
    ...
    void zUnionShouldWorkCorrectly() {
        ...
        connection
                .zSetCommands()
                .zUnion(Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER)) //
                .collectList() //
                .as(StepVerifier::create) //
                .assertNext(
                        actual -> {
        ...
        connection
                .zSetCommands()
                .zUnionWithScores(Arrays.asList(KEY_1_BBUFFER, KEY_2_BBUFFER), Arrays.asList(2D, 3D)) //
                .collectList() //
                .as(StepVerifier::create) //
                .assertNext(
                        actual -> {
                            assertThat(actual)
                                    .contains(
                                            new DefaultTuple(VALUE_1_BYTES, 5D),
                                            new DefaultTuple(VALUE_2_BYTES, 10D),
    ...
    void zRangeByLex() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRangeByLex(KEY_1_BBUFFER, Range.rightOpen("", "c"))
                                .collectList()
                                .block())
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRangeByLex(KEY_1_BBUFFER, Range.rightOpen("aaa", "g"))
                                .collectList()
                                .block())
                .containsExactly(
                        ByteBuffer.wrap("b".getBytes()),
    ...
    void zRevRangeByLex() {
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRevRangeByLex(KEY_1_BBUFFER, Range.closed("", "c"))
                                .collectList()
                                .block())
                .containsExactly(
                        ByteBuffer.wrap("c".getBytes()),
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRevRangeByLex(KEY_1_BBUFFER, Range.rightOpen("", "c"))
                                .collectList()
                                .block())
        ...
        assertThat(
                        connection
                                .zSetCommands()
                                .zRevRangeByLex(KEY_1_BBUFFER, Range.rightOpen("aaa", "g"))
                                .collectList()
                                .block())
                .containsExactly(
                        ByteBuffer.wrap("f".getBytes()),
