...
import static io.valkey.springframework.data.valkey.test.extension.parametrized.ParameterizedTestContext.ResolverType.*;
...
/**
 * Encapsulates access to the parameters of a parameterized test method and caches the converters
 * and aggregators used to resolve them.
 *
 * <p>Copy of {@code org.junit.jupiter.params.ParameterizedTestContext}.
 */
class ParameterizedTestContext {
    ...
    /**
     * Determine if the supplied {@link Parameter} is an aggregator (i.e., of type {@link
     * ArgumentsAccessor} or annotated with {@link AggregateWith}).
     *
    ...
    /**
     * Determine if the {@link Method} represented by this context has a <em>potentially</em> valid
     * signature (i.e., formal parameter declarations) with regard to aggregators.
     *
     * <p>This method takes a best-effort approach at enforcing the following policy for parameterized
     * test methods that accept aggregators as arguments.
     *
     * <ol>
     *   <li>zero or more <em>indexed arguments</em> come first.
     *   <li>zero or more <em>aggregators</em> come next.
     *   <li>zero or more arguments supplied by other {@code ParameterResolver} implementations come
     *       last.
     * </ol>
     *
    ...
    /**
     * Get the name of the {@link Parameter} with the supplied index, if it is present and declared
    ...
    /**
     * Determine if the {@link Method} represented by this context declares at least one {@link
     * Parameter} that is an {@linkplain #isAggregator aggregator}.
     *
    ...
    /**
     * Find the index of the first {@linkplain #isAggregator aggregator} {@link Parameter} in the
     * {@link Method} represented by this context.
     *
            ...
            Resolver createResolver(ParameterContext parameterContext) {
                try { // @formatter:off
                    ...
                    throw parameterResolutionException(
                            "Error creating ArgumentConverter", ex, parameterContext);
                }
            }
        },
            ...
            Resolver createResolver(ParameterContext parameterContext) {
                try { // @formatter:off
                    return AnnotationUtils.findAnnotation(
                                    parameterContext.getParameter(), AggregateWith.class)
                    ...
                    throw parameterResolutionException(
                            "Error creating ArgumentsAggregator", ex, parameterContext);
                }
            }
        };
    ...
    static class Aggregator implements Resolver {
        ...
        public Object resolve(ParameterContext parameterContext, Object[] arguments) {
            ...
            try {
                ...
                throw parameterResolutionException(
                        "Error aggregating arguments for parameter", ex, parameterContext);
            }
        }
    }

    private static ParameterResolutionException parameterResolutionException(
            String message, Exception cause, ParameterContext parameterContext) {
