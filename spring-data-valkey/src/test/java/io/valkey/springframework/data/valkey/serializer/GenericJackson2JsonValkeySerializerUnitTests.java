...
class GenericJackson2JsonValkeySerializerUnitTests {
    ...
    private static final ComplexObject COMPLEX_OBJECT =
            new ComplexObject("steelheart", SIMPLE_OBJECT);
    ...
    void shouldUseDefaultTyping() {
        ...
        assertThat(extractTypeResolver(GenericJackson2JsonValkeySerializer.builder().build()))
                .isNotNull();
        assertThat(
                        extractTypeResolver(
                                GenericJackson2JsonValkeySerializer.builder().defaultTyping(false).build()))
                .isNull();
        assertThat(
                        extractTypeResolver(
                                GenericJackson2JsonValkeySerializer.builder()
    ...
    void shouldUseDefaultTypingWhenClassPropertyNameIsEmpty() {
        ...
        TypeResolverBuilder<?> typeResolver =
                extractTypeResolver(new GenericJackson2JsonValkeySerializer(""));
    ...
    void shouldUseDefaultTypingWhenClassPropertyNameIsNull() {
        ...
        TypeResolverBuilder<?> typeResolver =
                extractTypeResolver(new GenericJackson2JsonValkeySerializer((String) null));
        assertThat((String) getField(typeResolver, "_typeProperty"))
                .isEqualTo(JsonTypeInfo.Id.CLASS.getDefaultPropertyName());
    }
    ...
    void shouldUseDefaultTypingWhenClassPropertyNameIsProvided() {
        ...
        TypeResolverBuilder<?> typeResolver =
                extractTypeResolver(
                        GenericJackson2JsonValkeySerializer.builder()
                                .typeHintPropertyName("firefight")
                                .build());
    ...
    void serializeShouldReturnEmptyByteArrayWhenSourceIsNull() {
        assertThat(new GenericJackson2JsonValkeySerializer().serialize(null))
                .isEqualTo(SerializationUtils.EMPTY_ARRAY);
    }
    ...
    void deserializeShouldReturnNullWhenSouceIsEmptyArray() {
        assertThat(
                        new GenericJackson2JsonValkeySerializer().deserialize(SerializationUtils.EMPTY_ARRAY))
                .isNull();
    }
    ...
    void deserializeShouldBeAbleToRestoreSimpleObjectAfterSerialization() {
        ...
        assertThat((SimpleObject) serializer.deserialize(serializer.serialize(SIMPLE_OBJECT)))
                .isEqualTo(SIMPLE_OBJECT);
    }
    ...
    void deserializeShouldBeAbleToRestoreComplexObjectAfterSerialization() {
        ...
        assertThat((ComplexObject) serializer.deserialize(serializer.serialize(COMPLEX_OBJECT)))
                .isEqualTo(COMPLEX_OBJECT);
    }
    ...
    void serializeShouldThrowSerializationExceptionProcessingError() throws JsonProcessingException {
        ...
        when(objectMapperMock.writeValueAsBytes(any()))
                .thenThrow(new JsonGenerationException("nightwielder"));

        assertThatExceptionOfType(SerializationException.class)
                .isThrownBy(
                        () ->
                                new GenericJackson2JsonValkeySerializer(objectMapperMock).serialize(SIMPLE_OBJECT));
    }
    ...
    void deserializeShouldThrowSerializationExceptionProcessingError() throws IOException {
        ...
        assertThatExceptionOfType(SerializationException.class)
                .isThrownBy(
                        () ->
                                new GenericJackson2JsonValkeySerializer(objectMapperMock)
                                        .deserialize(new byte[] {1}));
    }
    ...
    void shouldSerializeNullValueWithCustomObjectMapper() {
        ...
        GenericJackson2JsonValkeySerializer serializer =
                new GenericJackson2JsonValkeySerializer(mapper);
    ...
    void shouldDeserializePrimitiveArrayWithoutTypeHint() {
        ...
        CountAndArray result =
                (CountAndArray)
                        gs.deserialize(
                                ("{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJackson2JsonValkeySerializerUnitTests$CountAndArray\","
                                        + " \"count\":1, \"available\":[0,1]}")
                                        .getBytes());
    ...
    void readsToMapForNonDefaultTyping() {
        ...
        GenericJackson2JsonValkeySerializer serializer =
                new GenericJackson2JsonValkeySerializer(new ObjectMapper());
    ...
    void shouldDeserializePrimitiveWrapperArrayWithoutTypeHint() {
        ...
        CountAndArray result =
                (CountAndArray)
                        gs.deserialize(
                                ("{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJackson2JsonValkeySerializerUnitTests$CountAndArray\","
                                        + " \"count\":1, \"arrayOfPrimitiveWrapper\":[0,1]}")
                                        .getBytes());
        ...
        assertThat(serializer.deserialize(serializedValue)) //
                ...
                .satisfies(
                        it -> {
                            ...
                            assertThat(deserialized.primitiveArrayWrapper)
                                    .hasValue(source.primitiveArrayWrapper.get());
                        });
    }
    ...
    void includesTypingForWrappedObjectTypes() {
        ...
        assertThat(serializer.deserialize(serializedValue)) //
                ...
                .satisfies(
                        it -> {
                            WithWrapperTypes deserialized = (WithWrapperTypes) it;
                            assertThat(deserialized.simpleObjectWrapper)
                                    .hasValue(source.simpleObjectWrapper.get());
                        });
    }
    ...
    void verifySerializeUUIDIntoBytes() {
        ...
        assertThat(serializer.serialize(source))
                .isEqualTo(("\"" + source + "\"").getBytes(StandardCharsets.UTF_8));
    }
    ...
    void deserializesUUIDFromBytes() {
        ...
        GenericJackson2JsonValkeySerializer serializer = new GenericJackson2JsonValkeySerializer();
        UUID deserializedUuid =
                serializer.deserialize(
                        "\"730145fe-324d-4fb1-b12f-60b89a045730\"".getBytes(StandardCharsets.UTF_8),
                        UUID.class);
    ...
    void serializesEnumIntoBytes() {
        ...
        assertThat(serializer.serialize(EnumType.ONE))
                .isEqualTo(("\"ONE\"").getBytes(StandardCharsets.UTF_8));
    }
    ...
    void deserializesJavaTimeFrimBytes() {
        ...
        byte[] source =
                "{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJackson2JsonValkeySerializerUnitTests$WithJsr310\",\"myDate\":[2022,9,2]}"
                        .getBytes(StandardCharsets.UTF_8);
        assertThat(serializer.deserialize(source, WithJsr310.class).myDate)
                .isEqualTo(java.time.LocalDate.of(2022, 9, 2));
    }
    ...
    void internalObjectMapperCustomization() {
        ...
        com.fasterxml.jackson.databind.Module mockModule =
                mock(com.fasterxml.jackson.databind.Module.class);
    ...
    void customNullValueSerializer() {
        ...
        StdSerializer<NullValue> nullValueSerializer =
                new StdSerializer<>(NullValue.class) {
                    @Override
                ...
                GenericJackson2JsonValkeySerializer.builder()
                        .objectMapper(
                                new ObjectMapper(new MessagePackFactory())
                                        .enableDefaultTyping(DefaultTyping.EVERYTHING, As.PROPERTY))
                        .build();
    ...
    private static void serializeAndDeserializeNullValue(
            GenericJackson2JsonValkeySerializer serializer) {
    ...
    @Nullable
    private TypeResolverBuilder<?> extractTypeResolver(
            GenericJackson2JsonValkeySerializer serializer) {
    ...
    static class WithWrapperTypes {
        ...
        public int hashCode() {
            return Objects.hash(
                    getPrimitiveWrapper(), getPrimitiveArrayWrapper(), getSimpleObjectWrapper());
        }
    }
