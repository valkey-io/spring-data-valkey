...
public class DefaultReactiveZSetOperationsIntegrationTests<K, V> {
    ...
    void addAll() {
        ...
        List<DefaultTypedTuple<V>> tuples =
                Arrays.asList(new DefaultTypedTuple<>(value1, 42.1d), new DefaultTypedTuple<>(value2, 10d));

        zSetOperations.addAll(key, tuples).as(StepVerifier::create).expectNext(2L).verifyComplete();

        List<DefaultTypedTuple<V>> updated =
                Arrays.asList(new DefaultTypedTuple<>(value1, 52.1d), new DefaultTypedTuple<>(value2, 10d));
    ...
    void randomMemberWithScore() {
        ...
        zSetOperations
                .randomMemberWithScore(key)
                .as(StepVerifier::create)
                .consumeNextWith(
                        actual -> {
                            assertThat(actual)
                                    .isIn(
                                            new DefaultTypedTuple<>(value1, 42.1d), new DefaultTypedTuple<>(value2, 10d));
                        })
                .verifyComplete();

        zSetOperations
                .randomMembersWithScore(key, 2)
                .as(StepVerifier::create)
                .expectNextCount(2)
                .verifyComplete();
        zSetOperations
                .distinctRandomMembersWithScore(key, 2)
                .as(StepVerifier::create)
                .expectNextCount(2)
                .verifyComplete();
    }
    ...
    void rangeWithScores() {
        ...
        zSetOperations
                .rangeWithScores(key, ZERO_RANGE)
                .as(StepVerifier::create) //
    ...
    void rangeByScore() {
        ...
        zSetOperations
                .rangeByScore(key, NINE_TO_ELEVEN_DOUBLE)
                .as(StepVerifier::create) //
                .expectNext(value2) //
                .verifyComplete();
    }
    ...
    void rangeByScoreWithScores() {
        ...
        zSetOperations
                .rangeByScoreWithScores(key, NINE_TO_ELEVEN_DOUBLE)
                .as(StepVerifier::create) //
                .expectNext(new DefaultTypedTuple<>(value2, 10d)) //
                .verifyComplete();
    }
    ...
    void reverseRangeWithScores() {
        ...
        zSetOperations
                .reverseRangeWithScores(key, ZERO_RANGE)
                .as(StepVerifier::create) //
                .expectNext(new DefaultTypedTuple<>(value1, 42.1)) //
                .verifyComplete();
    }
    ...
    void reverseRangeByScore() {
        ...
        zSetOperations
                .reverseRangeByScore(key, NINE_TO_ELEVEN_DOUBLE)
                .as(StepVerifier::create) //
                .expectNext(value2) //
                .verifyComplete();
    }
    ...
    void reverseRangeByScoreWithScores() {
        ...
        zSetOperations
                .reverseRangeByScoreWithScores(key, NINE_TO_ELEVEN_DOUBLE)
                .as(StepVerifier::create) //
                .expectNext(new DefaultTypedTuple<>(value2, 10d)) //
                .verifyComplete();
    }
    ...
    void rangeAndStoreByLex() {
        ...
        zSetOperations
                .rangeAndStoreByLex(key, destKey, Range.closed("a", "b"))
                .as(StepVerifier::create) //
                .expectNext(2L) //
                .verifyComplete();
    }
    ...
    void rangeAndStoreByScore() {
        ...
        zSetOperations
                .rangeAndStoreByScore(key, destKey, Range.closed(1.0, 2.0))
                .as(StepVerifier::create) //
                .expectNext(2L) //
                .verifyComplete();

        zSetOperations
                .range(destKey, Range.unbounded())
                .as(StepVerifier::create) //
                .expectNext(a) //
                .expectNext(b) //
                .verifyComplete();
    ...
    void reverseRangeAndStoreByLex() {
        ...
        zSetOperations
                .reverseRangeAndStoreByLex(key, destKey, Range.closed("a", "b"))
                .as(StepVerifier::create) //
                .expectNext(2L) //
                .verifyComplete();
    }
    ...
    void reverseRangeAndStoreByScore() {
        ...
        zSetOperations
                .reverseRangeAndStoreByScore(key, destKey, Range.closed(1.0, 2.0))
                .as(StepVerifier::create) //
                .expectNext(2L) //
                .verifyComplete();
        ...
        zSetOperations
                ...
                .consumeNextWith(
                        actual ->
                                assertThat(actual)
                                        .isIn(
                                                new DefaultTypedTuple<>(value1, 42.1),
    ...
    void count() {
        ...
        zSetOperations
                .count(key, ZERO_TO_HUNDRED_DOUBLE)
                .as(StepVerifier::create)
                .expectNext(2L)
                .expectComplete()
                .verify();
        zSetOperations
                .count(key, Range.closed(0d, 10d))
                .as(StepVerifier::create)
                .expectNext(1L)
                .verifyComplete();
    }
    ...
    void lexCount() {
        ...
        zSetOperations
                .lexCount(key, Range.unbounded())
                .as(StepVerifier::create)
                .expectNext(7L)
                .verifyComplete();
        zSetOperations
                .lexCount(key, Range.leftOpen("b", "f"))
                .as(StepVerifier::create)
                .expectNext(4L)
                .verifyComplete();
        zSetOperations
                .lexCount(key, Range.rightOpen("b", "f"))
                .as(StepVerifier::create)
                .expectNext(4L)
                .verifyComplete();
    }
    ...
    void popMin() {
        ...
        zSetOperations
                .popMin(key)
                .as(StepVerifier::create)
                .expectNext(new DefaultTypedTuple<>(value1, 1D))
                .verifyComplete();
        zSetOperations
                .popMin(key, Duration.ofSeconds(1))
                .as(StepVerifier::create)
                .expectNext(new DefaultTypedTuple<>(value2, 2D))
                .verifyComplete();
        zSetOperations
                .popMin(key, 2)
                .as(StepVerifier::create)
                .expectNext(new DefaultTypedTuple<>(value3, 3D))
                .expectNext(new DefaultTypedTuple<>(value4, 4D))
                .verifyComplete();
    }
    ...
    void popMax() {
        ...
        zSetOperations
                ...
                .verifyComplete();
        zSetOperations
                .popMax(key, Duration.ofSeconds(1))
                .as(StepVerifier::create)
                .expectNext(new DefaultTypedTuple<>(value3, 3D))
                .verifyComplete();
        zSetOperations
    ...
    void scores() {
        ...
        zSetOperations
                .score(key, value1, value2, valueFactory.instance())
                .as(StepVerifier::create)
                .expectNext(Arrays.asList(42.1d, 10d, null))
                .verifyComplete();
    }
    ...
    void removeRange() {
        ...
        zSetOperations
                .removeRange(key, ZERO_RANGE)
                .as(StepVerifier::create)
                .expectNext(1L)
                .verifyComplete();
        zSetOperations
                .range(key, ZERO_TO_FIVE)
                .as(StepVerifier::create)
                .expectNext(value1)
                .verifyComplete();
    }
    ...
    void removeRangeByScore() {
        ...
        zSetOperations
                .removeRangeByScore(key, NINE_TO_ELEVEN_DOUBLE)
                .as(StepVerifier::create)
                .expectNext(1L)
                .expectComplete()
                .verify();
    ...
    void difference() {
        ...
        zSetOperations
                .add(otherKey, onlyInOtherKey, 10)
                .as(StepVerifier::create)
                .expectNext(true)
                .verifyComplete();
        zSetOperations
                .add(otherKey, shared, 11)
                .as(StepVerifier::create)
                .expectNext(true)
                .verifyComplete();
        ...
        zSetOperations
                ...
                .as(StepVerifier::create)
                .expectNext(onlyInKey)
                .verifyComplete();

        zSetOperations
                .differenceWithScores(key, otherKey)
                .as(StepVerifier::create)
                .expectNext(new DefaultTypedTuple<>(onlyInKey, 10D))
                .verifyComplete();
    }
    ...
    void intersect() {
        ...
        zSetOperations
                ...
                .as(StepVerifier::create)
                .expectNext(new DefaultTypedTuple<>(shared, 22D))
                .verifyComplete();

        zSetOperations
                .intersectWithScores(key, Collections.singleton(otherKey), Aggregate.SUM, Weights.of(1, 2))
                .as(StepVerifier::create)
                .expectNext(new DefaultTypedTuple<>(shared, 33D))
                .verifyComplete();
    }
    ...
    void intersectAndStoreWithAggregation() {
        ...
        zSetOperations
                .intersectAndStore(key, Collections.singletonList(otherKey), destKey, Aggregate.SUM)
                .as(StepVerifier::create)
                .expectNext(1L)
                .expectComplete()
                .verify();
        ...
        zSetOperations
                .intersectAndStore(
                        key, Collections.singletonList(otherKey), destKey, Aggregate.SUM, Weights.of(1, 2))
                .as(StepVerifier::create)
                .expectNext(1L)
                .expectComplete()
                .verify();
        ...
        zSetOperations
                ...
                .assertNext(
                        actual -> {
                            assertThat(actual)
                                    .containsOnly(
                                            new DefaultTypedTuple<>(onlyInKey, 10D),
                                            new DefaultTypedTuple<>(shared, 22D),
                                            new DefaultTypedTuple<>(onlyInOtherKey, 10D));
                        })
                .verifyComplete();

        zSetOperations
                .unionWithScores(key, Collections.singleton(otherKey), Aggregate.SUM, Weights.of(1, 2))
                .collectList()
                .as(StepVerifier::create)
                .assertNext(
                        actual -> {
                            assertThat(actual)
                                    .containsOnly(
                                            new DefaultTypedTuple<>(onlyInKey, 10D),
                                            new DefaultTypedTuple<>(shared, 33D),
    ...
    void unionAndStore() {
        ...
        zSetOperations
                ...
                .verifyComplete();
        zSetOperations
                .range(destKey, Range.closed(0L, 100L))
                .as(StepVerifier::create)
                .expectNextCount(3)
                .verifyComplete();
    }
    ...
    void unionAndStoreWithAggregation() {
        ...
        zSetOperations
                .unionAndStore(key, Collections.singleton(otherKey), destKey, Aggregate.SUM)
                .as(StepVerifier::create)
                .expectNext(3L)
                .verifyComplete();
        ...
        zSetOperations
                .unionAndStore(
                        key, Collections.singleton(otherKey), destKey, Aggregate.SUM, Weights.of(2, 1))
                .as(StepVerifier::create)
                .expectNext(3L)
                .verifyComplete();
    ...
    void rangeByLexWithLimit() {
        ...
        zSetOperations
                .rangeByLex(key, aToZ, Limit.limit().offset(0).count(10))
                .as(StepVerifier::create) //
                .expectNext(a, b) //
                .verifyComplete();

        zSetOperations
                .rangeByLex(key, aToZ, Limit.limit().offset(1).count(10))
                .as(StepVerifier::create) //
                .expectNext(b) //
                .verifyComplete();
    }
    ...
    void reverseRangeByLex() {
        ...
        zSetOperations
                .reverseRangeByLex(key, Range.just("a"))
                .as(StepVerifier::create) //
                .expectNext(a) //
                .verifyComplete();
    }
    ...
    void reverseRangeByLexLimit() {
        ...
        zSetOperations
                .reverseRangeByLex(key, aToZ, Limit.limit().offset(0).count(10))
                .as(StepVerifier::create) //
                .expectNext(b, a) //
                .verifyComplete();

        zSetOperations
                .reverseRangeByLex(key, aToZ, Limit.limit().offset(1).count(10))
                .as(StepVerifier::create) //
                .expectNext(a) //
                .verifyComplete();
    }
