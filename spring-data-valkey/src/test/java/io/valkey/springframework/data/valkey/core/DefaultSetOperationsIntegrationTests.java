...
public class DefaultSetOperationsIntegrationTests<K, V> {
    ...
    public DefaultSetOperationsIntegrationTests(
    ...
    void diffAndStoreShouldReturnDifferenceShouldReturnNumberOfElementsInDestination() {
        ...
        assertThat(setOps.differenceAndStore(Arrays.asList(sourceKey1, sourceKey2), destinationKey))
                .isEqualTo(1L);
    }
    ...
    void unionAndStoreShouldReturnDifferenceShouldReturnNumberOfElementsInDestination() {
        ...
        assertThat(setOps.unionAndStore(Arrays.asList(sourceKey1, sourceKey2), destinationKey))
                .isEqualTo(4L);
    }
    ...
    void intersectAndStoreShouldReturnNumberOfElementsInDestination() {
        ...
        assertThat(setOps.intersectAndStore(Arrays.asList(sourceKey1, sourceKey2), destinationKey))
                .isEqualTo(2L);
    }
    ...
    void isMember() {
        ...
        assertThat(setOps.isMember(key, v1, v2, v3, v4))
                .containsEntry(v1, true)
                .containsEntry(v2, true)
                .containsEntry(v3, true)
                .containsEntry(v4, false);
    }
}
