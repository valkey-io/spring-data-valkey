...
/**
 * Unit tests for {@link GenericJacksonJsonValkeySerializer}.
 *
 * @author Christoph Strobl
 * @author Mark Paluch
 * @author John Blum
 */
class GenericJacksonJsonValkeySerializerUnitTests {
	...
	private final GenericJacksonJsonValkeySerializer serializer = GenericJacksonJsonValkeySerializer
	...
	void deserializeShouldBeAbleToRestoreSimpleObjectAfterSerialization() {
		...
		GenericJacksonJsonValkeySerializer serializer = this.serializer;
	...
	void serializeShouldThrowSerializationExceptionProcessingError() {
		...
		assertThatExceptionOfType(SerializationException.class)
				.isThrownBy(() -> new GenericJacksonJsonValkeySerializer(objectMapperMock).serialize(SIMPLE_OBJECT));
	}
	...
	void deserializeShouldThrowSerializationExceptionProcessingError() throws IOException {
		...
		assertThatExceptionOfType(SerializationException.class)
				.isThrownBy(() -> new GenericJacksonJsonValkeySerializer(objectMapperMock).deserialize(new byte[] { 1 }));
	}
	...
	void shouldSerializeNullValueWithCustomObjectMapper() {
		...
		GenericJacksonJsonValkeySerializer serializer = GenericJacksonJsonValkeySerializer.create(configHelper -> {
	...
	void deserializeShouldBeAbleToRestoreFinalObjectAfterSerialization() {
		...
		assertThat(serializer.deserialize(
				("{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJacksonJsonValkeySerializerUnitTests$FinalObject\",\"longValue\":1,\"myArray\":[1,2,3],\n"
						+ "\"simpleObject\":{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJacksonJsonValkeySerializerUnitTests$SimpleObject\",\"longValue\":2}}")
						.getBytes()))
				.isEqualTo(source);
	}
	...
	void shouldDeserializePrimitiveArrayWithoutTypeHint() {
		...
		GenericJacksonJsonValkeySerializer gs = serializer;
		CountAndArray result = (CountAndArray) gs.deserialize(
				("{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJacksonJsonValkeySerializerUnitTests$CountAndArray\", \"count\":1, \"available\":[0,1]}")
						.getBytes());
	...
	void readsToMapForNonDefaultTyping() {
		...
		GenericJacksonJsonValkeySerializer serializer = new GenericJacksonJsonValkeySerializer(JsonMapper.shared());
	...
	void shouldDeserializePrimitiveWrapperArrayWithoutTypeHint() {
		...
		GenericJacksonJsonValkeySerializer gs = this.serializer;
		CountAndArray result = (CountAndArray) gs.deserialize(
				("{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJacksonJsonValkeySerializerUnitTests$CountAndArray\", \"count\":1, \"arrayOfPrimitiveWrapper\":[0,1]}")
						.getBytes());
	...
	void includesTypingForWrappedObjectTypes() {
		...
		assertThat(new String(serializedValue)) //
				.contains(
						"\"simpleObjectWrapper\":{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJacksonJsonValkeySerializerUnitTests$SimpleObject\",\"longValue\":100}");
	...
	void serializesJavaTimeIntoBytes() {
		...
		assertThat(serialized).isEqualTo(
				("{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJacksonJsonValkeySerializerUnitTests$WithJsr310\",\"myDate\":\"2022-09-02\"}")
	...
	void deserializesJavaTimeFromBytes() {
		...
		byte[] source = "{\"@class\":\"io.valkey.springframework.data.valkey.serializer.GenericJacksonJsonValkeySerializerUnitTests$WithJsr310\",\"myDate\":\"2022-09-02\"}"
				.getBytes(StandardCharsets.UTF_8);
	...
	void configuresObjectMapper() {
		...
		GenericJacksonJsonValkeySerializer serializer = GenericJacksonJsonValkeySerializer
	...
	void configuresJsonMapper() {
		...
		GenericJacksonJsonValkeySerializer serializer = GenericJacksonJsonValkeySerializer.create(b -> {
	...
	private static void serializeAndDeserializeNullValue(GenericJacksonJsonValkeySerializer serializer) {
	...
	private @Nullable TypeResolverBuilder<?> extractTypeResolver(GenericJacksonJsonValkeySerializer serializer) {
