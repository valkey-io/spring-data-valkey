...
public class LettuceReactiveHashCommandsIntegrationTests extends LettuceReactiveCommandsTestSupport {
	...
	void hSetExShouldSetFieldsWithUpsertCondition() {
		...
		connection.hashCommands()
				.hSetEx(KEY_1_BBUFFER, fieldMap, ValkeyHashCommands.HashFieldSetOption.upsert(), Expiration.seconds(60))
	...
	void hSetExShouldSucceedWithIfNoneExistWhenNoFieldsExist() {
		...
		connection.hashCommands()
				.hSetEx(KEY_1_BBUFFER, fieldMap, ValkeyHashCommands.HashFieldSetOption.ifNoneExist(), Expiration.seconds(60))
				.as(StepVerifier::create).expectNext(true).verifyComplete();
	...
	void hSetExShouldSucceedWithIfAllExistWhenAllFieldsExist() {
		...
		connection.hashCommands()
				.hSetEx(KEY_1_BBUFFER, fieldMap, ValkeyHashCommands.HashFieldSetOption.ifAllExist(), Expiration.seconds(60))
				.as(StepVerifier::create).expectNext(true).verifyComplete();
