 ...
 */
public class LettuceReactiveHashCommandsIntegrationTests
    ...
    void hSetShouldOperateCorrectly() {
        ...
        connection
                .hashCommands()
                .hSet(KEY_1_BBUFFER, FIELD_1_BBUFFER, VALUE_1_BBUFFER)
    ...
    void hSetNxShouldOperateCorrectly() {
        connection
                .hashCommands()
                .hSetNX(KEY_1_BBUFFER, FIELD_1_BBUFFER, VALUE_1_BBUFFER)
                .as(StepVerifier::create)
                .expectNext(true)
                .verifyComplete();
    }
    ...
    void hGetShouldReturnValueForExistingField() {
        ...
        connection
                .hashCommands()
                .hGet(KEY_1_BBUFFER, FIELD_1_BBUFFER)
                .as(StepVerifier::create)
    ...
    void hGetShouldReturnNullForNotExistingField() {
        ...
        connection
                .hashCommands()
                .hGet(KEY_1_BBUFFER, FIELD_2_BBUFFER)
                .as(StepVerifier::create)
                .verifyComplete();
    }
    ...
    void hMGetShouldReturnValueForFields() {
        ...
        connection
                .hashCommands()
                .hMGet(KEY_1_BBUFFER, Arrays.asList(FIELD_1_BBUFFER, FIELD_3_BBUFFER))
                .as(StepVerifier::create)
                .consumeNextWith(
                        actual -> {
    ...
    void hMGetShouldReturnNullValueForFieldsThatHaveNoValue() {
        ...
        connection
                .hashCommands()
                .hMGet(KEY_1_BBUFFER, Collections.singletonList(FIELD_1_BBUFFER))
                .as(StepVerifier::create)
                .expectNext(Collections.singletonList(VALUE_1_BBUFFER))
                .verifyComplete();

        connection
                .hashCommands()
                .hMGet(KEY_1_BBUFFER, Collections.singletonList(FIELD_2_BBUFFER))
                .as(StepVerifier::create)
        ...
        connection
                .hashCommands()
                .hMGet(KEY_1_BBUFFER, Arrays.asList(FIELD_1_BBUFFER, FIELD_2_BBUFFER, FIELD_3_BBUFFER))
                .as(StepVerifier::create)
                .expectNext(Arrays.asList(VALUE_1_BBUFFER, null, VALUE_3_BBUFFER))
                .verifyComplete();
    }
    ...
    void hMSetSouldSetValuesCorrectly() {
        ...
        connection
                .hashCommands()
                .hMSet(KEY_1_BBUFFER, fieldValues)
                .as(StepVerifier::create)
                .expectNext(true)
                .verifyComplete();
    ...
    void hMSetShouldOverwriteValuesCorrectly() {
        ...
        connection
                .hashCommands()
                .hMSet(KEY_1_BBUFFER, overwriteFieldValues)
                .as(StepVerifier::create)
                .expectNext(true)
                .verifyComplete();
    ...
    void hExistsShouldReturnTrueForExistingField() {
        ...
        connection
                .hashCommands()
                .hExists(KEY_1_BBUFFER, FIELD_1_BBUFFER)
                .as(StepVerifier::create)
                .expectNext(true)
                .verifyComplete();
    }
    ...
    void hDelShouldRemoveSingleFieldsCorrectly() {
        ...
        connection
                .hashCommands()
                .hDel(KEY_1_BBUFFER, FIELD_2_BBUFFER)
                .as(StepVerifier::create)
                .expectNext(true)
                .verifyComplete();
    }
    ...
    void hDelShouldRemoveMultipleFieldsCorrectly() {
        ...
        connection
                .hashCommands()
                .hDel(KEY_1_BBUFFER, Arrays.asList(FIELD_1_BBUFFER, FIELD_3_BBUFFER))
                .as(StepVerifier::create)
                .expectNext(2L)
                .verifyComplete();
    }
    ...
    void hScanShouldIterateOverHash() {
        ...
        connection
                .hashCommands()
                .hScan(KEY_1_BBUFFER, ScanOptions.scanOptions().count(1).build())
                .as(StepVerifier::create) //
                .expectNextCount(3) //
                .verifyComplete();
    }
    ...
    void hStrLenReturnsFieldLength() {
        ...
        connection
                .hashCommands()
                .hStrLen(KEY_1_BBUFFER, FIELD_1_BBUFFER)
                .as(StepVerifier::create)
    ...
    void hExpireShouldHandleMultipleParametersCorrectly() {
        ...
        connection
                .hashCommands()
                .hExpire(KEY_1_BBUFFER, Duration.ofSeconds(1), fields)
                .as(StepVerifier::create) //
                .expectNext(1L)
                .expectNext(1L)
                .expectNext(-2L)
        ...
        assertThat(nativeCommands.httl(KEY_1, FIELD_1))
                .allSatisfy(it -> assertThat(it).isBetween(0L, 1000L));
        assertThat(nativeCommands.httl(KEY_1, FIELD_2))
                .allSatisfy(it -> assertThat(it).isBetween(0L, 1000L));
    ...
    void hExpireAtShouldHandleMultipleParametersCorrectly() {
        ...
        connection
                .hashCommands()
                .hExpireAt(KEY_1_BBUFFER, Instant.now().plusSeconds(1), fields)
                .as(StepVerifier::create) //
                .expectNext(1L)
                .expectNext(1L)
                .expectNext(-2L)
        ...
        assertThat(nativeCommands.httl(KEY_1, FIELD_1, FIELD_2))
                .allSatisfy(it -> assertThat(it).isBetween(0L, 1000L));
        assertThat(nativeCommands.httl(KEY_1, FIELD_3)).allSatisfy(it -> assertThat(it).isEqualTo(-2L));
    }
