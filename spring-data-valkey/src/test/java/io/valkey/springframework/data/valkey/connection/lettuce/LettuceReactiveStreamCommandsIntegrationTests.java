...
public class LettuceReactiveStreamCommandsIntegrationTests
    ...
    void xAddShouldAddMessage() {
        ...
        connection
                .streamCommands()
                .xAdd(KEY_1_BBUFFER, Collections.singletonMap(KEY_2_BBUFFER, VALUE_2_BBUFFER)) //
    ...
    void xRangeShouldReportMessages() {
        ...
        connection
                .streamCommands()
                .xAdd(KEY_1_BBUFFER, Collections.singletonMap(KEY_1_BBUFFER, VALUE_1_BBUFFER)) //
                .as(StepVerifier::create) //
                .expectNextCount(1) //
                .verifyComplete();
        ...
        connection
                .streamCommands()
                .xRange(KEY_1_BBUFFER, Range.unbounded()) //
                .as(StepVerifier::create) //
                .assertNext(
                        it -> {
        ...
        connection
                .streamCommands()
                .xRange(KEY_1_BBUFFER, Range.unbounded(), Limit.limit().count(1)) //
                .as(StepVerifier::create) //
                .assertNext(
                        it -> {
                            assertThat(it.getStream()).isEqualTo(KEY_1_BBUFFER);
    ...
    void xReadShouldReadMessage() {
        ...
        connection
                .streamCommands()
                .xRead(StreamOffset.create(KEY_1_BBUFFER, ReadOffset.from("0-0"))) //
                .as(StepVerifier::create) //
                .assertNext(
                        it -> {
                            assertThat(it.getStream()).isEqualTo(KEY_1_BBUFFER);
    ...
    void xRevRangeShouldReportMessages() {
        ...
        connection
                .streamCommands()
                .xRevRange(KEY_1_BBUFFER, Range.unbounded(), Limit.limit().count(1)) //
                .as(StepVerifier::create) //
                .assertNext(
                        it -> {
                            assertThat(it.getStream()).isEqualTo(KEY_1_BBUFFER);
    ...
    void xGroupCreateShouldCreateGroup() {
        ...
        connection
                .streamCommands()
                .xGroupCreate(KEY_1_BBUFFER, "group-1", ReadOffset.latest()) //
                .as(StepVerifier::create) //
                .expectNext("OK") //
                .verifyComplete();
    }
    ...
    void xGroupCreateShouldCreateGroupBeforeStream() {
        connection
                .streamCommands()
                .xGroupCreate(KEY_1_BBUFFER, "group-1", ReadOffset.latest(), false)
                .as(StepVerifier::create) //
        ...
        connection
                .streamCommands()
                .xGroupCreate(KEY_1_BBUFFER, "group-1", ReadOffset.latest(), true) //
                .as(StepVerifier::create) //
                .expectNext("OK") //
                .verifyComplete();
    }
    ...
    void xGroupDelConsumerShouldRemoveConsumer() {
        ...
        nativeCommands.xreadgroup(
                io.lettuce.core.Consumer.from("group-1", "consumer-1"),
                XReadArgs.StreamOffset.from(KEY_1, id));

        connection
                .streamCommands()
                .xGroupDelConsumer(KEY_1_BBUFFER, Consumer.from("group-1", "consumer-1"))
                .as(StepVerifier::create) //
                .expectNext("OK") //
                .verifyComplete();
    }
    ...
    void xGroupDestroyShouldDestroyGroup() {
        ...
        connection
                .streamCommands()
                .xGroupDestroy(KEY_1_BBUFFER, "group-1")
                .as(StepVerifier::create) //
                .expectNext("OK") //
                .verifyComplete();
    }
    ...
    void xPendingShouldLoadOverviewCorrectly() {
        ...
        connection
                .streamCommands()
                .xPending(KEY_1_BBUFFER, "my-group")
                .as(StepVerifier::create)
                .assertNext(
                        it -> {
                            ...
                            assertThat(it.getPendingMessagesPerConsumer())
                                    .hasSize(1)
                                    .containsEntry("my-consumer", 1L);
                        })
                .verifyComplete();
    }
    ...
    void xPendingShouldLoadPendingMessages() {
        ...
        connection
                .streamCommands()
                .xPending(KEY_1_BBUFFER, "my-group", Range.open("-", "+"), 10L)
                .as(StepVerifier::create)
                .assertNext(
                        it -> {
    ...
    void xPendingShouldLoadPendingMessagesForConsumer() {
        ...
        connection
                .streamCommands()
                .xPending(KEY_1_BBUFFER, "my-group", "my-consumer", Range.open("-", "+"), 10L)
                .as(StepVerifier::create)
                .assertNext(
                        it -> {
                            assertThat(it.size()).isOne();
    ...
    void xPendingShouldLoadPendingMessagesForNonExistingConsumer() {
        ...
        connection
                .streamCommands()
                .xPending(KEY_1_BBUFFER, "my-group", "my-consumer-2", Range.open("-", "+"), 10L)
                .as(StepVerifier::create)
                .assertNext(
                        it -> {
    ...
    void xinfo() {
        ...
        nativeCommands.xreadgroup(
                io.lettuce.core.Consumer.from("my-group", "my-consumer"),
    ...
    void xinfoConsumers() {
        ...
        connection
                .streamCommands()
                .xInfoConsumers(KEY_1_BBUFFER, "my-group")
                .as(StepVerifier::create) //
                .consumeNextWith(
                        info -> {
                            assertThat(info.groupName()).isEqualTo("my-group");
