...
public abstract class AbstractConnectionIntegrationTests {
    ...
    @Autowired @EnabledOnValkeyDriver.DriverQualifier
    ...
    private boolean isJedisOrLettuceConnection(ValkeyConnectionFactory connectionFactory) {
        return ConnectionUtils.isJedis(connectionFactory)
                || ConnectionUtils.isLettuce(connectionFactory);
    }
    ...
    void testExpireWithArgs() {
        ...
        actual.add(connection.set("exp", "true"));
        actual.add(
                connection.applyExpiration(
                        "exp".getBytes(), Expiration.from(Duration.ofMinutes(1)), ExpirationOptions.none()));
        actual.add(
                connection.applyExpiration(
                        "exp".getBytes(),
        ...
        actual.add(
                connection.applyExpiration(
                        "exp".getBytes(),
                        Expiration.from(Duration.ofMinutes(2)),
    ...
    public void testEvalShaArrayError() {
        assertThatExceptionOfType(ValkeySystemException.class)
                .isThrownBy(
                        () -> {
    ...
    void testLMove() {
        ...
        actual.add(
                connection.lMove(
                        "From", "To", ValkeyListCommands.Direction.LEFT, ValkeyListCommands.Direction.RIGHT));
        actual.add(connection.lRange("From", 0, -1));
        actual.add(connection.lRange("To", 0, -1));

        verifyResults(
                Arrays.asList(
                        1L, 2L, 3L, 1L, "hello", Arrays.asList("big", "world"), Arrays.asList("bar", "hello")));
    }
    ...
    void testBLMove() {
        ...
        verifyResults(
                Arrays.asList(
                        1L, 2L, "hello", "big", null, Collections.emptyList(), Arrays.asList("hello", "big")));
    }
    ...
    void testRPopLPush() {
        ...
        verifyResults(
                Arrays.asList(1L, 2L, 1L, "world", Arrays.asList("hello"), Arrays.asList("world", "hey")));
    }
    ...
    void testSDiff() {
        ...
        verifyResults(
                Arrays.asList(new Object[] {1L, 1L, 1L, new HashSet<>(Collections.singletonList("foo"))}));
    }
    ...
    void testSDiffStore() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {1L, 1L, 1L, 1L, new HashSet<>(Collections.singletonList("foo"))}));
    }
    ...
    void testSInter() {
        ...
        verifyResults(
                Arrays.asList(new Object[] {1L, 1L, 1L, new HashSet<>(Collections.singletonList("bar"))}));
    }
    ...
    void testSInterStore() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {1L, 1L, 1L, 1L, new HashSet<>(Collections.singletonList("bar"))}));
    }
    ...
    void testSRem() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {1L, 1L, 1L, 0L, new HashSet<>(Collections.singletonList("bar"))}));
    }
    ...
    void testSRemMultiple() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {1L, 1L, 1L, 2L, new HashSet<>(Collections.singletonList("bar"))}));
    }
    ...
    void testSUnion() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {1L, 1L, 1L, 1L, new HashSet<>(Arrays.asList("foo", "bar", "baz"))}));
    }
    ...
    void testZAddAndZRange() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {true, true, new LinkedHashSet<>(Arrays.asList("James", "Bob"))}));
    }
    ...
    void testZAddMultiple() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {2L, 1L, new LinkedHashSet<>(Arrays.asList("James", "Bob", "Joe"))}));
    }
    ...
    void zPopMin() {
        ...
        assertThat((Collection) results.get(6))
                .containsExactly(
                        new DefaultStringTuple("c".getBytes(), "c", 3D),
    ...
    void zPopMax() {
        ...
        assertThat((Collection) results.get(6))
                .containsExactly(
                        new DefaultStringTuple("b".getBytes(), "b", 2D),
    ...
    void testZIncrBy() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {
                            true, true, true, 6d, new LinkedHashSet<>(Collections.singletonList("Joe"))
                        }));
    }
    ...
    void testZDiffStore() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {true, true, true, true, true, 1L, Collections.singleton("Joe")}));
    }
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {
                            ...
                            new LinkedHashSet<>(
                                    Arrays.asList(
                                            new DefaultStringTuple("Bob", 3d), new DefaultStringTuple("James", 5)))
                        }));
    }
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {
                            ...
                            new LinkedHashSet<>(
                                    Arrays.asList(
                                            new DefaultStringTuple("Bob", 4d), new DefaultStringTuple("James", 12d)))
                        }));
    }
    ...
    void testZInterStore() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {
                            true, true, true, true, true, 2L, new LinkedHashSet<>(Arrays.asList("Bob", "James"))
                        }));
    }
    ...
    void testZInterStoreAggWeights() {
        ...
        actual.add(connection.zAdd("otherset", 4, "James"));
        actual.add(
                connection.zInterStore("thirdset", Aggregate.MAX, new int[] {2, 3}, "myset", "otherset"));
    ...
    void testZRevRange() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {true, true, new LinkedHashSet<>(Arrays.asList("Bob", "James"))}));
    }
    ...
    void testZRemMultiple() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {
                            true, true, true, true, 2L, new LinkedHashSet<>(Arrays.asList("Joe", "Bob"))
                        }));
    }
    ...
    void testZRemRangeByScore() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {true, true, 1L, new LinkedHashSet<>(Collections.singletonList("Bob"))}));
    }
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {
                            ...
                            true,
                            true,
                            new LinkedHashSet<>(Arrays.asList("Bob", "James", "Joe")),
                            new LinkedHashSet<>(
                                    Arrays.asList(
                                            new DefaultStringTuple("Bob", 3d),
    ...
    void testZUnionStoreAggWeights() {
        ...
        actual.add(connection.zAdd("otherset", 4, "James"));
        actual.add(
                connection.zUnionStore("thirdset", Aggregate.MAX, new int[] {2, 3}, "myset", "otherset"));
        actual.add(connection.zRangeWithScores("thirdset", 0, -1));
        verifyResults(
                Arrays.asList(
                        new Object[] {
    ...
    void testHKeys() {
        ...
        verifyResults(
                Arrays.asList(
                        new Object[] {true, true, new LinkedHashSet<>(Arrays.asList("key", "key2"))}));
    }
    ...
    public void testGetTimeShouldRequestServerTimeAsMicros() {
        ...
        Instant micros =
                reference.plus(Duration.ofNanos(TimeUnit.MICROSECONDS.toNanos((Long) results.get(0))));

        Instant seconds =
                reference.plus(Duration.ofNanos(TimeUnit.SECONDS.toNanos((Long) results.get(1))));
    ...
    void scanShouldReadEntireValueRange() {
        ...
        if (isPipelinedOrQueueingConnection(connection)) {
            throw new AssumptionViolatedException(
                    "SCAN is only available in non-pipeline | non-queueing mode");
        }
                ...
                .forEach(
                        it ->
                                byteConnection
                                        .stringCommands()
                                        .set(
                                                "key:%s".formatted(it).getBytes(StandardCharsets.UTF_8),
                                                "data".getBytes(StandardCharsets.UTF_8)));
        byteConnection.closePipeline();

        Cursor<byte[]> cursor =
                connection.scan(ScanOptions.scanOptions().match("key*9").count(10).build());
    ...
    void sScanShouldReadEntireValueRange() {
        ...
        Cursor<String> cursor =
                connection.sScan("sscankey", scanOptions().count(2).match("fo*").build());
    ...
    void hScanShouldReadEntireValueRange() {
        ...
        Cursor<Map.Entry<String, String>> cursor =
                connection.hScan("hscankey", scanOptions().count(2).match("fo*").build());
    ...
    void pfCountWithNullKeysShouldThrowIllegalArgumentException() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> actual.add(connection.pfCount((String[]) null)));
    }
    ...
    void zRangeByLexTest() {
        ...
        actual.add(
                connection.zRangeByLex(
                        "myzset", Range.leftUnbounded(Bound.inclusive("c")), Limit.unlimited()));
        actual.add(
                connection.zRangeByLex(
                        "myzset", Range.leftUnbounded(Bound.inclusive("c")), Limit.limit().count(1)));
        actual.add(
                connection.zRangeByLex(
                        "myzset", Range.leftUnbounded(Bound.inclusive("c")), Limit.limit().count(1).offset(1)));

        List<Object> results = getResults();

        assertThat((Set<String>) results.get(7))
                .containsExactly("a", "b", "c")
                .doesNotContain("d", "e", "f", "g");
        assertThat((Set<String>) results.get(8)).containsExactly("a", "b").doesNotContain("c");
        assertThat((Set<String>) results.get(9))
                .containsExactly("b", "c", "d", "e", "f")
                .doesNotContain("a", "g");
        assertThat((Set<String>) results.get(10))
                .containsExactly("e", "f", "g")
                .doesNotContain("a", "b", "c", "d");
        assertThat((Set<String>) results.get(11))
                .containsExactly("a", "b", "c")
                .doesNotContain("d", "e", "f", "g");
        assertThat((Set<String>) results.get(12))
                .contains("a")
                .doesNotContain("b", "c", "d", "e", "f", "g");
        assertThat((Set<String>) results.get(13))
                .contains("b")
                .doesNotContain("a", "c", "d", "e", "f", "g");
    }
    ...
    public void zRevRangeByLexTest() {
        ...
        actual.add(
                connection.zRevRangeByLex(
                        "myzset", Range.leftUnbounded(Bound.inclusive("c")), Limit.unlimited()));
        actual.add(
                connection.zRevRangeByLex(
                        "myzset", Range.leftUnbounded(Bound.inclusive("d")), Limit.limit().count(2)));
        actual.add(
                connection.zRevRangeByLex(
                        "myzset", Range.leftUnbounded(Bound.inclusive("d")), Limit.limit().count(2).offset(1)));
        ...
        assertThat((Set<String>) results.get(12))
                .contains("d", "c")
                .doesNotContain("a", "b", "e", "f", "g");
        assertThat((Set<String>) results.get(13))
                .contains("c", "b")
                .doesNotContain("a", "d", "e", "f", "g");
    }
    ...
    void setWithNullExpirationAndUpsertOpionShouldThrowException() {
        ...
        String key = "exp-" + UUID.randomUUID();
        assertThatIllegalArgumentException()
                .isThrownBy(() -> connection.set(key, "foo", null, SetOption.upsert()));
    }
    ...
    void geoDist() {
        ...
        List<Object> result = getResults();
        assertThat(((Distance) result.get(1)).getValue())
                .isCloseTo(166274.15156960033D, Offset.offset(0.005));
    ...
    void geoDistWithMetric() {
        ...
        List<Object> result = getResults();
        assertThat(((Distance) result.get(1)).getValue())
                .isCloseTo(166.27415156960033D, Offset.offset(0.005));
    ...
    void geoPosition() {
        ...
        List<Object> result = getResults();
        assertThat(((List<Point>) result.get(1)).get(0).getX())
                .isCloseTo(POINT_PALERMO.getX(), Offset.offset(0.005));
        assertThat(((List<Point>) result.get(1)).get(0).getY())
                .isCloseTo(POINT_PALERMO.getY(), Offset.offset(0.005));

        assertThat(((List<Point>) result.get(1)).get(1).getX())
                .isCloseTo(POINT_CATANIA.getX(), Offset.offset(0.005));
        assertThat(((List<Point>) result.get(1)).get(1).getY())
                .isCloseTo(POINT_CATANIA.getY(), Offset.offset(0.005));
    }
    ...
    void geoPositionNonExisting() {
        ...
        assertThat(((List<Point>) result.get(1)).get(2).getX())
                .isCloseTo(POINT_CATANIA.getX(), Offset.offset(0.005));
        assertThat(((List<Point>) result.get(1)).get(2).getY())
                .isCloseTo(POINT_CATANIA.getY(), Offset.offset(0.005));
    }
    ...
    void geoRadiusShouldReturnMembersCorrectly() {
        ...
        actual.add(
                connection.geoRadius(key, new Circle(new Point(15D, 37D), new Distance(200D, KILOMETERS))));
        actual.add(
                connection.geoRadius(key, new Circle(new Point(15D, 37D), new Distance(150D, KILOMETERS))));
    ...
    void geoRadiusShouldReturnDistanceCorrectly() {
        ...
        assertThat(((GeoResults<GeoLocation<String>>) results.get(1)).getContent()).hasSize(3);
        assertThat(
                        ((GeoResults<GeoLocation<String>>) results.get(1))
                                .getContent()
                                .get(0)
                                .getDistance()
                                .getValue())
    ...
    void geoRadiusByMemberShouldApplyLimit() {
        ...
        actual.add(
                connection.geoRadiusByMember(
                        key, PALERMO.getName(), new Distance(200, KILOMETERS), newGeoRadiusArgs().limit(2)));
    ...
    void geoSearchByMemberShouldReturnMembersCorrectly() {
        ...
        actual.add(
                connection.geoSearch(
                        key,
                        GeoReference.fromMember(PALERMO),
                        GeoShape.byRadius(new Distance(200, KILOMETERS)),
                        newGeoSearchArgs().limit(2)));

        List<Object> results = getResults();
        List<GeoResult<GeoLocation<String>>> content =
                ((GeoResults<GeoLocation<String>>) results.get(1)).getContent();
    ...
    void geoSearchByPointShouldReturnMembersCorrectly() {
        ...
        actual.add(
                connection.geoSearch(
                        key,
                        GeoReference.fromCoordinate(PALERMO),
                        GeoShape.byRadius(new Distance(200, KILOMETERS)),
                        newGeoSearchArgs().limit(2)));
    ...
    public void hExpireReturnsSuccessAndSetsTTL() {
        ...
        assertThat((List) results.get(2))
                .allSatisfy(value -> assertThat((Long) value).isBetween(0L, 5L));
    }
    ...
    public void hpExpireReturnsSuccessAndSetsTTL() {
        ...
        assertThat((List) results.get(1)).contains(1L);
        assertThat((List) results.get(2))
                .allSatisfy(value -> assertThat((Long) value).isBetween(0L, 5000L));
    }
    ...
    void bitFieldSetShouldWorkCorrectly() {
        ...
        actual.add(
                connection.bitfield(
                        KEY_1, create().set(INT_8).valueAt(BitFieldSubCommands.Offset.offset(0L)).to(10L)));
        actual.add(
                connection.bitfield(
                        KEY_1, create().set(INT_8).valueAt(BitFieldSubCommands.Offset.offset(0L)).to(20L)));
    ...
    void bitFieldGetShouldWorkCorrectly() {
        ...
        actual.add(
                connection.bitfield(
                        KEY_1, create().get(INT_8).valueAt(BitFieldSubCommands.Offset.offset(0L))));
    ...
    void bitFieldIncrByShouldWorkCorrectly() {
        ...
        actual.add(
                connection.bitfield(
                        KEY_1, create().incr(INT_8).valueAt(BitFieldSubCommands.Offset.offset(100L)).by(1L)));
    ...
    void bitFieldIncrByAndThenGetShouldWorkCorrectly(boolean isMultipliedByTypeLengthOffset) {
        ...
        var offset =
                isMultipliedByTypeLengthOffset
    ...
    void xAddShouldTrimStreamExactly() {
        ...
        actual.add(
                connection.xAdd(
                        StringRecord.of(Collections.singletonMap(KEY_2, VALUE_2)).withStreamKey(KEY_1),
                        xAddOptions));
        actual.add(
                connection.xAdd(
                        StringRecord.of(Collections.singletonMap(KEY_2, VALUE_2)).withStreamKey(KEY_1),
    ...
    void xAddShouldTrimStreamApprox() {
        ...
        ValkeyStreamCommands.XAddOptions xAddOptions =
                ValkeyStreamCommands.XAddOptions.maxlen(1).approximateTrimming(true);
        actual.add(
                connection.xAdd(
                        StringRecord.of(Collections.singletonMap(KEY_2, VALUE_2)).withStreamKey(KEY_1),
                        xAddOptions));
    ...
    public void xRevRangeShouldWorkWithBoundedRange() {
        ...
        actual.add(connection.xAdd(KEY_1, Collections.singletonMap(KEY_3, VALUE_3)));
        actual.add(
                connection.xRevRange(KEY_1, org.springframework.data.domain.Range.closed("0-0", "+")));
    ...
    public void xPendingShouldLoadPendingMessages() {
        ...
        actual.add(
                connection.xPending(
                        KEY_1, "my-group", org.springframework.data.domain.Range.unbounded(), 10L));
    ...
    public void xPendingShouldWorkWithBoundedRange() {
        ...
        actual.add(
                connection.xPending(
                        KEY_1, "my-group", org.springframework.data.domain.Range.closed("0-0", "+"), 10L));
    ...
    public void xClaim() throws InterruptedException {
        ...
        List<MapRecord<String, String, String>> messages =
                (List<MapRecord<String, String, String>>) getResults().get(2);
        ...
        List<MapRecord<String, String, String>> claimed =
                (List<MapRecord<String, String, String>>) getResults().get(3);
    ...
    public void xinfo() {
        ...
        actual.add(
                connection.xGroupCreate(KEY_1, ReadOffset.from("0"), "my-group-without-stream", true));
        actual.add(connection.xAdd(KEY_1, Collections.singletonMap(KEY_2, VALUE_2)));
        actual.add(connection.xAdd(KEY_1, Collections.singletonMap(KEY_3, VALUE_3)));
        actual.add(connection.xGroupCreate(KEY_1, ReadOffset.from("0"), "my-group"));
        actual.add(
    ...
    public void zRangeStoreByLexStoresKeys() {
        ...
        actual.add(
                connection.zRangeStoreByLex(
                        dstKey, srcKey, Range.rightUnbounded(Bound.inclusive(VALUE_3))));
        actual.add(connection.zRange(dstKey, 0, -1));
        List<Object> result = getResults();
        assertThat(result.get(0)).isEqualTo(true);
        assertThat(result.get(1)).isEqualTo(true);
    ...
    public void zRangeStoreRevByLexStoresKeys() {
        ...
        actual.add(connection.zAdd(srcKey, 0, VALUE_2));
        actual.add(
                connection.zRangeStoreRevByLex(
                        dstKey, srcKey, Range.rightUnbounded(Bound.inclusive(VALUE_3))));
        actual.add(connection.zRange(dstKey, 0, -1));
        List<Object> result = getResults();
        assertThat(result.get(0)).isEqualTo(true);
