...
/**
 * Utility class exposing connection settings to connect Valkey instances during test execution.
 * Settings can be adjusted by overriding these in {@literal
 * io/valkey/springframework/data/valkey/test.properties}.
 *
 * @author Costin Leau
 * @author Mark Paluch
 * @author John Blum
...
public abstract class SettingsUtils {
    ...
    static {
        ...
        try {
            SETTINGS.load(
                    SettingsUtils.class.getResourceAsStream(
                            "/io/valkey/springframework/data/valkey/test.properties"));
