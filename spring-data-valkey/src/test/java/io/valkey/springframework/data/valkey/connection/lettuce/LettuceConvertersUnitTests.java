...
class LettuceConvertersUnitTests {
    ...
    void convertingMultipleLiesToListOfValkeyClientInfoReturnsListCorrectly() {
        ...
        assertThat(LettuceConverters.toListOfValkeyClientInformation(sb.toString()).size())
                .isEqualTo(2);
    }
    ...
    void convertsExpirationToSetPXAT() {
        ...
        assertThatCommandArgument(
                        LettuceConverters.toSetArgs(Expiration.unixTimestamp(10, TimeUnit.MILLISECONDS), null))
    ...
    void convertsExpirationToSetEXAT() {
        ...
        assertThatCommandArgument(
                        LettuceConverters.toSetArgs(Expiration.unixTimestamp(1, TimeUnit.MINUTES), null))
    ...
    void toLimit() {
        ...
        Limit limit =
                LettuceConverters.toLimit(
                        io.valkey.springframework.data.valkey.connection.Limit.unlimited());
        assertThat(limit.isLimited()).isFalse();
        assertThat(limit.getCount()).isEqualTo(-1L);

        limit =
                LettuceConverters.toLimit(
                        io.valkey.springframework.data.valkey.connection.Limit.limit().count(-1));
        assertThat(limit.isLimited()).isTrue();
        assertThat(limit.getCount()).isEqualTo(-1L);

        limit =
                LettuceConverters.toLimit(
                        io.valkey.springframework.data.valkey.connection.Limit.limit().count(5));
        assertThat(limit.isLimited()).isTrue();
    ...
    void convertsExpirationToGetExEX() {
        ...
        assertThatCommandArgument(LettuceConverters.toGetExArgs(Expiration.seconds(10)))
                .isEqualTo(new GetExArgs().ex(10));
    }
    ...
    void convertsExpirationToGetExEXAT() {
        ...
        assertThatCommandArgument(
                        LettuceConverters.toGetExArgs(Expiration.unixTimestamp(10, TimeUnit.SECONDS)))
    ...
    void convertsExpirationWithTimeUnitToGetExEXAT() {
        ...
        assertThatCommandArgument(
                        LettuceConverters.toGetExArgs(Expiration.unixTimestamp(1, TimeUnit.MINUTES)))
    ...
    void convertsExpirationToGetExPXAT() {
        ...
        assertThatCommandArgument(
                        LettuceConverters.toGetExArgs(Expiration.unixTimestamp(10, TimeUnit.MILLISECONDS)))
