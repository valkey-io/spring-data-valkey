...
public class DefaultListOperationsIntegrationIntegrationTests<K, V> {
    ...
    public DefaultListOperationsIntegrationIntegrationTests(
    ...
    void rightPushAllShouldThrowExceptionWhenCollectionContainsNullValue() {
        assertThatIllegalArgumentException()
                .isThrownBy(
                        () ->
                                listOps.rightPushAll(
                                        keyFactory.instance(), Arrays.asList(valueFactory.instance(), null)));
    }
    ...
    void move() {
        ...
        assertThat(
                        listOps.move(
                                ListOperations.MoveFrom.fromHead(source), ListOperations.MoveTo.toTail(target)))
                .isEqualTo(v1);
        assertThat(
                        listOps.move(
                                ListOperations.MoveFrom.fromTail(source), ListOperations.MoveTo.toHead(target)))
                .isEqualTo(v4);
