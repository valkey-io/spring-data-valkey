...
public class ValkeyPropertiesIntegrationTests extends ValkeyMapIntegrationTests {
     ...
     * @param template
     */
    public ValkeyPropertiesIntegrationTests(
    ...
    ValkeyMap<Object, Object> createMap() {
        ...
        props =
                new ValkeyProperties(
                        defaults, valkeyName, new StringValkeyTemplate(template.getConnectionFactory()));
        return props;
    }
    ...
    void testPropertiesLoad() throws Exception {
        InputStream stream =
                getClass()
                        .getResourceAsStream(
                                "/io/valkey/springframework/data/valkey/support/collections/props.properties");
    ...
    public static Collection<Object[]> testParams() {
        ...
        Jackson2JsonValkeySerializer<String> jackson2JsonStringSerializer =
                new Jackson2JsonValkeySerializer<>(String.class);
        ...
        ValkeyTemplate<String, String> genericTemplateLtc =
                new StringValkeyTemplate(lettuceConnFactory);
        ...
        ValkeyTemplate<String, String> genericTemplateVkg =
                new StringValkeyTemplate(valkeyGlideConnFactory);
