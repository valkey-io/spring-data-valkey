...
public class ValkeyCollectionFactoryBeanTests {
    ...
    void testIncompatibleCollections() {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(() -> createCollection("key", CollectionType.LIST))
                .withMessageContaining(
                        "Cannot create collection type 'LIST' for a key containing 'STRING'");

        template.delete("key");
        template.opsForList().leftPush("key", "value");
        assertThatIllegalArgumentException()
                .isThrownBy(() -> createCollection("key", CollectionType.SET))
