...
public class DefaultValueOperationsIntegrationTests<K, V> {
    ...
    public DefaultValueOperationsIntegrationTests(
    ...
    void testMultiSetIfAbsent() {
        ...
        assertThat(valueOps.multiGet(keysAndValues.keySet()))
                .containsExactlyElementsOf(keysAndValues.values());
    }
    ...
    void testSetWithExpiration() {
        ...
        assertThat(expire)
                ...
                .isGreaterThan(TimeUnit.MILLISECONDS.toMillis(1));
    }
    ...
    void testAppend() {
        ...
        assertThat(valueOps.append(key, "aaa"))
                .isEqualTo(Integer.valueOf(((String) value).length() + 3));
