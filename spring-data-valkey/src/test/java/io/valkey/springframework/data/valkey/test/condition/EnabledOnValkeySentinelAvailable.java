...
/**
 * {@code @EnabledOnValkeySentinelAvailable} is used to signal that the annotated test class or test
 * method is only <em>enabled</em> if Valkey Sentinel is running.
 *
