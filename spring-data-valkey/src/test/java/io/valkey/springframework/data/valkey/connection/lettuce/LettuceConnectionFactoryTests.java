...
class LettuceConnectionFactoryTests {
    ...
    void testGetNewConnectionOnError() throws Exception {
        ...
        DefaultStringValkeyConnection conn2 =
                new DefaultStringValkeyConnection(factory.getConnection());
    ...
    void testSelectDb() {
        ...
        LettuceConnectionFactory sharingConnectionFactory =
                newConnectionFactory(cf -> cf.setDatabase(1));
        runSelectDbTest(sharingConnectionFactory);

        LettuceConnectionFactory nonSharingConnectionFactory =
    ...
    private void runSelectDbTest(LettuceConnectionFactory factory2) {
        ...
        StringValkeyConnection separateDatabase =
                new DefaultStringValkeyConnection(factory2.getConnection());
    ...
    private static LettuceConnectionFactory newConnectionFactory(
            Consumer<LettuceConnectionFactory> customizer) {
    ...
    void testResetConnection() {
        RedisAsyncCommands<byte[], byte[]> nativeConn =
    ...
    void dbIndexShouldBePropagatedCorrectly() {
        ...
        StringValkeyConnection connectionToDbIndex2 =
                new DefaultStringValkeyConnection(factory.getConnection());
    ...
    void factoryShouldReturnReactiveConnectionWhenCorrectly() {
        ...
        assertThat(
                        factory.getReactiveConnection().execute(BaseRedisReactiveCommands::ping).blockFirst())
                .isEqualTo("PONG");
    }
    ...
    void connectsThroughValkeySocket() {
        ...
        LettuceConnectionFactory factory =
                new LettuceConnectionFactory(SettingsUtils.socketConfiguration(), configuration);
        factory.setShareNativeConnection(false);
        factory.start();
    ...
    void factoryUsesElastiCacheMasterReplicaConnections() {
        ...
        assumeTrue(
                "No replicas connected to %s:%d"
                        .formatted(SettingsUtils.getHost(), SettingsUtils.getPort()),
        ...
        ValkeyStaticMasterReplicaConfiguration elastiCache =
                new ValkeyStaticMasterReplicaConfiguration(SettingsUtils.getHost())
    ...
    void pubSubDoesNotSupportMasterReplicaConnections() {
        ...
        LettuceConnectionFactory factory =
                new LettuceConnectionFactory(
                        elastiCache, LettuceTestClientConfiguration.defaultConfiguration());
        factory.start();

        ValkeyConnection connection = factory.getConnection();

        assertThatThrownBy(() -> connection.pSubscribe((message, pattern) -> {}, "foo".getBytes()))
                .isInstanceOf(ValkeyConnectionFailureException.class)
    ...
    void factoryUsesElastiCacheMasterWithoutMaster() {
        ...
        ValkeyStaticMasterReplicaConfiguration elastiCache =
                new ValkeyStaticMasterReplicaConfiguration(
    ...
    void factoryUsesMasterReplicaConnections() {
        ...
        LettuceConnectionFactory factory =
                new LettuceConnectionFactory(SettingsUtils.standaloneConfiguration(), configuration);
    ...
    void getClientNameShouldEqualWithFactorySetting() {
        ...
        LettuceConnectionFactory factory =
                new LettuceConnectionFactory(new ValkeyStandaloneConfiguration());
        factory.setClientResources(LettuceTestClientResources.getSharedClientResources());
    ...
    void shouldInitializeClusterConnectionsEagerly() {
        ...
        LettuceConnectionFactory factory =
                new LettuceConnectionFactory(SettingsUtils.clusterConfiguration(), configuration);
        factory.setEagerInitialization(true);
        factory.start();
