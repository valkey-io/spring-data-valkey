...
class DefaultValkeyTypeMapperUnitTests {
    ...
    void setUp() {
        ...
        configurableTypeInformationMapper =
                new ConfigurableTypeInformationMapper(singletonMap(String.class, "1"));
    ...
    void defaultInstanceReadsClasses() {
        ...
        Bucket bucket =
                Bucket.newBucketFromStringMap(
                        singletonMap(DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY, String.class.getName()));
    ...
    void writesMapKeyForType() {
        ...
        typeMapper =
                new DefaultValkeyTypeMapper(
                        DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY,
    ...
    void readsTypeForMapKey() {
        ...
        readsTypeFromField(
                Bucket.newBucketFromStringMap(singletonMap(DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY, "1")),
                String.class);
        readsTypeFromField(
                Bucket.newBucketFromStringMap(
                        singletonMap(DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY, "unmapped")),
                null);
    }
    ...
    void readsTypeLoadingClassesForUnmappedTypesIfConfigured() {
        ...
        readsTypeFromField(
                new Bucket(singletonMap(DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY, "1".getBytes())),
                String.class);
        readsTypeFromField(
                new Bucket(
                        singletonMap(
                                DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY, Object.class.getName().getBytes())),
                Object.class);
    }
    ...
    void readsTypeFromCustomFieldConfigured() {
        ...
        typeMapper = new DefaultValkeyTypeMapper("_custom");
        readsTypeFromField(
                Bucket.newBucketFromStringMap(singletonMap("_custom", String.class.getName())),
                String.class);
    }
    ...
    void returnsNullIfNoTypeInfoInBucket() {
        ...
        readsTypeFromField(new Bucket(), null);
        readsTypeFromField(
                Bucket.newBucketFromStringMap(singletonMap(DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY, "")),
                null);
    }
    ...
    void returnsNullIfClassCannotBeLoaded() {
        ...
        readsTypeFromField(
                Bucket.newBucketFromStringMap(
                        singletonMap(DefaultValkeyTypeMapper.DEFAULT_TYPE_KEY, "fooBar")),
                null);
    }
    ...
    private void writesTypeToField(Bucket bucket, Class<?> type, @Nullable Object value) {
        ...
        if (value == null) {
            ...
            byte[] expected =
                    value instanceof Class javaClass
                            ? javaClass.getName().getBytes()
