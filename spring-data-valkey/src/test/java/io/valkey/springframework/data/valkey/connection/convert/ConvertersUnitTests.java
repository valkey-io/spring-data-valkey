...
class ConvertersUnitTests {
    ...
    private static final String VALKEY_3_0_CLUSTER_NODES_RESPONSE =
            "" //
                    + "ef570f86c7b1a953846668debc177a3a16733420 127.0.0.1:6379@16379 myself,master - 0 0 1"
                    + " connected 0-5460 5602\n"
                    + "0f2ee5df45d18c50aca07228cc18b1da96fd5e84 127.0.0.1:6380@16380 master - 0 1427718161587"
                    + " 2 connected 5461 5603-10922\n"
                    + "3b9b8192a874fa8f1f09dbc0ee20afab5738eee7 127.0.0.1:6381@6381 master - 0 1427718161587"
                    + " 3 connected 10923-16383\n"
                    + "8cad73f63eb996fedba89f041636f17d88cda075 127.0.0.1:7369@7369 slave"
                    + " ef570f86c7b1a953846668debc177a3a16733420 0 1427718161587 1 connected";
    ...
    private static final String CLUSTER_NODE_WITH_SINGLE_SLOT_RESPONSE =
            "ef570f86c7b1a953846668debc177a3a16733420 127.0.0.1:6379 myself,master - 0 0 1 connected"
                    + " 3456";

    private static final String CLUSTER_NODE_WITH_FAIL_FLAG_AND_DISCONNECTED_LINK_STATE =
            "b8b5ee73b1d1997abff694b3fe8b2397d2138b6d 127.0.0.1:7382 master,fail - 1450160048933"
                    + " 1450160048832 38 disconnected";

    private static final String CLUSTER_NODE_IMPORTING_SLOT =
            "ef570f86c7b1a953846668debc177a3a16733420 127.0.0.1:6379 myself,master - 0 0 1 connected"
                    + " [5461-<-0f2ee5df45d18c50aca07228cc18b1da96fd5e84]";

    private static final String CLUSTER_NODE_WITHOUT_HOST =
            "ef570f86c7b1a953846668debc177a3a16733420 :6379 fail,master - 0 0 1 connected";

    private static final String CLUSTER_NODE_WITH_SINGLE_IPV6_HOST =
            "67adfe3df1058896e3cb49d2863e0f70e7e159fa"
                    + " 2a02:6b8:c67:9c:0:6d8b:33da:5a2c:6380@16380,redis-master master,nofailover - 0"
                    + " 1692108412315 1 connected 0-5460";

    private static final String CLUSTER_NODE_WITH_SINGLE_IPV6_HOST_SQUARE_BRACKETS =
            "67adfe3df1058896e3cb49d2863e0f70e7e159fa"
                    + " [2a02:6b8:c67:9c:0:6d8b:33da:5a2c]:6380@16380,redis-master master,nofailover - 0"
                    + " 1692108412315 1 connected 0-5460";

    private static final String CLUSTER_NODE_WITH_SINGLE_INVALID_IPV6_HOST =
            "67adfe3df1058896e3cb49d2863e0f70e7e159fa 2a02:6b8:c67:9c:0:6d8b:33da:5a2c: master,nofailover"
                    + " - 0 1692108412315 1 connected 0-5460";

    private static final String CLUSTER_NODE_WITH_SINGLE_IPV4_EMPTY_HOSTNAME =
            "3765733728631672640db35fd2f04743c03119c6 10.180.0.33:11003@16379, master - 0 1708041426947 2"
                    + " connected 0-5460";

    private static final String CLUSTER_NODE_WITH_SINGLE_IPV4_HOSTNAME =
            "3765733728631672640db35fd2f04743c03119c6 10.180.0.33:11003@16379,hostname1 master - 0"
                    + " 1708041426947 2 connected 0-5460";

    @Test // DATAREDIS-315
    void toSetOfValkey30ClusterNodesShouldConvertSingleStringNodesResponseCorrectly() {

        Iterator<ValkeyClusterNode> nodes =
                Converters.toSetOfValkeyClusterNodes(VALKEY_3_0_CLUSTER_NODES_RESPONSE).iterator();
    ...
    void toSetOfValkey32ClusterNodesShouldConvertSingleStringNodesResponseCorrectly() {
        ...
        Iterator<ValkeyClusterNode> nodes =
                Converters.toSetOfValkeyClusterNodes(VALKEY_3_2_CLUSTER_NODES_RESPONSE).iterator();
    ...
    void toSetOfValkeyClusterNodesShouldConvertNodesWithSingleSlotCorrectly() {
        ...
        Iterator<ValkeyClusterNode> nodes =
                Converters.toSetOfValkeyClusterNodes(CLUSTER_NODE_WITH_SINGLE_SLOT_RESPONSE).iterator();
    ...
    void toSetOfValkeyClusterNodesShouldParseLinkStateAndDisconnectedCorrectly() {
        ...
        Iterator<ValkeyClusterNode> nodes =
                Converters.toSetOfValkeyClusterNodes(
    ...
    void toSetOfValkeyClusterNodesShouldIgnoreImportingSlot() {
        ...
        Iterator<ValkeyClusterNode> nodes =
                Converters.toSetOfValkeyClusterNodes(CLUSTER_NODE_IMPORTING_SLOT).iterator();
    ...
    void toSetOfValkeyClusterNodesShouldAllowEmptyHostname() {
        ...
        Iterator<ValkeyClusterNode> nodes =
                Converters.toSetOfValkeyClusterNodes(CLUSTER_NODE_WITHOUT_HOST).iterator();
    ...
    void toClusterNodeWithIPv6HostnameSquareBrackets() {
        ...
        ValkeyClusterNode node =
                Converters.toClusterNode(CLUSTER_NODE_WITH_SINGLE_IPV6_HOST_SQUARE_BRACKETS);
    ...
    static Stream<Arguments> clusterNodesEndpoints() {
        ...
        Stream<Arguments> regular =
                Stream.of(
                        ...
                        Arguments.of(
                                "127.0.0.1:7382@17382", new AddressPortHostname("127.0.0.1", "7382", null)),
                        ...
                        Arguments.of(
                                "my.host-name.com:7379@17379",
                                new AddressPortHostname("my.host-name.com", "7379", null)),

                        // With hostname, Valkey 7
                        Arguments.of(
                                "1.2.4.4:7379@17379,my.host-name.com",
                                new AddressPortHostname("1.2.4.4", "7379", "my.host-name.com")));

        Stream<Arguments> weird =
                Stream.of(
                        // Port-only
