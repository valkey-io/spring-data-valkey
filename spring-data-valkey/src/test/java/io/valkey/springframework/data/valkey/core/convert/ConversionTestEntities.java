...
public class ConversionTestEntities {
    ...
    public static class RecursiveConstructorPerson {
        ...
        public RecursiveConstructorPerson(
                String id, String firstname, RecursiveConstructorPerson father) {
            this.id = id;
        ...
        public String toString() {
            ...
            return "ConversionTestEntities.RecursiveConstructorPerson(id="
                    + this.getId()
                    + ", firstname="
                    + this.getFirstname()
                    + ", father="
    ...
    public static class PersonWithConstructorAndAddress {
        ...
        @Override
        public String toString() {
            return "ConversionTestEntities.PersonWithConstructorAndAddress(id="
                    + this.getId()
                    + ", address="
                    + this.getAddress()
                    + ")";
    ...
    public static class AccountInfo {
        ...
        @Override
        public String toString() {
            return "ConversionTestEntities.AccountInfo(id="
                    + this.getId()
                    + ", account="
                    + this.getAccount()
                    + ", accountName="
