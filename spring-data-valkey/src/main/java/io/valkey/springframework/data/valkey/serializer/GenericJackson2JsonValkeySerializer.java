...
/**
 * Generic Jackson 2-based {@link ValkeySerializer} that maps {@link Object objects} to and from
 * {@literal JSON} using dynamic typing.
 *
 * <p>{@literal JSON} reading and writing can be customized by configuring a {@link
 * JacksonObjectReader} and {@link JacksonObjectWriter}.
 *
...
public class GenericJackson2JsonValkeySerializer implements ValkeySerializer<Object> {
    ...
    /**
     * Creates {@link GenericJackson2JsonValkeySerializer} initialized with an {@link ObjectMapper}
    ...
    /**
     * Creates {@link GenericJackson2JsonValkeySerializer} initialized with an {@link ObjectMapper}
     * configured for default typing using the given {@link String name}.
     *
     * <p>In case {@link String name} is {@literal empty} or {@literal null}, then {@link
     * JsonTypeInfo.Id#CLASS} will be used.
     *
    ...
    /**
     * Creates {@link GenericJackson2JsonValkeySerializer} initialized with an {@link ObjectMapper}
     * configured for default typing using the given {@link String name} along with the given,
     * required {@link JacksonObjectReader} and {@link JacksonObjectWriter} used to read/write {@link
     * Object Objects} de/serialized as JSON.
     *
     * <p>In case {@link String name} is {@literal empty} or {@literal null}, then {@link
     * JsonTypeInfo.Id#CLASS} will be used.
     *
    ...
    public GenericJackson2JsonValkeySerializer(
        ...
        this.mapper.setDefaultTyping(
                createDefaultTypeResolverBuilder(getObjectMapper(), typeHintPropertyName));
    }
     ...
     *
     * @param mapper must not be {@literal null}.
     * @param reader the {@link JacksonObjectReader} function to read objects using {@link
     *     ObjectMapper}.
     * @param writer the {@link JacksonObjectWriter} function to write objects using {@link
     *     ObjectMapper}.
     * @since 3.0
     */
    public GenericJackson2JsonValkeySerializer(
            ObjectMapper mapper, JacksonObjectReader reader, JacksonObjectWriter writer) {
        this(mapper, reader, writer, null);
    }

    private GenericJackson2JsonValkeySerializer(
            ObjectMapper mapper,
            JacksonObjectReader reader,
            JacksonObjectWriter writer,
            @Nullable String typeHintPropertyName) {
        ...
        this.defaultTypingEnabled =
                Lazy.of(() -> mapper.getSerializationConfig().getDefaultTyper(null) != null);

        this.typeResolver = newTypeResolver(mapper, typeHintPropertyName, this.defaultTypingEnabled);
    }

    private static TypeResolver newTypeResolver(
            ObjectMapper mapper,
            @Nullable String typeHintPropertyName,
        ...
        Lazy<String> lazyTypeHintPropertyName =
    ...
    private static Lazy<String> newLazyTypeHintPropertyName(
            ObjectMapper mapper, Lazy<Boolean> defaultTypingEnabled) {

        Lazy<String> configuredTypeDeserializationPropertyName =
                getConfiguredTypeDeserializationPropertyName(mapper);

        Lazy<String> resolvedLazyTypeHintPropertyName =
                Lazy.of(
                        () ->
                                defaultTypingEnabled.get()
                                        ? null
    ...
    private static StdTypeResolverBuilder createDefaultTypeResolverBuilder(
        ...
        StdTypeResolverBuilder typer =
                TypeResolverBuilder.forEverything(objectMapper)
     ...
     *
     * @return new {@link
     *     GenericJackson2JsonValkeySerializer.GenericJackson2JsonValkeySerializerBuilder}.
     * @since 3.3.1
     */
    ...
    /**
     * Register {@link NullValueSerializer} in the given {@link ObjectMapper} with an optional {@code
     * typeHintPropertyName}. This method should be called by code that customizes {@link
     * GenericJackson2JsonValkeySerializer} by providing an external {@link ObjectMapper}.
     *
     * @param objectMapper the object mapper to customize.
     * @param typeHintPropertyName name of the type property. Defaults to {@code @class} if {@literal
     *     null}/empty.
     * @since 2.2
     */
    public static void registerNullValueSerializer(
            ObjectMapper objectMapper, @Nullable String typeHintPropertyName) {
        ...
        objectMapper.registerModule(
                new SimpleModule().addSerializer(new NullValueSerializer(typeHintPropertyName)));
    }

    /**
     * Gets the configured {@link ObjectMapper} used internally by this {@link
     * GenericJackson2JsonValkeySerializer} to de/serialize {@link Object objects} as {@literal JSON}.
     *
     ...
     *
     * @param source array of bytes containing the {@literal JSON} to deserialize; can be {@literal
     *     null}.
     * @param type {@link Class type} of {@link Object} from which the {@literal JSON} will be
     *     deserialized; must not be {@literal null}.
     * @return {@literal null} for an empty source, or an {@link Object} of the given {@link Class
     *     type} deserialized from the array of bytes containing {@literal JSON}.
    ...
    /**
     * Builder method used to configure and customize the internal Jackson {@link ObjectMapper}
     * created by this {@link GenericJackson2JsonValkeySerializer} and used to de/serialize {@link
     * Object objects} as {@literal JSON}.
     *
     * @param objectMapperConfigurer {@link Consumer} used to configure and customize the internal
     *     {@link ObjectMapper}; must not be {@literal null}.
     * @return this {@link GenericJackson2JsonValkeySerializer}.
     * @throws IllegalArgumentException if the {@link Consumer} used to configure and customize the
     *     internal {@link ObjectMapper} is {@literal null}.
     * @since 3.1.5
     */
    public GenericJackson2JsonValkeySerializer configure(
            Consumer<ObjectMapper> objectMapperConfigurer) {
    ...
    static class TypeResolver {
        ...
        TypeResolver(
                ObjectMapper mapper, Supplier<TypeFactory> typeFactory, Supplier<String> hintName) {
        ...
        /**
         * Lenient variant of ObjectMapper._readTreeAndClose using a strict {@link
    ...
    public static class GenericJackson2JsonValkeySerializerBuilder {
        ...
        /**
         * Enable or disable default typing. Enabling default typing will override {@link
         * ObjectMapper#setDefaultTyping(com.fasterxml.jackson.databind.jsontype.TypeResolverBuilder)}
         * for a given {@link ObjectMapper}. Default typing is enabled by default if no {@link
         * ObjectMapper} is provided.
         *
         * @param defaultTyping whether to enable/disable default typing. Enabled by default if the
         *     {@link ObjectMapper} is not provided.
         * @return this {@link
         *     GenericJackson2JsonValkeySerializer.GenericJackson2JsonValkeySerializerBuilder}.
         */
         ...
         *
         * @param typeHintPropertyName {@link String name} of the JSON property holding type
         *     information.
         * @return this {@link
         *     GenericJackson2JsonValkeySerializer.GenericJackson2JsonValkeySerializerBuilder}.
         */
        public GenericJackson2JsonValkeySerializerBuilder typeHintPropertyName(
        ...
        /**
         * Configure a provided {@link ObjectMapper}. Note that the provided {@link ObjectMapper} can be
         * reconfigured with a {@link #nullValueSerializer} or default typing depending on the builder
         * configuration.
         *
         ...
         *
         * @param nullValueSerializer the {@link StdSerializer} to use for {@link NullValue}
         *     serialization, must not be {@literal null}.
         * @return this {@link
         *     GenericJackson2JsonValkeySerializer.GenericJackson2JsonValkeySerializerBuilder}.
         */
        public GenericJackson2JsonValkeySerializerBuilder nullValueSerializer(
                StdSerializer<NullValue> nullValueSerializer) {
        ...
        /**
         * Configure whether to register a {@link StdSerializer serializer} for {@link NullValue}
         * serialization. The default serializer considers {@link #typeHintPropertyName(String)}.
         *
         * @param registerNullValueSerializer {@code true} to register the default serializer; {@code
         *     false} otherwise.
         * @return this {@link
         *     GenericJackson2JsonValkeySerializer.GenericJackson2JsonValkeySerializerBuilder}.
         */
        public GenericJackson2JsonValkeySerializerBuilder registerNullValueSerializer(
                boolean registerNullValueSerializer) {
            this.registerNullValueSerializer = registerNullValueSerializer;
            return this;
        }

        /**
         * Creates a new instance of {@link GenericJackson2JsonValkeySerializer} with configuration
         * options applied. Creates also a new {@link ObjectMapper} if none was provided.
         *
        ...
        public GenericJackson2JsonValkeySerializer build() {
            ...
            if (registerNullValueSerializer) {
                objectMapper.registerModule(
                        new SimpleModule("GenericJackson2JsonValkeySerializerBuilder")
                                .addSerializer(
            ...
            if ((!providedObjectMapper && (defaultTyping == null || defaultTyping))
                ...
                objectMapper.setDefaultTyping(
                        createDefaultTypeResolverBuilder(objectMapper, typeHintPropertyName));
            }

            return new GenericJackson2JsonValkeySerializer(
                    objectMapper, this.reader, this.writer, this.typeHintPropertyName);
        }
    }

    /**
     * Custom {@link StdTypeResolverBuilder} that considers typing for non-primitive types.
     * Primitives, their wrappers and primitive arrays do not require type hints. The default {@code
     * DefaultTyping#EVERYTHING} typing does not satisfy those requirements.
     *
     * @author Mark Paluch
     * @since 2.7.2
     */
    private static class TypeResolverBuilder extends ObjectMapper.DefaultTypeResolverBuilder {
        ...
        public TypeResolverBuilder(
                DefaultTyping typing, PolymorphicTypeValidator polymorphicTypeValidator) {
