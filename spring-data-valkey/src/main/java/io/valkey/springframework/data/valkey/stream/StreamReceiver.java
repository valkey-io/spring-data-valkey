 ...
 * {@link io.valkey.springframework.data.valkey.core.ReactiveStreamOperations#acknowledge(Object, String, String...)
 * acknowledge}</li>
...
public interface StreamReceiver<K, V extends Record<K, ?>> {
	 ...
	 * {@link io.valkey.springframework.data.valkey.connection.ReactiveStreamCommands#xAck(ByteBuffer, String, String...)}
	 *
	 ...
	 * <p>
	 * Every record must be acknowledged using
	 * {@link io.valkey.springframework.data.valkey.core.ReactiveStreamOperations#acknowledge(Object, String, String...)} after
	 * processing.
	 *
	 * @param consumer consumer group, must not be {@literal null}.
	 * @param streamOffset the stream along its offset.
