...
/**
 * Default implementation for {@link ValkeyZSet}. Note that the collection support works only with
 * normal, non-pipeline/multi-exec connections as it requires a reply to be sent right away.
 *
 * @author Costin Leau
...
public class DefaultValkeyZSet<E> extends AbstractValkeyCollection<E> implements ValkeyZSet<E> {
    ...
    @Override
    public ValkeyZSet<E> rangeAndStoreByScore(
    ...
    @Override
    public ValkeyZSet<E> reverseRangeAndStoreByScore(
            String dstKey, Range<? extends Number> range, Limit limit) {
