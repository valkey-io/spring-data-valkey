...
/**
 * Base implementation for {@link ValkeyCollection}. Provides a skeletal implementation. Note that
 * the collection support works only with normal, non-pipeline/multi-exec connections as it requires
 ...
 * @author Mark Paluch
 */
public abstract class AbstractValkeyCollection<E> extends AbstractCollection<E>
        implements ValkeyCollection<E> {
    ...
    protected void checkResult(@Nullable Object obj) {
        ...
        if (obj == null) {
            throw new IllegalStateException(
                    "Cannot read collection with Valkey connection in pipeline/multi-exec mode");
        }
    }
}
