...
/**
 * Implementation of {@link ValkeyKeyCommands} for Valkey-Glide in cluster mode. This implementation
 * handles cross-slot operations by executing commands separately and aggregating results when keys
 * map to different cluster slots.
 *
