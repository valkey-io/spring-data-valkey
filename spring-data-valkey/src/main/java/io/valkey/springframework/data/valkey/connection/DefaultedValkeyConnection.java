...
/**
 * {@link DefaultedValkeyConnection} provides method delegates to {@code Valkey*Command} interfaces
 * accessible via {@link ValkeyConnection}. This allows us to maintain backwards compatibility while
 * moving the actual implementation and stay in sync with {@link ReactiveValkeyConnection}. Going
 * forward the {@link ValkeyCommands} extension is likely to be removed from {@link
 * ValkeyConnection}.
 *
...
public interface DefaultedValkeyConnection extends ValkeyCommands, ValkeyCommandsProvider {
    ...
    @Override
    @Deprecated
    default List<RecordId> xClaimJustId(
    ...
    @Override
    @Deprecated
    default List<ByteRecord> xRange(
            byte[] key,
    ...
    @Override
    @Deprecated
    default List<ByteRecord> xReadGroup(
    ...
    @Override
    @Deprecated
    default List<ByteRecord> xRevRange(
            byte[] key, org.springframework.data.domain.Range<String> range) {
    ...
    default List<Long> hpExpireAt(byte[] key, long unixTimeInMillis, byte[]... fields) {
        return hashCommands()
                .hpExpireAt(key, unixTimeInMillis, ExpirationOptions.Condition.ALWAYS, fields);
    }
    ...
    @Override
    @Deprecated
    default GeoResults<GeoLocation<byte[]>> geoRadius(
    ...
    @Override
    @Deprecated
    default GeoResults<GeoLocation<byte[]>> geoRadiusByMember(
    ...
    @Override
    @Deprecated
    default GeoResults<GeoLocation<byte[]>> geoSearch(
