...
public class Bucket {
    ...
    /**
     * Value object representing a path within a {@link Bucket}. Paths can be either top-level (if the
     * {@code prefix} is {@literal null} or empty) or nested with a given {@code prefix}.
     *
     * @author Mark Paluch
     * @since 2.1
     */
    public static class BucketPropertyPath {
        ...
        /**
         * Creates a {@link BucketPropertyPath} given {@link Bucket} and {@code prefix}. The resulting
         * path is top-level if {@code prefix} is empty or nested, if {@code prefix} is not empty.
         *
         * @param bucket the bucket, must not be {@literal null}.
         * @param prefix the prefix. Property path is top-level if {@code prefix} is {@literal null} or
         *     empty.
