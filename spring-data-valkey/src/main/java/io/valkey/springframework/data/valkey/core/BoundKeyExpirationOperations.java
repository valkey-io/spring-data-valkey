...
public interface BoundKeyExpirationOperations {
     ...
     *     a {@code Date}.
     * @see <a href="https://valkey.io/docs/latest/commands/expireat/">Valkey Documentation:
     *     EXPIRE</a>
     * @since 3.5
     */
    @Nullable
     ...
     *
     * @return changes to the key. {@literal null} when used in pipeline / transaction.
     * @see <a href="https://valkey.io/docs/latest/commands/persist/">Valkey Documentation:
     *     PERSIST</a>
     * @since 3.5
     */
    @Nullable
     ...
     *
     * @return the actual expirations in seconds for the key. {@literal null} when used in pipeline /
     *     transaction.
     ...
     * @return the actual expirations for the key in the given time unit. {@literal null} when used in
