...
public final class ReadOffset {
    ...
    /**
     * Read all new arriving elements with ids greater than the last one consumed by the consumer
     * group.
     *
    ...
    /**
     * Read all arriving elements from the stream starting at {@link RecordId}. Using a {@link
     * RecordId#shouldBeAutoGenerated() auto-generated} {@link RecordId} returns the {@link #latest()}
     * read offset.
     *
     * @param offset the stream offset.
