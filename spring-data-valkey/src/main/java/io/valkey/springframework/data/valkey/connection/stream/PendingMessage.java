...
/**
 * Value object representing a single pending message containing its {@literal ID}, the {@literal
 * consumer} that fetched the message and has still to acknowledge it, the time elapsed since the
 * messages last delivery and the the total number of times delivered.
 *
...
public class PendingMessage {
    ...
    /**
     * Get the total number of times the messages has been delivered to the {@link #getConsumer()
     * consumer}.
     *
     * @return never {@literal null}.
     */
    ...
    public String toString() {
        return "PendingMessage{"
                ...
                + ", consumer="
                + consumer
                + ", elapsedTimeSinceLastDeliveryMS="
                + elapsedTimeSinceLastDelivery.toMillis()
                + ", totalDeliveryCount="
                + totalDeliveryCount
                + '}';
    }
