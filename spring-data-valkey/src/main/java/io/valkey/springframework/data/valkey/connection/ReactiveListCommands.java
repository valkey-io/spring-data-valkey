...
public interface ReactiveListCommands {
    ...
    class PushCommand extends KeyCommand {
        ...
        private PushCommand(
                @Nullable ByteBuffer key, List<ByteBuffer> values, Direction direction, boolean upsert) {
    ...
    default Mono<Long> rPush(ByteBuffer key, List<ByteBuffer> values) {
        ...
        return push(Mono.just(PushCommand.right().values(values).to(key)))
                .next()
    ...
    default Mono<Long> rPushX(ByteBuffer key, ByteBuffer value) {
        ...
        return push(Mono.just(PushCommand.right().value(value).to(key).ifExists()))
                .next()
                .map(NumericResponse::getOutput);
    }
    ...
    default Mono<Long> lPush(ByteBuffer key, List<ByteBuffer> values) {
        ...
        return push(Mono.just(PushCommand.left().values(values).to(key)))
                .next()
                .map(NumericResponse::getOutput);
    }
    ...
    default Mono<Long> lPushX(ByteBuffer key, ByteBuffer value) {
        ...
        return push(Mono.just(PushCommand.left().value(value).to(key).ifExists()))
                .next()
                .map(NumericResponse::getOutput);
    }
    ...
    default Flux<ByteBuffer> lRange(ByteBuffer key, long start, long end) {
        ...
        return lRange(Mono.just(RangeCommand.key(key).fromIndex(start).toIndex(end)))
    ...
    class LPosCommand extends KeyCommand {
        ...
        /**
         * Applies the {@literal count} parameter specifying the number of matches to return. Constructs
         * a new command instance with all previously configured properties.
         *
        ...
        /**
         * Applies the {@literal rank} parameter specifying the "rank" of the first element to return.
    ...
    default Mono<ByteBuffer> lIndex(ByteBuffer key, long index) {
        ...
        return lIndex(Mono.just(LIndexCommand.elementAt(index).from(key)))
                .next()
    ...
    class LInsertCommand extends KeyCommand {
        ...
        private LInsertCommand(
                @Nullable ByteBuffer key,
                @Nullable Position position,
                @Nullable ByteBuffer pivot,
                ByteBuffer value) {
        ...
        /**
         * Applies the before {@literal pivot}. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * Applies the after {@literal pivot}. Constructs a new command instance with all previously
         * configured properties.
         *
         * @param pivot must not be {@literal null}.
         * @return a new {@link LInsertCommand} with {@literal pivot} applied.
    ...
    /**
     * Insert {@literal value} {@link Position#BEFORE} or {@link Position#AFTER} existing {@literal
     * pivot} for {@literal key}.
     *
     * @param key must not be {@literal null}.
     ...
     * @see <a href="https://valkey.io/commands/linsert">Valkey Documentation: LINSERT</a>
     */
    default Mono<Long> lInsert(
            ByteBuffer key, Position position, ByteBuffer pivot, ByteBuffer value) {
    ...
    /**
     * Insert {@link LInsertCommand#getValue()} {@link Position#BEFORE} or {@link Position#AFTER}
     * existing {@link LInsertCommand#getPivot()} for {@link LInsertCommand#getKey()}
     *
     * @param commands must not be {@literal null}.
     * @return
     * @see <a href="https://valkey.io/commands/linsert">Valkey Documentation: LINSERT</a>
    ...
    class LMoveCommand extends KeyCommand {
        ...
        public LMoveCommand(
                @Nullable ByteBuffer sourceKey,
                @Nullable ByteBuffer destinationKey,
        ...
        /**
         * Applies the {@link ByteBuffer destinationKey}. Constructs a new command instance with all
        ...
        /**
         * Applies the {@link Duration timeout}. Constructs a new command instance with all previously
         * configured properties.
         *
     ...
     * @see <a href="https://valkey.io/commands/lmove">Valkey Documentation: LMOVE</a>
     */
    default Mono<ByteBuffer> lMove(
            ByteBuffer sourceKey, ByteBuffer destinationKey, Direction from, Direction to) {
        ...
        return lMove(Mono.just(LMoveCommand.from(sourceKey, from).to(destinationKey, to)))
     ...
     * @see <a href="https://valkey.io/commands/blmove">Valkey Documentation: BLMOVE</a>
     */
    default Mono<ByteBuffer> bLMove(
            ByteBuffer sourceKey,
        ...
        return bLMove(
                        Mono.just(BLMoveCommand.from(sourceKey, from).to(destinationKey, to).timeout(timeout)))
                .map(CommandResponse::getOutput)
                .next();
    }
     ...
     * destinationKey}.
     *
     * <p><b>Blocks connection</b> until element available or {@code timeout} reached.
     *
     * @param commands must not be {@literal null}.
     * @return
     * @since 2.6
    ...
    default Mono<Boolean> lSet(ByteBuffer key, long index, ByteBuffer value) {
        ...
        return lSet(Mono.just(LSetCommand.elementAt(index).to(value).forKey(key)))
                .next()
                .map(BooleanResponse::getOutput);
    }
    ...
    default Mono<Long> lRem(ByteBuffer key, ByteBuffer value) {
        ...
        return lRem(Mono.just(LRemCommand.all().occurrencesOf(value).from(key)))
                .next()
                .map(NumericResponse::getOutput);
    }

    /**
     * Removes the first {@literal count} occurrences of {@literal value} from the list stored at
     * {@literal key}.
     *
     * @param key must not be {@literal null}.
    ...
    default Mono<Long> lRem(ByteBuffer key, Long count, ByteBuffer value) {
        ...
        return lRem(Mono.just(LRemCommand.first(count).occurrencesOf(value).from(key)))
                .next()
                .map(NumericResponse::getOutput);
    }

    /**
     * Removes the {@link LRemCommand#getCount()} occurrences of {@link LRemCommand#getValue()} from
     * the list stored at {@link LRemCommand#getKey()}.
     *
     * @param commands must not be {@literal null}.
     * @return
     * @see <a href="https://valkey.io/commands/lrem">Valkey Documentation: LREM</a>
    ...
    default Flux<ByteBuffer> lPop(ByteBuffer key, long count) {
        ...
        return popList(Mono.just(PopCommand.left().from(key).count(count)))
                .flatMap(CommandResponse::getOutput);
    }
    ...
    default Flux<ByteBuffer> rPop(ByteBuffer key, long count) {
        ...
        return popList(Mono.just(PopCommand.right().from(key).count(count)))
                .flatMap(CommandResponse::getOutput);
    }
    ...
    default Mono<PopResult> blPop(List<ByteBuffer> keys, Duration timeout) {
        ...
        return bPop(Mono.just(BPopCommand.left().from(keys).blockingFor(timeout)))
                .next()
                .map(PopResponse::getOutput);
    }
    ...
    default Mono<PopResult> brPop(List<ByteBuffer> keys, Duration timeout) {
        ...
        return bPop(Mono.just(BPopCommand.right().from(keys).blockingFor(timeout)))
                .next()
                .map(PopResponse::getOutput);
    }
    ...
    /**
     * Remove the last element from list at {@literal source}, append it to {@literal destination} and
     * return its value.
     *
    ...
    /**
     * Remove the last element from list at {@link RPopLPushCommand#getKey()}, append it to {@link
     * RPopLPushCommand#getDestination()} and return its value.
     *
     * @param commands must not be {@literal null}.
     * @return
     * @see <a href="https://valkey.io/commands/rpoplpush">Valkey Documentation: RPOPLPUSH</a>
    ...
    /**
     * Remove the last element from list at {@literal source}, append it to {@literal destination} and
     * return its value. <b>Blocks connection</b> until element available or {@literal timeout}
     * reached. <br>
     *
     * @param source must not be {@literal null}.
     * @param destination must not be {@literal null}.
    ...
    default Mono<ByteBuffer> bRPopLPush(ByteBuffer source, ByteBuffer destination, Duration timeout) {
        ...
        return bRPopLPush(
                        Mono.just(BRPopLPushCommand.from(source).to(destination).blockingFor(timeout)))
                .next()
                .map(ByteBufferResponse::getOutput);
    }

    /**
     * Remove the last element from list at {@link BRPopLPushCommand#getKey()}, append it to {@link
     * BRPopLPushCommand#getDestination()} and return its value. <br>
     * <b>Blocks connection</b> until element available or {@link BRPopLPushCommand#getTimeout()}
     * reached.
     *
     * @param commands must not be {@literal null}.
     * @return
