...
import io.valkey.springframework.data.valkey.listener.support.SimpleTopicResolver;
import io.valkey.springframework.data.valkey.listener.support.TopicResolver;
import org.springframework.util.Assert;
import org.springframework.util.StringUtils;

/**
 * Base model for a Valkey listener endpoint.
 *
 ...
 * @since 4.1
 */
public abstract class AbstractValkeyListenerEndpoint implements ValkeyListenerEndpoint, SmartLifecycle {
	...
	private @Nullable ValkeyMessageListenerContainer listenerContainer;
	...
	@Override
	public void register(ValkeyMessageListenerContainer listenerContainer) {
