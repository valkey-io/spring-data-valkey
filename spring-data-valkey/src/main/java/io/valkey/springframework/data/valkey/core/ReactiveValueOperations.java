...
public interface ReactiveValueOperations<K, V> {
     ...
     * stored at key, or empty if key did not exist. An error is returned and SET aborted if the value
    ...
    /**
     * Increment the string representing a floating point number stored at {@code key} by {@code
     * delta}.
     *
     * @param key must not be {@literal null}.
     * @param delta
