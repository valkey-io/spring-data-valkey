...
public class ValkeyRuntimeHints implements RuntimeHintsRegistrar {
    ...
    public void registerHints(RuntimeHints hints, @Nullable ClassLoader classLoader) {
        ...
        hints
                ...
                .registerTypes(
                        Arrays.asList(
                                TypeReference.of(ValkeyConnection.class),
                                TypeReference.of(StringValkeyConnection.class),
                                TypeReference.of(DefaultedValkeyConnection.class),
                                TypeReference.of(DefaultedValkeyClusterConnection.class),
                                TypeReference.of(ValkeyKeyCommands.class),
                                TypeReference.of(ValkeyStringCommands.class),
                                TypeReference.of(ValkeyListCommands.class),
                                TypeReference.of(ValkeySetCommands.class),
                                TypeReference.of(ValkeyZSetCommands.class),
                                TypeReference.of(ValkeyHashCommands.class),
                                TypeReference.of(ValkeyTxCommands.class),
                                TypeReference.of(ValkeyPubSubCommands.class),
                                TypeReference.of(ValkeyConnectionCommands.class),
                                TypeReference.of(ValkeyServerCommands.class),
                                TypeReference.of(ValkeyStreamCommands.class),
                                TypeReference.of(ValkeyScriptingCommands.class),
                                TypeReference.of(ValkeyGeoCommands.class),
                                TypeReference.of(ValkeyHyperLogLogCommands.class),
                                TypeReference.of(ValkeyClusterCommands.class),
                                TypeReference.of(ReactiveValkeyConnection.class),
                                TypeReference.of(ReactiveKeyCommands.class),
                                TypeReference.of(ReactiveStringCommands.class),
                                TypeReference.of(ReactiveListCommands.class),
                                TypeReference.of(ReactiveSetCommands.class),
                                TypeReference.of(ReactiveZSetCommands.class),
                                TypeReference.of(ReactiveHashCommands.class),
                                TypeReference.of(ReactivePubSubCommands.class),
                                TypeReference.of(ReactiveServerCommands.class),
                                TypeReference.of(ReactiveStreamCommands.class),
                                TypeReference.of(ReactiveScriptingCommands.class),
                                TypeReference.of(ReactiveGeoCommands.class),
                                TypeReference.of(ReactiveHyperLogLogCommands.class),
                                TypeReference.of(ReactiveClusterKeyCommands.class),
                                TypeReference.of(ReactiveClusterStringCommands.class),
                                TypeReference.of(ReactiveClusterListCommands.class),
                                TypeReference.of(ReactiveClusterSetCommands.class),
                                TypeReference.of(ReactiveClusterZSetCommands.class),
                                TypeReference.of(ReactiveClusterHashCommands.class),
                                ...
                                TypeReference.of(ReactiveClusterHyperLogLogCommands.class),
                                TypeReference.of(ReactiveValkeyOperations.class),
                                TypeReference.of(ReactiveValkeyConnectionFactory.class),
                                TypeReference.of(ReactiveValkeyTemplate.class),
                                TypeReference.of(ValkeyOperations.class),
                                TypeReference.of(ValkeyTemplate.class),
                                TypeReference.of(StringValkeyTemplate.class),
                                TypeReference.of(KeyspaceConfiguration.class),
                                TypeReference.of(MappingConfiguration.class),
                                TypeReference.of(MappingValkeyConverter.class),
                                TypeReference.of(ValkeyConverter.class),
                                TypeReference.of(ValkeyCustomConversions.class),
                                TypeReference.of(ReferenceResolver.class),
                                TypeReference.of(ReferenceResolverImpl.class),
                                TypeReference.of(IndexConfiguration.class),
                                TypeReference.of(ConfigurableIndexDefinitionProvider.class),
                                TypeReference.of(ValkeyMappingContext.class),
                                TypeReference.of(ValkeyRepositoryFactoryBean.class),
                                TypeReference.of(ValkeyQueryCreator.class),
                                TypeReference.of(ValkeyPartTreeQuery.class),
                                TypeReference.of(MessageListener.class),
                                TypeReference.of(ValkeyMessageListenerContainer.class),
                                TypeReference.of(
                                        "io.valkey.springframework.data.valkey.core.BoundOperationsProxyFactory$DefaultBoundKeyOperations"),
                                TypeReference.of("io.valkey.springframework.data.valkey.core.DefaultGeoOperations"),
                                TypeReference.of(
                                        "io.valkey.springframework.data.valkey.core.DefaultHashOperations"),
                                TypeReference.of("io.valkey.springframework.data.valkey.core.DefaultKeyOperations"),
                                TypeReference.of(
                                        "io.valkey.springframework.data.valkey.core.DefaultListOperations"),
                                TypeReference.of("io.valkey.springframework.data.valkey.core.DefaultSetOperations"),
                                TypeReference.of(
                                        "io.valkey.springframework.data.valkey.core.DefaultStreamOperations"),
                                TypeReference.of(
                                        "io.valkey.springframework.data.valkey.core.DefaultValueOperations"),
                                TypeReference.of(
                                        "io.valkey.springframework.data.valkey.core.DefaultZSetOperations"),
                                TypeReference.of(ValkeyKeyValueAdapter.class),
                                TypeReference.of(ValkeyKeyValueTemplate.class),

                                // Key-Value
                                TypeReference.of(KeySpace.class),
                                TypeReference.of(AbstractKeyValueAdapter.class),
                                TypeReference.of(KeyValueAdapter.class),
                                TypeReference.of(KeyValueOperations.class),
                                TypeReference.of(KeyValueTemplate.class),
                                TypeReference.of(KeyValueMappingContext.class),
                                TypeReference.of(KeyValueRepository.class),
                                TypeReference.of(KeyValueRepositoryFactoryBean.class),
                                TypeReference.of(QueryCreatorType.class),
    ...
    static void boundOperationsProxy(
            TypeReference typeReference, ClassLoader classLoader, RuntimeHints hints) {

        String boundTargetClass =
                typeReference.getPackageName() + "." + typeReference.getSimpleName().replace("Bound", "");
        if (ClassUtils.isPresent(boundTargetClass, classLoader)) {
            hints
                    .reflection()
                    .registerType(
                            TypeReference.of(boundTargetClass),
                            hint ->
                                    hint.withMembers(
                                            MemberCategory.INVOKE_DECLARED_METHODS,
                                            MemberCategory.INVOKE_PUBLIC_METHODS));
    ...
    static void registerValkeyConnectionProxy(TypeReference typeReference, RuntimeHints hints) {
        ...
        hints
                .proxies()
                .registerJdkProxy(
                        TypeReference.of(ValkeyConnectionProxy.class), //
                        typeReference, //
                        TypeReference.of("org.springframework.aop.SpringProxy"), //
                        TypeReference.of("org.springframework.aop.framework.Advised"), //
                        TypeReference.of("org.springframework.core.DecoratingProxy"));
