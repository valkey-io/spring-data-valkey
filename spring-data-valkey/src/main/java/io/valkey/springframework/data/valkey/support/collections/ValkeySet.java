...
/**
 * Valkey extension for the {@link Set} contract. Supports {@link Set} specific operations backed by
 * Valkey operations.
 *
...
public interface ValkeySet<E> extends ValkeyCollection<E>, Set<E> {
    ...
    /**
     * Create a new {@link ValkeySet} by diffing this sorted set and {@link ValkeySet} and store
    ...
    /**
     * Create a new {@link ValkeySet} by diffing this sorted set and the collection {@link ValkeySet}
    ...
    /**
     * Create a new {@link ValkeySet} by intersecting this sorted set and {@link ValkeySet} and store
     * result in destination {@code destKey}.
     *
     * @param set must not be {@literal null}.
     * @param destKey must not be {@literal null}.
    ...
    /**
     * Create a new {@link ValkeySet} by intersecting this sorted set and the collection {@link
     * ValkeySet} and store result in destination {@code destKey}.
     *
     * @param sets must not be {@literal null}.
     * @param destKey must not be {@literal null}.
     * @return a new {@link ValkeySet} pointing at {@code destKey}.
    ...
    /**
     * Create a new {@link ValkeySet} by union this sorted set and {@link ValkeySet} and store result
    ...
    /**
     * Create a new {@link ValkeySet} by union this sorted set and the collection {@link ValkeySet}
     * and store result in destination {@code destKey}.
     *
     * @param sets must not be {@literal null}.
     * @param destKey must not be {@literal null}.
