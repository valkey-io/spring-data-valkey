 ...
 * @since 4.0
 */
public class JacksonJsonValkeySerializer<T> implements ValkeySerializer<T> {
	...
	/**
	 * Creates a new {@link JacksonJsonValkeySerializer} for the given target {@link Class}.
	 *
	 * @param type must not be {@literal null}.
	 */
	public JacksonJsonValkeySerializer(Class<T> type) {
		this(JsonMapper.shared(), type);
	}

	/**
	 * Creates a new {@link JacksonJsonValkeySerializer} for the given target {@link JavaType}.
	 *
	 * @param javaType must not be {@literal null}.
	 */
	public JacksonJsonValkeySerializer(JavaType javaType) {
	 ...
	 * @param type must not be {@literal null}.
	 */
	public JacksonJsonValkeySerializer(ObjectMapper mapper, Class<T> type) {
	 ...
	 * @param javaType must not be {@literal null}.
	 */
	public JacksonJsonValkeySerializer(ObjectMapper mapper, JavaType javaType) {
	 ...
	 */
	public JacksonJsonValkeySerializer(ObjectMapper mapper, JavaType javaType, JacksonObjectReader reader,
