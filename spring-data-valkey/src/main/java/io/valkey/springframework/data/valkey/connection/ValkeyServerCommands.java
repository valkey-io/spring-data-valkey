...
public interface ValkeyServerCommands {
     ...
     *
     * @see <a href="https://valkey.io/commands/config-resetstat">Valkey Documentation: CONFIG
     *     RESETSTAT</a>
     */
     ...
     *
     * @since 2.5
     * @see <a href="https://valkey.io/commands/config-rewrite">Valkey Documentation: CONFIG
     *     REWRITE</a>
     */
    void rewriteConfig();
     ...
     *
     * @return current server time in milliseconds or {@literal null} when used in pipeline /
     *     transaction.
     * @since 1.1
     ...
     * @return current server time in {@link TimeUnit} or {@literal null} when used in pipeline /
     *     transaction.
     * @since 2.5
     * @see <a href="https://valkey.io/commands/time">Valkey Documentation: TIME</a>
     */
     ...
     *
     * @see <a href="https://valkey.io/commands/client-getname">Valkey Documentation: CLIENT
     *     GETNAME</a>
     * @return {@literal null} when used in pipeline / transaction.
     * @since 1.3
     */
     ...
     *
     * @return {@link List} of {@link ValkeyClientInfo} objects or {@literal null} when used in
    ...
    /**
     * Atomically transfer a key from a source Valkey instance to a destination Valkey instance. On
     * success the key is deleted from the original instance and is guaranteed to exist in the target
     * instance.
     *
