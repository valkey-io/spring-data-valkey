...
public interface BoundGeoOperations<K, M> extends BoundKeyOperations<K> {
     ...
     */
    @Nullable
    default GeoResults<GeoLocation<M>> search(
            GeoReference<M> reference, Distance radius, GeoSearchCommandArgs args) {
    ...
    @Nullable
    default GeoResults<GeoLocation<M>> search(
            GeoReference<M> reference, BoundingBox boundingBox, GeoSearchCommandArgs args) {
     ...
     */
    @Nullable
    GeoResults<GeoLocation<M>> search(
            GeoReference<M> reference, GeoShape geoPredicate, GeoSearchCommandArgs args);
    ...
    default Long searchAndStore(K destKey, GeoReference<M> reference, Distance radius) {
        return searchAndStore(
                destKey, reference, radius, GeoSearchStoreCommandArgs.newGeoSearchStoreArgs());
    }
     ...
     */
    @Nullable
    default Long searchAndStore(
            K destKey, GeoReference<M> reference, Distance radius, GeoSearchStoreCommandArgs args) {
    ...
    default Long searchAndStore(K destKey, GeoReference<M> reference, BoundingBox boundingBox) {
        return searchAndStore(
                destKey, reference, boundingBox, GeoSearchStoreCommandArgs.newGeoSearchStoreArgs());
    }
    ...
    @Nullable
    Long searchAndStore(
            K destKey, GeoReference<M> reference, GeoShape geoPredicate, GeoSearchStoreCommandArgs args);
}
