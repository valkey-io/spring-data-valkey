...
public interface ReactiveHashCommands {
	...
	class HSetExCommand extends KeyCommand {
		...
		private final Map<ByteBuffer, ByteBuffer> fieldValueMap;
		private final ValkeyHashCommands.HashFieldSetOption condition;
		private final @Nullable Expiration expiration;

		private HSetExCommand(@Nullable ByteBuffer key, Map<ByteBuffer, ByteBuffer> fieldValueMap,
				ValkeyHashCommands.HashFieldSetOption condition, @Nullable Expiration expiration) {
			super(key);
		 ...
		 */
		public ValkeyHashCommands.HashFieldSetOption getCondition() {
			return condition;
		}
