...
public interface ValkeyStringCommands {
     ...
     *
     * <p>Use {@link Expiration#seconds(long)} for {@code EX}. <br>
     ...
     * @param key must not be {@literal null}.
     * @param value must not be {@literal null}.
     * @param expiration must not be {@literal null}. Use {@link Expiration#persistent()} to not set
     *     any ttl or {@link Expiration#keepTtl()} to keep the existing expiration.
    ...
    /**
     * Set {@code value} for {@code key}. Return the old string stored at key, or {@literal null} if
     * key did not exist. An error is returned and SET aborted if the value stored at key is not a
     * string.
     *
     * @param key must not be {@literal null}.
     * @param value must not be {@literal null}.
     ...
     * @param offset
     * @param value
     * @return the original bit value stored at {@code offset} or {@literal null} when used in
