...
/**
 * Utility for functional invocation of Jedis methods. Typically used to express the method call as
 * method reference and passing method arguments through one of the {@code just} or {@code from}
 * methods.
 *
 * <p>{@code just} methods record the method call and evaluate the method result immediately. {@code
 * from} methods allows composing a functional pipeline to transform the result using a {@link
 * Converter}.
 *
 * <p>Usage example:
 *
 ...
 * </pre>
 *
 * <p>The actual translation from {@link Response} is delegated to {@link Synchronizer} which can
 * either await completion or record the response along {@link Converter} for further processing.
 *
 * @author Mark Paluch
...
class JedisInvoker {
    ...
    <R> R just(ConnectionFunction0<R> function) {
        ...
        return synchronizer.invoke(
                function::apply,
                it -> {
                    throw new InvalidDataAccessApiUsageException(
                            "Operation not supported by Jedis in pipelining/transaction mode");
                },
    ...
    <R> R just(ConnectionFunction0<R> function, PipelineFunction0<R> pipelineFunction) {
        ...
        return synchronizer.invoke(
                function::apply, pipelineFunction::apply, Converters.identityConverter(), () -> null);
    }
    ...
    @Nullable
    <R, T1> R just(
            ConnectionFunction1<T1, R> function, PipelineFunction1<T1, R> pipelineFunction, T1 t1) {
    ...
    @Nullable
    <R, T1, T2> R just(
            ConnectionFunction2<T1, T2, R> function,
            PipelineFunction2<T1, T2, R> pipelineFunction,
            T1 t1,
            T2 t2) {
        ...
        return synchronizer.invoke(
                it -> function.apply(it, t1, t2), it -> pipelineFunction.apply(it, t1, t2));
    }
    ...
    @Nullable
    <R, T1, T2, T3> R just(
            ConnectionFunction3<T1, T2, T3, R> function,
            PipelineFunction3<T1, T2, T3, R> pipelineFunction,
            T1 t1,
            T2 t2,
            T3 t3) {
        ...
        return synchronizer.invoke(
                it -> function.apply(it, t1, t2, t3), it -> pipelineFunction.apply(it, t1, t2, t3));
    }
     ...
     */
    @Nullable
    <R, T1, T2, T3, T4> R just(
            ConnectionFunction4<T1, T2, T3, T4, R> function,
        ...
        return synchronizer.invoke(
                it -> function.apply(it, t1, t2, t3, t4), it -> pipelineFunction.apply(it, t1, t2, t3, t4));
    }
     ...
     */
    @Nullable
    <R, T1, T2, T3, T4, T5> R just(
            ConnectionFunction5<T1, T2, T3, T4, T5, R> function,
            PipelineFunction5<T1, T2, T3, T4, T5, R> pipelineFunction,
            T1 t1,
            T2 t2,
            T3 t3,
            T4 t4,
        ...
        return synchronizer.invoke(
                it -> function.apply(it, t1, t2, t3, t4, t5),
     ...
     */
    @Nullable
    <R, T1, T2, T3, T4, T5, T6> R just(
            ConnectionFunction6<T1, T2, T3, T4, T5, T6, R> function,
            PipelineFunction6<T1, T2, T3, T4, T5, T6, R> pipelineFunction,
            T1 t1,
            T2 t2,
            T3 t3,
            T4 t4,
        ...
        return synchronizer.invoke(
                it -> function.apply(it, t1, t2, t3, t4, t5, t6),
                it -> pipelineFunction.apply(it, t1, t2, t3, t4, t5, t6));
    }

    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction0} and return a {@link
     * SingleInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     */
    <R> SingleInvocationSpec<R> from(ConnectionFunction0<R> function) {
        ...
        return from(
                ...
                connection -> {
                    throw new InvalidDataAccessApiUsageException(
                            "Operation not supported in pipelining/transaction mode");
                });
    }
     ...
     * @param pipelineFunction must not be {@literal null}.
     */
    <R> SingleInvocationSpec<R> from(
            ConnectionFunction0<R> function, PipelineFunction0<R> pipelineFunction) {

        Assert.notNull(function, "ConnectionFunction must not be null");
        Assert.notNull(pipelineFunction, "PipelineFunction must not be null");

        return new DefaultSingleInvocationSpec<>(
                function::apply, pipelineFunction::apply, synchronizer);
    }

    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction1} and return a {@link
     * SingleInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     * @param t1 first argument.
     */
    <R, T1> SingleInvocationSpec<R> from(
            ConnectionFunction1<T1, R> function, PipelineFunction1<T1, R> pipelineFunction, T1 t1) {
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction2} and return a {@link
     * SingleInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     ...
     * @param t2 second argument.
     */
    <R, T1, T2> SingleInvocationSpec<R> from(
            ConnectionFunction2<T1, T2, R> function,
            PipelineFunction2<T1, T2, R> pipelineFunction,
            T1 t1,
            T2 t2) {
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction3} and return a {@link
     * SingleInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     ...
     * @param t3 third argument.
     */
    <R, T1, T2, T3> SingleInvocationSpec<R> from(
            ConnectionFunction3<T1, T2, T3, R> function,
            PipelineFunction3<T1, T2, T3, R> pipelineFunction,
            T1 t1,
            T2 t2,
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction4} and return a {@link
     * SingleInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     ...
     * @param t4 fourth argument.
     */
    <R, T1, T2, T3, T4> SingleInvocationSpec<R> from(
            ConnectionFunction4<T1, T2, T3, T4, R> function,
            PipelineFunction4<T1, T2, T3, T4, R> pipelineFunction,
            T1 t1,
            T2 t2,
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction5} and return a {@link
     * SingleInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     ...
     * @param t5 fifth argument.
     */
    <R, T1, T2, T3, T4, T5> SingleInvocationSpec<R> from(
            ConnectionFunction5<T1, T2, T3, T4, T5, R> function,
            PipelineFunction5<T1, T2, T3, T4, T5, R> pipelineFunction,
            T1 t1,
            T2 t2,
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction6} and return a {@link
     * SingleInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     ...
     * @param t6 sixth argument.
     */
    <R, T1, T2, T3, T4, T5, T6> SingleInvocationSpec<R> from(
            ConnectionFunction6<T1, T2, T3, T4, T5, T6, R> function,
            PipelineFunction6<T1, T2, T3, T4, T5, T6, R> pipelineFunction,
            T1 t1,
            T2 t2,
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction0} that returns a {@link
     * Collection}-like result and return a {@link ManyInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     */
     ...
     * @param pipelineFunction must not be {@literal null}.
     */
    <R extends Collection<E>, E> ManyInvocationSpec<E> fromMany(
            ConnectionFunction0<R> function, PipelineFunction0<R> pipelineFunction) {
        ...
        return new DefaultManyInvocationSpec<>(
                (Function<Jedis, R>) function::apply, pipelineFunction::apply, synchronizer);
    }

    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction1} that returns a {@link
     * Collection}-like result and return a {@link ManyInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     * @param t1 first argument.
     */
    <R extends Collection<E>, E, T1> ManyInvocationSpec<E> fromMany(
            ConnectionFunction1<T1, R> function, PipelineFunction1<T1, R> pipelineFunction, T1 t1) {
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction2} that returns a {@link
     * Collection}-like result and return a {@link ManyInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     ...
     * @param t2 second argument.
     */
    <R extends Collection<E>, E, T1, T2> ManyInvocationSpec<E> fromMany(
            ConnectionFunction2<T1, T2, R> function,
            PipelineFunction2<T1, T2, R> pipelineFunction,
            T1 t1,
            T2 t2) {
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction3} that returns a {@link
     * Collection}-like result and return a {@link ManyInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
     ...
     * @param t3 third argument.
     */
    <R extends Collection<E>, E, T1, T2, T3> ManyInvocationSpec<E> fromMany(
            ConnectionFunction3<T1, T2, T3, R> function,
            PipelineFunction3<T1, T2, T3, R> pipelineFunction,
            T1 t1,
            T2 t2,
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction4} that returns a {@link
     * Collection}-like result and return a {@link ManyInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction5} that returns a {@link
     * Collection}-like result and return a {@link ManyInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
    ...
    /**
     * Compose a invocation pipeline from the {@link ConnectionFunction6} that returns a {@link
     * Collection}-like result and return a {@link ManyInvocationSpec} for further composition.
     *
     * @param function must not be {@literal null}.
     * @param pipelineFunction must not be {@literal null}.
    ...
    /**
     * Represents an element in the invocation pipleline allowing consuming the result by applying a
     * {@link Converter}.
     *
     * @param <S>
     */
    interface SingleInvocationSpec<S> {
        ...
        /**
         * Materialize the pipeline by invoking the {@code ConnectionFunction} and returning the result
         * after applying {@link Converter} or return the {@literal nullDefault} value if not present.
         *
         * @param converter must not be {@literal null}.
    ...
    /**
     * Represents an element in the invocation pipleline for methods returning {@link Collection}-like
     * results allowing consuming the result by applying a {@link Converter}.
     *
     * @param <S>
     */
    ...
    static class DefaultSingleInvocationSpec<S> implements SingleInvocationSpec<S> {
        ...
        DefaultSingleInvocationSpec(
                Function<Jedis, S> parentFunction,
                Function<ResponseCommands, Response<S>> parentPipelineFunction,
    ...
    static class DefaultManyInvocationSpec<S> implements ManyInvocationSpec<S> {
        ...
        DefaultManyInvocationSpec(
                Function<Jedis, ? extends Collection<S>> parentFunction,
    ...
    interface Synchronizer {
        ...
        default <I, T> T invoke(
                Function<Jedis, I> callFunction, Function<ResponseCommands, Response<I>> pipelineFunction) {
        ...
        @Nullable
        Object doInvoke(
                Function<Jedis, Object> callFunction,
                Function<ResponseCommands, Response<Object>> pipelineFunction,
                Converter<Object, Object> converter,
                Supplier<Object> nullDefault);
    }
    ...
    /**
     * Create a proxy to invoke methods dynamically on {@link Pipeline} or {@link Transaction} as
     * those share many commands that are not defined on a common super-type.
     */
