...
/**
 * {@link Properties} extension for a Valkey back-store. Useful for reading (and storing) properties
 * inside a Valkey hash. Particularly useful inside a Spring container for hooking into Spring's
 * property placeholder or {@link org.springframework.beans.factory.config.PropertiesFactoryBean}.
 *
 * <p>Note that this implementation only accepts Strings - objects of other type are not supported.
 *
 * @see Properties
...
public class ValkeyProperties extends Properties implements ValkeyMap<Object, Object> {
    ...
    public ValkeyProperties(
            @Nullable Properties defaults, BoundHashOperations<String, String, String> boundOps) {
    ...
    @Override
    public BoundHashFieldExpirationOperations<Object> hashFieldExpiration(
            Collection<Object> hashFields) {
        return (BoundHashFieldExpirationOperations)
                delegate.hashFieldExpiration((Collection) hashFields);
    }
}
