...
/**
 * Valkey extension for the {@link List} contract. Supports {@link List}, {@link Queue} and {@link
 * Deque} contracts as well as their equivalent blocking siblings {@link BlockingDeque} and {@link
 * BlockingDeque}.
 *
...
public interface ValkeyList<E> extends ValkeyCollection<E>, List<E>, BlockingDeque<E> {
    ...
    /**
     * Factory method used to construct a new {@link ValkeyList} from a Valkey list reference by the
     * given {@link String key}.
     *
     * @param key Valkey key of this list.
     * @param operations {@link ValkeyOperations} for the value type of this list.
    ...
    /**
     * Atomically returns and removes the first element of the list stored at the bound key, and
     * pushes the element at the first/last element (head/tail depending on the {@link Direction
     * destinationPosition} argument) of the list stored at {@link ValkeyList destination}.
     *
    ...
    @Nullable
    E moveFirstTo(
            ValkeyList<E> destination, Direction destinationPosition, long timeout, TimeUnit unit);
     ...
     */
    @Nullable
    default E moveFirstTo(
            ValkeyList<E> destination, Direction destinationPosition, Duration timeout) {
    ...
    /**
     * Atomically returns and removes the last element of the list stored at the bound key, and pushes
     * the element at the first/last element (head/tail depending on the {@link Direction
     * destinationPosition} argument) of the list stored at {@link ValkeyList destination}.
     *
     * @param destination must not be {@literal null}.
     * @param destinationPosition must not be {@literal null}.
     ...
     * {@inheritDoc}
     *
     * <p>This method is forward-compatible with Java 21 {@literal SequencedCollections}.
     *
     ...
     *
     * <p>The encounter order of elements returned by the view is the inverse of the encounter order
     * of the elements stored in this collection. The reverse ordering affects all order-sensitive
     * operations, including any operations on further views of the returned view. If the collection
     * implementation permits modifications to this view, the modifications "write-through" to the
     * underlying collection. Changes to the underlying collection might or might not be visible in
