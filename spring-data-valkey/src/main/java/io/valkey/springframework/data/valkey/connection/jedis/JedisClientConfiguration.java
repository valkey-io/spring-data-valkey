...
/**
 * Valkey client configuration for jedis. This configuration provides optional configuration
 * elements such as {@link SSLSocketFactory} and {@link JedisPoolConfig} specific to jedis client
 * features.
 *
 * <p>Providing optional elements allows a more specific configuration of the client:
 *
 * <ul>
 *   <li>Whether to use SSL
 *   <li>Optional {@link SSLSocketFactory}
 *   <li>Optional {@link SSLParameters}
 *   <li>Optional {@link HostnameVerifier}
 *   <li>Whether to use connection-pooling
 *   <li>Optional {@link GenericObjectPoolConfig}
 *   <li>Optional client name
 *   <li>Connect {@link Duration timeout}
 *   <li>Read {@link Duration timeout}
 * </ul>
 *
 * @author Mark Paluch
 ...
 * @see io.valkey.springframework.data.valkey.connection.ValkeyStandaloneConfiguration
 * @see io.valkey.springframework.data.valkey.connection.ValkeySentinelConfiguration
 * @see io.valkey.springframework.data.valkey.connection.ValkeyClusterConfiguration
 */
public interface JedisClientConfiguration {
    ...
    /**
     * @return {@literal true} to use connection-pooling. Applies only to single node Valkey. Sentinel
     *     and Cluster modes use always connection-pooling regardless of the pooling setting.
     */
    ...
    /**
     * Creates a new {@link JedisClientConfigurationBuilder} to build {@link JedisClientConfiguration}
     * to be used with the jedis client.
     *
     * @return a new {@link JedisClientConfigurationBuilder} to build {@link
    ...
    interface JedisClientConfigurationBuilder {
        ...
        /**
         * Configure a {@link JedisClientConfigBuilderCustomizer} to configure {@link
         ...
         *
         * <p>Applies only to single node Valkey. Sentinel and Cluster modes use always
         * connection-pooling regardless of the pooling setting.
         *
    ...
    /**
     * Default {@link JedisClientConfigurationBuilder} implementation to build an immutable {@link
     * JedisClientConfiguration}.
     */
    class DefaultJedisClientConfigurationBuilder
        ...
        @Override
        public JedisClientConfigurationBuilder customize(
                JedisClientConfigBuilderCustomizer customizer) {
        ...
        public JedisClientConfiguration build() {
            ...
            return new DefaultJedisClientConfiguration(
                    customizer,
                    useSsl,
                    sslSocketFactory,
                    sslParameters,
