...
/**
 * Comparison-based condition for conditional Valkey operations such as {@code DELEX} and {@code SET}.
...
public class CompareCondition {
	 ...
	 * {@code hex16Digest}.
	 *
	 * @param hex16Digest the value digest in hexadecimal format. Obtained via Valkey {@code DIGEST} command.
	 * @return the new {@link CompareCondition}.
