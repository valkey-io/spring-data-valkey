...
/**
 * Converter configuration that provides a {@link Builder} to create a composite {@link MessageConverter} for Valkey
 * listener endpoints.
 * <p>
 ...
 * <p>
 * <strong>Note:</strong>{@code ValkeyMessageConverters} uses Spring Data Valkey's {@link ValkeySerializer}s for JSON
 ...
 * @author Mark Paluch
 * @since 4.1
 * @see io.valkey.springframework.data.valkey.serializer.GenericJacksonJsonValkeySerializer
 * @see io.valkey.springframework.data.valkey.serializer.GenericJackson2JsonValkeySerializer
 ...
 */
public interface ValkeyMessageConverters {
	...
	static Builder builder() {
		return new DefaultValkeyMessageConverters.DefaultBuilder();
	}
	...
	interface Builder {
		...
		/**
		 * Add a custom {@link MessageConverter} to the composite converter using the given {@link ValkeySerializer} to use
		 * Spring Data Valkey' {@link ValkeySerializer} for specific serializers such.
		 * {@link io.valkey.springframework.data.valkey.serializer.JdkSerializationValkeySerializer JDK serialization}.
		 * <p>
		 ...
		 * @return this builder.
		 */
		default Builder addCustomConverter(ValkeySerializer<?> serializer) {
			if (serializer instanceof JdkSerializationValkeySerializer jdkSerializer) {
		 ...
		 *
		 * @return the constructed {@link ValkeyMessageConverters}.
		 */
		ValkeyMessageConverters build();
