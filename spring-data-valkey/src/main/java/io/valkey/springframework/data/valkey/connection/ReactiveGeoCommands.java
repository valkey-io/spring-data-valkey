...
public interface ReactiveGeoCommands {
    ...
    default Mono<Long> geoAdd(ByteBuffer key, Collection<GeoLocation<ByteBuffer>> locations) {
        ...
        return geoAdd(Mono.just(GeoAddCommand.locations(locations).to(key)))
                .next()
    ...
    class GeoDistCommand extends KeyCommand {
        ...
        private GeoDistCommand(
                @Nullable ByteBuffer key,
                @Nullable ByteBuffer from,
        ...
        /**
         * Applies the {@literal from} member. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * Applies the {@literal to} member. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * Applies the Geo set {@literal key} member. Constructs a new command instance with all
    ...
    default Mono<List<Point>> geoPos(ByteBuffer key, Collection<ByteBuffer> members) {
        ...
        return geoPos(Mono.just(GeoPosCommand.members(members).of(key)))
                .next()
                .map(MultiValueResponse::getOutput);
    }
    ...
    class GeoRadiusCommand extends KeyCommand {
        ...
        private GeoRadiusCommand(
                @Nullable ByteBuffer key,
                @Nullable Point point,
                Distance distance,
                GeoRadiusCommandArgs args,
                @Nullable ByteBuffer store,
                @Nullable ByteBuffer storeDist) {
        ...
        public static GeoRadiusCommand within(Distance distance) {
            ...
            return new GeoRadiusCommand(
                    null, null, distance, GeoRadiusCommandArgs.newGeoRadiusArgs(), null, null);
        }

        /**
         * Creates a new {@link GeoRadiusCommand} given a {@literal distance} in {@link
         * DistanceUnit#METERS}.
         *
         * @param distance must not be {@literal null}.
         * @return a new {@link GeoRadiusCommand} for a {@literal distance} in {@link
         *     DistanceUnit#METERS}.
         */
        ...
        /**
         * Sets the {@literal center} {@link Point}. Constructs a new command instance with all
         * previously configured properties.
         *
        ...
        /**
         * Applies command {@link Flag flags}. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * Enables coordinate retrieval. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * Enables distance retrieval. Constructs a new command instance with all previously configured
         * properties.
         *
        ...
        /**
         * Applies command {@link GeoRadiusCommandArgs}. Constructs a new command instance with all
         * previously configured properties.
         *
        ...
        public GeoRadiusCommand withArgs(GeoRadiusCommandArgs args) {
            ...
            return new GeoRadiusCommand(
                    ...
                    point,
                    distance,
                    args == null ? GeoRadiusCommandArgs.newGeoRadiusArgs() : args,
                    store,
                    storeDist);
        }
        ...
        /**
         * Applies the distance sort {@link Direction}. Constructs a new command instance with all
         * previously configured properties.
         *
        ...
        /**
         * Applies ascending sort by distance. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * Applies descending sort by distance. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * <b>NOTE:</b> STOREDIST option is not compatible with WITHDIST, WITHHASH and WITHCOORDS
         * options.
         *
         * @param key must not be {@literal null}.
         * @return new instance of {@link GeoRadiusCommand}.
    ...
    /**
     * Get the {@literal member}s within the boundaries of a given {@link Circle} applying given
     * parameters.
     *
     * @param key must not be {@literal null}.
     * @param circle must not be {@literal null}.
     ...
     * @see <a href="https://valkey.io/commands/georadius">Valkey Documentation: GEORADIUS</a>
     */
    default Flux<GeoResult<GeoLocation<ByteBuffer>>> geoRadius(
            ByteBuffer key, Circle circle, GeoRadiusCommandArgs geoRadiusArgs) {
    ...
    class GeoRadiusByMemberCommand extends KeyCommand {
        ...
        private GeoRadiusByMemberCommand(
                @Nullable ByteBuffer key,
                @Nullable ByteBuffer member,
                Distance distance,
                GeoRadiusCommandArgs args,
                @Nullable ByteBuffer store,
                @Nullable ByteBuffer storeDist) {
        ...
        public static GeoRadiusByMemberCommand within(Distance distance) {
            ...
            return new GeoRadiusByMemberCommand(
                    null, null, distance, GeoRadiusCommandArgs.newGeoRadiusArgs(), null, null);
        }

        /**
         * Creates a new {@link GeoRadiusByMemberCommand} given a {@literal distance} in {@link
         * DistanceUnit#METERS}.
         *
         * @param distance must not be {@literal null}.
         * @return a new {@link GeoRadiusByMemberCommand} for a {@literal distance} in {@link
         *     DistanceUnit#METERS}.
         */
        ...
        /**
         * Sets the {@literal member}. Constructs a new command instance with all previously configured
         * properties.
         *
         * @param member must not be {@literal null}.
    ...
    /**
     * Get the {@literal member}s within given {@link Distance} from {@literal member} applying given
     * parameters.
     *
     * @param key must not be {@literal null}.
     * @param member must not be {@literal null}.
     ...
     *     GEORADIUSBYMEMBER</a>
     */
    default Flux<GeoResult<GeoLocation<ByteBuffer>>> geoRadiusByMember(
            ByteBuffer key, ByteBuffer member, Distance distance) {
     ...
     */
    default Flux<GeoResult<GeoLocation<ByteBuffer>>> geoRadiusByMember(
            ByteBuffer key, ByteBuffer member, Distance distance, GeoRadiusCommandArgs geoRadiusArgs) {
        ...
        return geoRadiusByMember(
                        Mono.just(
                                GeoRadiusByMemberCommand.within(distance)
                                        .from(member)
                                        .forKey(key)
                                        .withArgs(geoRadiusArgs)))
                .flatMap(CommandResponse::getOutput);
    }
     ...
     *     GEORADIUSBYMEMBER</a>
     */
    Flux<CommandResponse<GeoRadiusByMemberCommand, Flux<GeoResult<GeoLocation<ByteBuffer>>>>>
            geoRadiusByMember(Publisher<GeoRadiusByMemberCommand> commands);
    ...
    class GeoSearchCommand extends KeyCommand {
        ...
        private GeoSearchCommand(
                @Nullable ByteBuffer key,
                @Nullable GeoReference<ByteBuffer> reference,
                @Nullable GeoShape shape,
                @Nullable GeoSearchCommandArgs args) {
            super(key);
        ...
        /**
         * Sets the geoset {@literal key}. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * Sets the command {@literal args}. Constructs a new command instance with all previously
         * configured properties.
         *
         * @param args must not be {@literal null}.
     ...
     * @author Mark Paluch
     * @since 2.6
     * @see <a href="https://valkey.io/commands/geosearchstore">Valkey Documentation:
     *     GEOSEARCHSTORE</a>
     */
    class GeoSearchStoreCommand extends KeyCommand {
        ...
        /**
         * Sets the geoset {@literal destKey}. Constructs a new command instance with all previously
         * configured properties.
         *
     ...
     * @see <a href="https://valkey.io/commands/geosearch">Valkey Documentation: GEOSEARCH</a>
     */
    default Flux<GeoResult<GeoLocation<ByteBuffer>>> geoSearch(
            ByteBuffer key,
    ...
    /**
     * Get the {@literal member}s within given {@link GeoShape} from {@link GeoReference} applying
     * given parameters.
     *
     * @param commands must not be {@literal null}.
     * @return
     ...
     * @see <a href="https://valkey.io/commands/geosearch">Valkey Documentation: GEOSEARCH</a>
     */
    default Mono<Long> geoSearchStore(
            ByteBuffer destKey,
            ByteBuffer key,
            GeoReference<ByteBuffer> reference,
            GeoShape shape,
        ...
        return geoSearchStore(
                        Mono.just(
                                GeoSearchStoreCommand.within(shape)
                                        .in(key)
                                        .storeAt(destKey)
                                        .at(reference)
                                        .with(args)))
    ...
    /**
     * Store the {@literal member}s within given {@link GeoShape} from {@link GeoReference} applying
     * given parameters in a new geo set.
     *
     * @param commands must not be {@literal null}.
     * @return
     * @since 2.6
     ...
     *     GEOSEARCHSTORE</a>
     */
    Flux<NumericResponse<GeoSearchStoreCommand, Long>> geoSearchStore(
            Publisher<GeoSearchStoreCommand> commands);
}
