...
import io.valkey.springframework.data.valkey.connection.jedis.JedisClusterConnection.JedisClusterCommandCallback;
...
class JedisClusterServerCommands implements ValkeyClusterServerCommands {
    ...
    public void flushAll(FlushOption option) {
        connection
                ...
                .executeCommandOnAllNodes(
                        (JedisClusterCommandCallback<String>)
                                it -> it.flushAll(JedisConverters.toFlushMode(option)));
    }
    ...
    public Properties info() {
        ...
        List<NodeResult<Properties>> nodeResults =
                connection
                        .getClusterCommandExecutor()
                        .executeCommandOnAllNodes(
                                (JedisClusterCommandCallback<Properties>)
                                        client -> JedisConverters.toProperties(client.info()))
                        .getResults();
    ...
    public Properties info(String section) {
        ...
        List<NodeResult<Properties>> nodeResults =
                connection
                        ...
                        .executeCommandOnAllNodes(
                                (JedisClusterCommandCallback<Properties>)
                                        client -> JedisConverters.toProperties(client.info(section)))
                        .getResults();
    ...
    public Properties info(ValkeyClusterNode node, String section) {
        ...
        return JedisConverters.toProperties(
                executeCommandOnSingleNode(client -> client.info(section), node).getValue());
    }
    ...
    public Properties getConfig(String pattern) {
        ...
        List<NodeResult<Map<String, String>>> nodeResults =
                connection.getClusterCommandExecutor().executeCommandOnAllNodes(command).getResults();
    ...
    public Properties getConfig(ValkeyClusterNode node, String pattern) {
        ...
        return connection
                ...
                .executeCommandOnSingleNode(
                        (JedisClusterCommandCallback<Properties>)
                                client -> Converters.toProperties(client.configGet(pattern)),
                        node)
                .getValue();
    }
    ...
    public void setConfig(String param, String value) {
        ...
        connection
                .getClusterCommandExecutor()
                .executeCommandOnAllNodes(
                        (JedisClusterCommandCallback<String>) client -> client.configSet(param, value));
    }
    ...
    public Long time(TimeUnit timeUnit) {
        ...
        return convertListOfStringToTime(
                connection
                        .getClusterCommandExecutor()
                        .executeCommandOnArbitraryNode((JedisClusterCommandCallback<List<String>>) Jedis::time)
                        .getValue(),
                timeUnit);
    }
    ...
    public Long time(ValkeyClusterNode node, TimeUnit timeUnit) {
        ...
        return convertListOfStringToTime(
                connection
                        .getClusterCommandExecutor()
                        .executeCommandOnSingleNode(
                                (JedisClusterCommandCallback<List<String>>) Jedis::time, node)
                        .getValue(),
                timeUnit);
    }
    ...
    public List<ValkeyClientInfo> getClientList() {
        ...
        Collection<String> map =
                connection
                        .getClusterCommandExecutor()
                        .executeCommandOnAllNodes((JedisClusterCommandCallback<String>) Jedis::clientList)
                        .resultsAsList();
    ...
    public List<ValkeyClientInfo> getClientList(ValkeyClusterNode node) {
        ...
        return JedisConverters.toListOfValkeyClientInformation(
                executeCommandOnSingleNode(Jedis::clientList, node).getValue());
    }
    ...
    public void migrate(
        ...
        ValkeyClusterNode node =
                connection.getTopologyProvider().getTopology().lookup(target.getHost(), target.getPort());

        executeCommandOnSingleNode(
                client -> client.migrate(target.getHost(), target.getPort(), key, dbIndex, timeoutToUse),
                node);
    }
    ...
    private Long convertListOfStringToTime(List<String> serverTimeInformation, TimeUnit timeUnit) {
        ...
        Assert.notEmpty(
                ...
                "Received invalid result from server; Expected 2 items in collection");
        Assert.isTrue(
                serverTimeInformation.size() == 2,
                "Received invalid number of arguments from valkey server; Expected 2 received "
                        + serverTimeInformation.size());

        return Converters.toTimeMillis(
                serverTimeInformation.get(0), serverTimeInformation.get(1), timeUnit);
    }

    private <T> NodeResult<T> executeCommandOnSingleNode(
            JedisClusterCommandCallback<T> cmd, ValkeyClusterNode node) {
