...
class JedisClusterZSetCommands implements ValkeyZSetCommands {
    ...
    public Boolean zAdd(byte[] key, double score, byte[] value, ZAddArgs args) {
        ...
        try {
            return JedisConverters.toBoolean(
                    connection.getCluster().zadd(key, score, value, JedisConverters.toZAddParams(args)));
        } catch (Exception ex) {
    ...
    public Long zAdd(byte[] key, Set<Tuple> tuples, ZAddArgs args) {
        ...
        try {
            return connection
                    .getCluster()
                    .zadd(key, JedisConverters.toTupleMap(tuples), JedisConverters.toZAddParams(args));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
    ...
    public Tuple zRandMemberWithScore(byte[] key) {
        ...
        try {
            List<redis.clients.jedis.resps.Tuple> tuples =
                    connection.getCluster().zrandmemberWithScores(key, 1);
    ...
    public List<Tuple> zRandMemberWithScore(byte[] key, long count) {
        ...
        try {
            List<redis.clients.jedis.resps.Tuple> tuples =
                    connection.getCluster().zrandmemberWithScores(key, count);
    ...
    public Set<Tuple> zRangeByScoreWithScores(
        ...
        try {
            ...
            return toTupleSet(
                    connection
                            .getCluster()
                            .zrangeByScoreWithScores(key, min, max, limit.getOffset(), limit.getCount()));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
    ...
    public Set<byte[]> zRevRangeByScore(
        ...
        try {
            ...
            return new LinkedHashSet<>(
                    connection
                            .getCluster()
                            .zrevrangeByScore(key, max, min, limit.getOffset(), limit.getCount()));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
    ...
    public Set<Tuple> zRevRangeByScoreWithScores(
        ...
        try {
            ...
            return toTupleSet(
                    connection
                            .getCluster()
                            .zrevrangeByScoreWithScores(key, max, min, limit.getOffset(), limit.getCount()));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
    ...
    public Tuple bZPopMin(byte[] key, long timeout, TimeUnit unit) {
        ...
        try {
            return toTuple(
                    connection.getCluster().bzpopmin(JedisConverters.toSeconds(timeout, unit), key));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
    ...
    public Tuple bZPopMax(byte[] key, long timeout, TimeUnit unit) {
        ...
        try {
            return toTuple(
                    connection.getCluster().bzpopmax(JedisConverters.toSeconds(timeout, unit), key));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
    ...
    public Set<byte[]> zRangeByScore(
        ...
        try {
            ...
            return new LinkedHashSet<>(
                    connection
                            .getCluster()
                            .zrangeByScore(key, min, max, limit.getOffset(), limit.getCount()));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
    ...
    public Set<byte[]> zRevRangeByLex(
        ...
        try {
            ...
            return new LinkedHashSet<>(
                    connection
                            .getCluster()
                            .zrevrangeByLex(key, max, min, limit.getOffset(), limit.getCount()));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
        ...
        try {
            return new LinkedHashSet<>(
                    connection
                            .getCluster()
                            .zrangeByScore(
                                    key, min, max, Long.valueOf(offset).intValue(), Long.valueOf(count).intValue()));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
        ...
        try {
            return new LinkedHashSet<>(
                    connection
                            .getCluster()
                            .zrevrangeByScore(
                                    key, max, min, Long.valueOf(offset).intValue(), Long.valueOf(count).intValue()));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
    ...
    public Set<byte[]> zDiff(byte[]... sets) {
        ...
        throw new InvalidDataAccessApiUsageException(
                "ZDIFF can only be executed when all keys map to the same slot");
    }
        ...
        if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
            ...
            try {
                return JedisConverters.toSet(
                        JedisConverters.toTupleList(connection.getCluster().zdiffWithScores(sets)));
            } catch (Exception ex) {
                throw convertJedisAccessException(ex);
            }
        }
    ...
    public Long zDiffStore(byte[] destKey, byte[]... sets) {
        ...
        throw new InvalidDataAccessApiUsageException(
                "ZDIFFSTORE can only be executed when all keys map to the same slot");
    }
    ...
    public Set<byte[]> zInter(byte[]... sets) {
        ...
        throw new InvalidDataAccessApiUsageException(
                "ZINTER can only be executed when all keys map to the same slot");
    }
    ...
    public Set<Tuple> zInterWithScores(byte[]... sets) {
        ...
        if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
            ...
            try {
                return JedisConverters.toSet(
                        JedisConverters.toTupleList(
                                connection.getCluster().zinterWithScores(new ZParams(), sets)));
            } catch (Exception ex) {
                throw convertJedisAccessException(ex);
            }
        }
    ...
    public Set<Tuple> zInterWithScores(Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
            ...
            try {
                return JedisConverters.toSet(
                        JedisConverters.toTupleList(
                                connection.getCluster().zinterWithScores(toZParams(aggregate, weights), sets)));
            } catch (Exception ex) {
                throw convertJedisAccessException(ex);
            }
        }
    ...
    public Set<byte[]> zUnion(byte[]... sets) {
        ...
        throw new InvalidDataAccessApiUsageException(
                "ZUNION can only be executed when all keys map to the same slot");
    }
    ...
    public Set<Tuple> zUnionWithScores(byte[]... sets) {
        ...
        if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
            ...
            try {
                return JedisConverters.toSet(
                        JedisConverters.toTupleList(
                                connection.getCluster().zunionWithScores(new ZParams(), sets)));
            } catch (Exception ex) {
                throw convertJedisAccessException(ex);
            }
        }
    ...
    public Set<Tuple> zUnionWithScores(Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
            ...
            try {
                return JedisConverters.toSet(
                        JedisConverters.toTupleList(
                                connection.getCluster().zunionWithScores(toZParams(aggregate, weights), sets)));
            } catch (Exception ex) {
                throw convertJedisAccessException(ex);
            }
        }
        ...
        return new ScanCursor<Tuple>(options) {
            ...
            protected ScanIteration<Tuple> doScan(CursorId cursorId, ScanOptions options) {
                ...
                ScanResult<redis.clients.jedis.resps.Tuple> result =
                        connection.getCluster().zscan(key, JedisConverters.toBytes(cursorId), params);
    ...
    public Set<byte[]> zRangeByScore(byte[] key, String min, String max) {
        ...
        try {
            return new LinkedHashSet<>(
                    connection
                            .getCluster()
                            .zrangeByScore(key, JedisConverters.toBytes(min), JedisConverters.toBytes(max)));
        } catch (Exception ex) {
            throw convertJedisAccessException(ex);
        }
    }
