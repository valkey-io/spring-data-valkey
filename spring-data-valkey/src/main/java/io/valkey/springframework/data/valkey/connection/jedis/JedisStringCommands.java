...
class JedisStringCommands implements ValkeyStringCommands {
    ...
    public Boolean set(byte[] key, byte[] value) {
        ...
        return connection
                .invoke()
                .from(Jedis::set, PipelineBinaryCommands::set, key, value)
    ...
    public Boolean set(byte[] key, byte[] value, Expiration expiration, SetOption option) {
        ...
        SetParams params =
                JedisConverters.toSetCommandExPxArgument(
                        expiration, JedisConverters.toSetCommandNxXxArgument(option));
    ...
    public byte[] setGet(byte[] key, byte[] value, Expiration expiration, SetOption option) {
        ...
        return connection
                .invoke()
                .just(Jedis::setGet, PipelineBinaryCommands::setGet, key, value, params);
    }
    ...
    public Boolean setNX(byte[] key, byte[] value) {
        ...
        return connection
                .invoke()
                .from(Jedis::setnx, PipelineBinaryCommands::setnx, key, value)
    ...
    public Boolean setEx(byte[] key, long seconds, byte[] value) {
        ...
        return connection
                .invoke()
                .from(Jedis::setex, PipelineBinaryCommands::setex, key, seconds, value)
                .getOrElse(Converters.stringToBooleanConverter(), () -> false);
    }
    ...
    public Boolean pSetEx(byte[] key, long milliseconds, byte[] value) {
        ...
        return connection
                .invoke()
                .from(Jedis::psetex, PipelineBinaryCommands::psetex, key, milliseconds, value)
                .getOrElse(Converters.stringToBooleanConverter(), () -> false);
    }
    ...
    public Boolean mSet(Map<byte[], byte[]> tuples) {
        ...
        return connection
                .invoke()
                .from(Jedis::mset, PipelineBinaryCommands::mset, JedisConverters.toByteArrays(tuples))
                .get(Converters.stringToBooleanConverter());
    }
    ...
    public Double incrBy(byte[] key, double value) {
        ...
        return connection
                .invoke()
                .just(Jedis::incrByFloat, PipelineBinaryCommands::incrByFloat, key, value);
    }
    ...
    public byte[] getRange(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .just(Jedis::getrange, PipelineBinaryCommands::getrange, key, start, end);
    }
    ...
    public void setRange(byte[] key, byte[] value, long offset) {
        ...
        connection
                .invokeStatus()
                .just(Jedis::setrange, PipelineBinaryCommands::setrange, key, offset, value);
    }
    ...
    public Boolean setBit(byte[] key, long offset, boolean value) {
        ...
        return connection
                .invoke()
                .just(Jedis::setbit, PipelineBinaryCommands::setbit, key, offset, value);
    }
    ...
    public Long bitCount(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .just(Jedis::bitcount, PipelineBinaryCommands::bitcount, key, start, end);
    }
    ...
    public List<Long> bitField(byte[] key, BitFieldSubCommands subCommands) {
        ...
        return connection
                ...
                .just(
                        Jedis::bitfield,
                        PipelineBinaryCommands::bitfield,
                        key,
    ...
    public Long bitOp(BitOperation op, byte[] destination, byte[]... keys) {
        ...
        return connection
                ...
                .just(
                        Jedis::bitop,
                        PipelineBinaryCommands::bitop,
                        JedisConverters.toBitOp(op),
                        destination,
                        keys);
    }
    ...
    public Long bitPos(byte[] key, boolean bit, Range<Long> range) {
        ...
        if (range.getLowerBound().isBounded()) {
            ...
            BitPosParams params =
                    range.getUpperBound().isBounded()
                            ? new BitPosParams(
                                    range.getLowerBound().getValue().get(), range.getUpperBound().getValue().get())
                            : new BitPosParams(range.getLowerBound().getValue().get());

            return connection
                    .invoke()
                    .just(Jedis::bitpos, PipelineBinaryCommands::bitpos, key, bit, params);
        }
