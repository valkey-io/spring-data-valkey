 ...
 * ValkeyConnectionFactory} using the provided Master / Replica configuration to nodes know to not
 * change address. Eg. when connecting to <a
 * href="https://aws.amazon.com/documentation/elasticache/">AWS ElastiCache with Read Replicas</a>.
 * <br>
 ...
 * @since 2.1
 */
public class ValkeyStaticMasterReplicaConfiguration
        implements ValkeyConfiguration, StaticMasterReplicaConfiguration {
