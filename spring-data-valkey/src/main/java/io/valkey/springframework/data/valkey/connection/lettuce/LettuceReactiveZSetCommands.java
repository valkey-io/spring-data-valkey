...
class LettuceReactiveZSetCommands implements ReactiveZSetCommands {
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            if (command.isIncr()) {
                                                ...
                                                if (command.getTuples().size() > 1) {
                                                    throw new IllegalArgumentException(
                                                            "ZADD INCR must not contain more than one tuple");
                                                }
                                            ...
                                            ScoredValue<ByteBuffer>[] values =
                                                    (ScoredValue<ByteBuffer>[])
                                                            command.getTuples().stream()
                                                                    .map(
                                                                            tuple ->
                                                                                    ScoredValue.fromNullable(
                                                                                            tuple.getScore(), ByteBuffer.wrap(tuple.getValue())))
                                                                    .toArray(ScoredValue[]::new);

                                            Mono<Long> result =
                                                    args == null
                                                            ? reactiveCommands.zadd(command.getKey(), values)
                                ...
                                .concatMap(
                                        command -> {
                                            ...
                                            return reactiveCommands
                                                    .zincrby(
                                                            command.getKey(),
                                                            command.getIncrement().doubleValue(),
                                                            command.getValue())
                                                    .map(value -> new NumericResponse<>(command, value));
                                        }));
    }
                                ...
                                .map(
                                        command -> {
                                            ...
                                            return new CommandResponse<>(
                                                    command,
                                                    reactiveCommands.zrandmember(command.getKey(), command.getCount()));
                                        }));
    }
                                ...
                                .map(
                                        command -> {
                                            ...
                                            Flux<ScoredValue<ByteBuffer>> result =
                                                    reactiveCommands.zrandmemberWithScores(
                                                            command.getKey(), command.getCount());
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            Mono<Long> result =
                                                    ObjectUtils.nullSafeEquals(command.getDirection(), Direction.ASC)
    ...
    @Override
    public Flux<CommandResponse<ZRangeCommand, Flux<Tuple>>> zRange(
            Publisher<ZRangeCommand> commands) {
                                        ...
                                        command -> {
                                            ...
                                            if (ObjectUtils.nullSafeEquals(command.getDirection(), Direction.ASC)) {
                                                if (command.isWithScores()) {
                                                    result =
                                                            reactiveCommands
                                                                    .zrangeWithScores(command.getKey(), start, stop)
                                                                    .map(this::toTuple);
                                                } else {
                                                    result =
                                                            reactiveCommands
    ...
    @Override
    @SuppressWarnings("unchecked")
    public Flux<CommandResponse<ZRangeStoreCommand, Mono<Long>>> zRangeStore(
                                        ...
                                        command -> {
                                            ...
                                            if (command.getDirection() == Direction.ASC) {
                                                ...
                                                switch (command.getRangeMode()) {
                                                    case ByScore ->
                                                            result =
                                                                    reactiveCommands.zrangestorebyscore(
                                                                            command.getDestKey(),
                                                                            command.getKey(),
                                                                            (Range<? extends Number>)
                                                                                    LettuceConverters.toRange(command.getRange()),
                                                                            limit);
                                                    case ByLex ->
                                                            result =
                                                                    reactiveCommands.zrangestorebylex(
                                                                            command.getDestKey(),
                                                                            command.getKey(),
                                                                            RangeConverter.toRange(command.getRange()),
                                                                            limit);
                                                    default ->
                                                            throw new IllegalStateException(
                                                                    "Unsupported value: " + command.getRangeMode());
                                                }
                                            } else {
                                                switch (command.getRangeMode()) {
                                                    case ByScore ->
                                                            result =
                                                                    reactiveCommands.zrevrangestorebyscore(
                                                                            command.getDestKey(),
                                                                            command.getKey(),
                                                                            (Range<? extends Number>)
                                                                                    LettuceConverters.toRange(command.getRange()),
                                                    ...
                                                    case ByLex ->
                                                            result =
                                                                    reactiveCommands.zrevrangestorebylex(
                                                                            command.getDestKey(),
                                                                            command.getKey(),
                                                                            RangeConverter.toRange(command.getRange()),
                                                                            limit);
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            boolean isLimited =
                                                    command.getLimit().isPresent() && !command.getLimit().get().isUnlimited();
                                            ...
                                            if (ObjectUtils.nullSafeEquals(command.getDirection(), Direction.ASC)) {
                                                ...
                                                if (command.isWithScores()) {
                                                    ...
                                                    if (!isLimited) {
                                                        result =
                                                                reactiveCommands
                                                                        .zrangebyscore(command.getKey(), range)
                                                                        .map(value -> toTuple(value, Double.NaN));
                                                    } else {
                                                ...
                                                if (command.isWithScores()) {
                                                    ...
                                                    if (!isLimited) {
                                                        result =
                                                                reactiveCommands
                                                                        .zrevrangebyscore(command.getKey(), range)
                                                                        .map(value -> toTuple(value, Double.NaN));
                                                    } else {
                                                        result =
                                                                reactiveCommands
    ...
    @Override
    public Flux<NumericResponse<ZLexCountCommand, Long>> zLexCount(
            Publisher<ZLexCountCommand> commands) {
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            Mono<Long> result =
                                                    reactiveCommands.zlexcount(
                                                            command.getKey(), RangeConverter.toRange(command.getRange()));
                                ...
                                .map(
                                        command -> {
                                            ...
                                            if (command.getCount() > 1) {
                                                result =
                                                        command.getDirection() == PopDirection.MIN
                                                ...
                                                result =
                                                        (command.getDirection() == PopDirection.MIN
                                                                        ...
                                                                        : reactiveCommands.zpopmax(command.getKey()))
                                                                .flux();
                                            }

                                            return new CommandResponse<>(
                                                    command, result.filter(Value::hasValue).map(this::toTuple));
                                        }));
    }
                                ...
                                .map(
                                        command -> {
                                            ...
                                            if (command.getTimeUnit() == TimeUnit.MILLISECONDS) {
                                                ...
                                                double timeout =
                                                        TimeoutUtils.toDoubleSeconds(
                                                                command.getTimeout(), command.getTimeUnit());

                                                Mono<KeyValue<ByteBuffer, ScoredValue<ByteBuffer>>> commandResult =
                                                        command.getDirection() == PopDirection.MIN
                                                                ? reactiveCommands.bzpopmin(timeout, command.getKey())
                                                                : reactiveCommands.bzpopmax(timeout, command.getKey());

                                                Mono<ScoredValue<ByteBuffer>> result =
                                                        commandResult.filter(Value::hasValue).map(Value::getValue);

                                                return new CommandResponse<>(
                                                        command, result.filter(Value::hasValue).map(this::toTuple).flux());
                                            } else {
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            return reactiveCommands
                                                    .zscore(command.getKey(), command.getValue())
                                                    .map(value -> new NumericResponse<>(command, value));
                                        }));
    }

    @Override
    public Flux<MultiValueResponse<ZMScoreCommand, Double>> zMScore(
            Publisher<ZMScoreCommand> commands) {
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            return reactiveCommands
                                                    .zmscore(command.getKey(), command.getValues().toArray(new ByteBuffer[0]))
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            Mono<Long> result =
                                                    reactiveCommands.zremrangebyrank(
                                                            command.getKey(), //
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            Range<? extends Number> range = RangeConverter.toRange(command.getRange());
                                            Mono<Long> result =
                                                    reactiveCommands.zremrangebyscore(command.getKey(), range);
    ...
    @Override
    public Flux<NumericResponse<ZRemRangeByLexCommand, Long>> zRemRangeByLex(
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            Mono<Long> result =
                                                    reactiveCommands.zremrangebylex(
                                                            command.getKey(), RangeConverter.toRange(command.getRange()));
    ...
    @Override
    public Flux<CommandResponse<ZDiffCommand, Flux<ByteBuffer>>> zDiff(
    ...
    @Override
    public Flux<CommandResponse<ZDiffCommand, Flux<Tuple>>> zDiffWithScores(
            Publisher<? extends ZDiffCommand> commands) {
                        ...
                        Flux.from(commands)
                                .map(
                                        command -> {
                                            ...
                                            return new CommandResponse<>(
                                                    command, reactiveCommands.zdiffWithScores(sourceKeys).map(this::toTuple));
                                        }));
    }

    @Override
    public Flux<NumericResponse<ZDiffStoreCommand, Long>> zDiffStore(
            Publisher<ZDiffStoreCommand> commands) {
                        ...
                        Flux.from(commands)
                                .concatMap(
                                        command -> {
                                            ...
                                            return reactiveCommands
                                                    .zdiffstore(command.getKey(), sourceKeys)
                                                    .map(value -> new NumericResponse<>(command, value));
                                        }));
    }
                                ...
                                .map(
                                        command -> {
                                            ...
                                            if (command.getAggregateFunction().isPresent()
                                                    || !command.getWeights().isEmpty()) {
                                                args =
                                                        zStoreArgs(
                                                                command.getAggregateFunction().isPresent()
                                                                        ? command.getAggregateFunction().get()
                                                                        : null,
                                                                command.getWeights());
                                            }
                                ...
                                .concatMap(
                                        command -> {
                                            ...
                                            if (!command.getLimit().isUnlimited()) {
                                                if (ObjectUtils.nullSafeEquals(command.getDirection(), Direction.ASC)) {
                                                    result =
                                                            reactiveCommands.zrangebylex(
                                                                    command.getKey(),
                                                                    RangeConverter.toRange(command.getRange()),
                                                                    LettuceConverters.toLimit(command.getLimit()));
                                                } else {
                                                    result =
                                                            reactiveCommands.zrevrangebylex(
                                                                    command.getKey(),
                                                                    RangeConverter.toRange(command.getRange()),
                                                                    LettuceConverters.toLimit(command.getLimit()));
                                                }
    ...
    private static ZStoreArgs zStoreArgs(
            @Nullable Aggregate aggregate, @Nullable List<Double> weights) {
    ...
    private Tuple toTuple(ScoredValue<ByteBuffer> scoredValue) {
        return scoredValue
                .map(it -> new DefaultTuple(ByteUtils.getBytes(it), scoredValue.getScore()))
                .getValue();
    }
