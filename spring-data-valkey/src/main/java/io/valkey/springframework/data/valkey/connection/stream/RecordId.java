...
/**
 * The id of a single {@link Record} within a stream. Composed of two parts: {@literal
 * <millisecondsTime>-<sequenceNumber>}.
 *
 * @author Christoph Strobl
 * @since 2.2
 * @see <a href="https://valkey.io/topics/streams-intro#entry-ids">Valkey Documentation - Entriy
 *     ID</a>
 */
public class RecordId {
    ...
    /**
     * Auto-generation of IDs by the server is almost always what you want so we've got this instance
     * here shortcutting computation.
     */
    private static final RecordId AUTOGENERATED =
            new RecordId(GENERATE_ID) {
    ...
    /**
     * Obtain an instance of {@link RecordId} using the provided String formatted as {@literal
     * <millisecondsTime>-<sequenceNumber>}. <br>
     * For server auto generated {@literal entry-id} on insert pass in {@literal null} or {@literal
     * *}. Event better, just use {@link #autoGenerate()}.
     *
    ...
    /**
     * Create a new instance of {@link RecordId} using the provided String formatted as {@literal
     * <millisecondsTime>-<sequenceNumber>}. <br>
    ...
    /**
     * Obtain the {@link RecordId} signalling the server to auto generate an {@literal entry-id} on
     * insert ({@code XADD}).
     *
    ...
    /**
     * Get the {@literal entry-id millisecondsTime} part or {@literal null} if it {@link
    ...
    /**
     * Get the {@literal entry-id sequenceNumber} part or {@literal null} if it {@link
     * #shouldBeAutoGenerated()}.
     *
    ...
    /**
     * @return {@literal true} if a new {@literal entry-id} shall be generated on server side when
     *     calling {@code XADD}.
     */
    public boolean shouldBeAutoGenerated() {
        return false;
    ...
    /**
     * @return get the string representation of the {@literal entry-id} in {@literal
     *     <millisecondsTime>-<sequenceNumber>} format or {@literal *} if it {@link
     *     #shouldBeAutoGenerated()}. Never {@literal null}.
     */
