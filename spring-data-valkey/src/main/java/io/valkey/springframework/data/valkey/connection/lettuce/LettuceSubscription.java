...
public class LettuceSubscription extends AbstractSubscription {
    ...
    /**
     * Creates a new {@link LettuceSubscription} given {@link MessageListener}, {@link
     * StatefulRedisPubSubConnection}, and {@link LettuceConnectionProvider}.
     *
    ...
    protected LettuceSubscription(
        ...
        this.listener =
                new LettuceMessageListener(
                        listener,
                        listener instanceof SubscriptionListener subscriptionListener
