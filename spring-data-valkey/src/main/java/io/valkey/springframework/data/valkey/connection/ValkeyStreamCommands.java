...
public interface ValkeyStreamCommands {
     ...
     * @param recordIds the String representation of the {@literal id's} of the records to
     *     acknowledge.
    ...
    /**
     * Append a new record with the given {@link Map field/value pairs} as content to the stream
     * stored at {@code key}.
     *
     * @param key the {@literal key} the stream is stored at.
     * @param content the records content modeled as {@link Map field/value pairs}.
     * @return the server generated {@link RecordId id}. {@literal null} when used in pipeline /
     *     transaction.
    ...
    /**
     * Append the given {@link MapRecord record} to the stream stored at {@code Record#getStream}. If
     * you prefer manual id assignment over server generated ones make sure to provide an id via
     * {@code Record#withId}.
     *
     * @param record the {@link MapRecord record} to append.
     * @return the {@link RecordId id} after save. {@literal null} when used in pipeline /
     *     transaction.
     */
    @Nullable
     ...
     */
    @Nullable
    default List<ByteRecord> xClaim(
            byte[] key, String group, String newOwner, Duration minIdleTime, RecordId... recordIds) {
    ...
    class XClaimOptions {
        ...
        private XClaimOptions(
                List<RecordId> ids,
                Duration minIdleTime,
                @Nullable Duration idleTime,
                @Nullable Instant unixTime,
                @Nullable Long retryCount,
                boolean force) {
        ...
        /**
         * Set the {@literal min-idle-time} to limit the command to messages that have been idle for at
         * at least the given {@link Duration}.
         *
         * @param minIdleTime must not be {@literal null}.
        ...
        /**
         * Set the {@literal min-idle-time} to limit the command to messages that have been idle for at
         * at least the given {@literal milliseconds}.
         *
         * @param millis
         * @return new instance of {@link XClaimOptions}.
         */
        ...
        /**
         * Sets the idle time to a specific unix time (in milliseconds). To define a relative idle time
         * use {@link #idle(Duration)}.
         *
         ...
         *
         * @param retryCount can be {@literal null}. If {@literal null} no change to the retry counter
         *     will be made.
         * @return new instance of {@link XClaimOptions}.
         */
        ...
        /**
         * Forces creation of a pending message entry in the PEL even if it does not already exist as
         * long a the given stream record id is valid.
         *
         * @return new instance of {@link XClaimOptions}.
         */
    ...
    /**
     * Removes the records with the given id's from the stream. Returns the number of items deleted,
     ...
     * @return pending messages for the given {@link Consumer} or {@literal null} when used in
     ...
     * @param range the range of messages ids to search within. Must not be {@literal null}.
     * @param count limit the number of results. Must not be {@literal null}.
     * @return pending messages for the given {@literal consumer} in given {@literal consumer group}
     *     or {@literal null} when used in pipeline / transaction.
     * @see <a href="https://valkey.io/commands/xpending">Valkey Documentation: xpending</a>
     * @since 2.3
     */
    @Nullable
    default PendingMessages xPending(
            byte[] key, String groupName, String consumerName, Range<?> range, Long count) {
    ...
    /**
     * Retrieve all {@link ByteRecord records} within a specific {@link Range} from the stream stored
     * at {@literal key}. <br>
    ...
    /**
     * Retrieve a {@link Limit limited number} of {@link ByteRecord records} within a specific {@link
     * Range} from the stream stored at {@literal key}. <br>
