...
/**
 * Valkey client configuration for lettuce. This configuration provides optional configuration
 * elements such as {@link ClientResources} and {@link ClientOptions} specific to Lettuce client
 * features.
 *
 ...
 *   <li>Whether to verify peers using SSL
 *   <li>Whether to use StartTLS
 *   <li>Optional {@link ClientResources}
 *   <li>Optional {@link ClientOptions}, defaults to {@link ClientOptions} with enabled {@link
 *       TimeoutOptions}.
 *   <li>Optional client name
 *   <li>Optional {@link ReadFrom}. Enables Master/Replica operations if configured.
 *   <li>Client {@link Duration timeout}
 *   <li>Shutdown {@link Duration timeout}
 *   <li>Shutdown quiet {@link Duration period}
 * </ul>
 *
 * @author Mark Paluch
...
public interface LettuceClientConfiguration {
    ...
    /**
     * @return {@literal true} to use Start TLS ({@code true} if the first write request shouldn't be
     *     encrypted).
     */
    boolean isStartTls();
    ...
    /**
     * Creates a new {@link LettuceClientConfigurationBuilder} to build {@link
     * LettuceClientConfiguration} to be used with the Lettuce client.
     *
     * @return a new {@link LettuceClientConfigurationBuilder} to build {@link
    ...
    class LettuceClientConfigurationBuilder {
        ...
        /**
         * Configure a {@link ValkeyCredentialsProviderFactory} to obtain {@link
         * io.lettuce.core.RedisCredentialsProvider} instances to support credential rotation.
         *
        ...
        public LettuceClientConfigurationBuilder valkeyCredentialsProviderFactory(
            ...
            Assert.notNull(
                    valkeyCredentialsProviderFactory, "ValkeyCredentialsProviderFactory must not be null");
        ...
        /**
         * Build the {@link LettuceClientConfiguration} with the configuration applied from this
         * builder.
         *
        ...
        public LettuceClientConfiguration build() {
            ...
            return new DefaultLettuceClientConfiguration(
                    ...
                    clientName,
                    readFrom,
                    valkeyCredentialsProviderFactory,
                    timeout,
                    shutdownTimeout,
                    shutdownQuietPeriod);
        }
