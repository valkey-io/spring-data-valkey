...
public abstract class KeyspaceEventMessageListener
     ...
     * @since 1.8
     */
    public void setKeyspaceNotificationsConfigParameter(
    ...
    /**
     * Initialize the message listener by writing requried valkey config for {@literal
     * notify-keyspace-events} and registering the listener within the container.
     */
    public void init() {
