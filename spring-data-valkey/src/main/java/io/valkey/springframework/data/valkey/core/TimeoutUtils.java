...
public abstract class TimeoutUtils {
    ...
    /**
     * Check if a given Duration can be represented in {@code sec} or requires {@code msec}
     * representation.
     *
     ...
     *
     * <p>Since a 0 timeout blocks some Valkey ops indefinitely, this method will return 1 if the
     * original value is greater than 0 but is truncated to 0 on conversion.
     *
