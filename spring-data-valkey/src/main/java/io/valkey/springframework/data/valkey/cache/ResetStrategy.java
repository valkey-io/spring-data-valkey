...
public interface ResetStrategy {
	...
	/**
	 * Default reset strategy iterating through each registered {@link ValkeyCache} and calling {@link ValkeyCache#clear()}.
	...
	/**
	 * Reset strategy iterating through each registered {@link ValkeyCache} and calling {@link ValkeyCache#invalidate()}.
	...
	/**
	 * Flush the Valkey database using the {@code FLUSHDB} command. This is the fastest way to reset all caches, but it
