...
public interface ReactiveSetOperations<K, V> {
    ...
    /**
     * Use a {@link Flux} to iterate over entries in the set at {@code key}. The resulting {@link
    ...
    /**
     * Use a {@link Flux} to iterate over entries in the set at {@code key} given {@link ScanOptions}.
     ...
     * @return the {@link Flux} emitting the {@literal values} one by one or an {@link Flux#empty()
     *     empty Flux} if the key does not exist.
