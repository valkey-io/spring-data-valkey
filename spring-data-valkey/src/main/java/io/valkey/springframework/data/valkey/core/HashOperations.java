...
public interface HashOperations<H, HK, HV> {
    ...
    /**
     * Returns the length of the value associated with {@code hashKey}. If either the {@code key} or
     * the {@code hashKey} do not exist, {@code 0} is returned.
     *
     * @param key must not be {@literal null}.
     * @param hashKey must not be {@literal null}.
     * @return {@literal null} when used in pipeline / transaction.
     ...
     * @param hashKeys must not be {@literal null}.
     * @return the actual expirations for the hash fields. {@literal null} when used in pipeline /
     *     transaction.
     * @see <a href="https://valkey.io/docs/latest/commands/httl/">Valkey Documentation: HTTL</a>
     * @since 3.5
     */
     ...
     * hash fields at {@code key}. Operations on the expiration object obtain keys at the time of
     * invoking any expiration operation.
     *
     * @param key must not be {@literal null}.
    ...
    /**
     * Returns a bound operations object to perform operations on the hash field expiration for all
     * hash fields at {@code key} for the given hash fields.
     *
