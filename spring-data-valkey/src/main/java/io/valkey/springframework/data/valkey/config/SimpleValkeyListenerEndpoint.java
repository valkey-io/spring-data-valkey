...
/**
 * A {@link ValkeyListenerEndpoint} simply providing the {@link MessageListener} to invoke to process an incoming message
 * for this endpoint.
 *
 * @author Mark Paluch
 * @since 4.1
 */
public class SimpleValkeyListenerEndpoint extends AbstractValkeyListenerEndpoint {

	private @Nullable MessageListener messageListener;

	public SimpleValkeyListenerEndpoint() {}

	public SimpleValkeyListenerEndpoint(MessageListener messageListener) {
