...
/**
 * Represents a data type returned from Valkey, currently used to denote the expected return type of
 * Valkey scripting commands
 *
...
public enum ReturnType {
    ...
    public static ReturnType fromJavaType(@Nullable Class<?> javaType) {
        ...
        if (ClassUtils.isAssignable(Double.class, javaType)
                || ClassUtils.isAssignable(Float.class, javaType)) {
