...
public class ValkeyKeyValueTemplate extends KeyValueTemplate {
     ...
     */
    public ValkeyKeyValueTemplate(
            ValkeyKeyValueAdapter adapter, ValkeyMappingContext mappingContext) {
     ...
     * <br>
     * The callback provides either a single {@literal id} or an {@link Iterable} of {@literal id}s,
     * used for retrieving the actual domain types and shortcuts manual retrieval and conversion of
     * {@literal id}s via {@link ValkeyTemplate}.
     *
     * <pre>
     * <code>
    ...
    public <T> List<T> find(ValkeyCallback<?> callback, Class<T> type) {
        ...
        return execute(
                new ValkeyKeyValueCallback<List<T>>() {
                    ...
                    public List<T> doInValkey(ValkeyKeyValueAdapter adapter) {
                        ...
                        Iterable<?> ids =
                                ClassUtils.isAssignable(Iterable.class, callbackResult.getClass())
                        ...
                        for (Object id : ids) {
                            ...
                            String idToUse =
                                    adapter
                                                    ...
                                                    .canConvert(id.getClass(), String.class)
    ...
    public <T> T insert(Object id, T objectToInsert) {
        ...
        if (!(objectToInsert instanceof ValkeyData)) {
            ...
            ValkeyPersistentEntity<?> entity =
                    converter.getMappingContext().getRequiredPersistentEntity(objectToInsert.getClass());
    ...
    protected void doPartialUpdate(final PartialUpdate<?> update) {
        ...
        execute(
                new ValkeyKeyValueCallback<Void>() {
     ...
     * @since 1.7
     */
    public abstract static class ValkeyKeyValueCallback<T> implements KeyValueCallback<T> {
