...
/**
 * {@link KeyspaceConfiguration} allows programmatic setup of keyspaces and time to live options for
 * certain types. This is suitable for cases where there is no option to use the equivalent {@link
 * ValkeyHash} or {@link TimeToLive} annotations.
 *
