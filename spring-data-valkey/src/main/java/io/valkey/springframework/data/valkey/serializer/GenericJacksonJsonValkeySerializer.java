...
/**
 * Generic Jackson 3-based {@link ValkeySerializer} that maps {@link Object objects} to and from {@literal JSON}.
 * <p>
 ...
 * @since 4.0
 */
public class GenericJacksonJsonValkeySerializer implements ValkeySerializer<Object> {
	...
	/**
	 * Create a {@link GenericJacksonJsonValkeySerializer} with a custom-configured {@link ObjectMapper}.
	 *
	 * @param mapper must not be {@literal null}.
	 */
	public GenericJacksonJsonValkeySerializer(ObjectMapper mapper) {
		this(mapper, JacksonObjectReader.create(), JacksonObjectWriter.create());
	}

	/**
	 * Create a {@link GenericJacksonJsonValkeySerializer} with a custom-configured {@link ObjectMapper} considering
	 ...
	 */
	protected GenericJacksonJsonValkeySerializer(ObjectMapper mapper, JacksonObjectReader reader,
	...
	/**
	 * Prepare a new {@link GenericJacksonJsonValkeySerializer} instance.
	 *
	 * @param configurer the configurer for {@link GenericJacksonJsonValkeySerializerBuilder}.
	 * @return new instance of {@link GenericJacksonJsonValkeySerializer}.
	 */
	public static GenericJacksonJsonValkeySerializer create(
			Consumer<GenericJacksonJsonValkeySerializerBuilder<JsonMapper.Builder>> configurer) {

		Assert.notNull(configurer, "Builder configurer must not be null");

		GenericJacksonJsonValkeySerializerBuilder<JsonMapper.Builder> builder = builder();
		configurer.accept(builder);
		return builder.build();
	}

	/**
	 * Creates a new {@link GenericJacksonJsonValkeySerializerBuilder} to configure and build a
	 * {@link GenericJacksonJsonValkeySerializer} using {@link JsonMapper}.
	 *
	 * @return a new {@link GenericJacksonJsonValkeySerializerBuilder}.
	 */
	public static GenericJacksonJsonValkeySerializerBuilder<JsonMapper.Builder> builder() {
		return builder(JsonMapper::builder);
	}

	/**
	 * Creates a new {@link GenericJacksonJsonValkeySerializerBuilder} to configure and build a
	 * {@link GenericJacksonJsonValkeySerializer}.
	 *
	 ...
	 * @return a new {@link GenericJacksonJsonValkeySerializerBuilder}.
	 */
	public static <B extends MapperBuilder<? extends ObjectMapper, ? extends MapperBuilder<?, ?>>> GenericJacksonJsonValkeySerializerBuilder<B> builder(
			Supplier<B> builderFactory) {

		Assert.notNull(builderFactory, "MapperBuilder Factory must not be null");

		return new GenericJacksonJsonValkeySerializerBuilder<>(builderFactory);
	}
	...
	/**
	 * {@link GenericJacksonJsonValkeySerializerBuilder} wraps around a {@link JsonMapper.Builder} providing dedicated
	 * methods to configure aspects like {@link NullValue} serialization strategy for the resulting {@link ObjectMapper}
	 * to be used with {@link GenericJacksonJsonValkeySerializer} as well as potential Object/{@link JacksonObjectReader
	 * -reader} and {@link JacksonObjectWriter -writer} settings.
	 *
	 * @param <B> type of the {@link MapperBuilder}.
	 */
	public static class GenericJacksonJsonValkeySerializerBuilder<B extends MapperBuilder<? extends ObjectMapper, ? extends MapperBuilder<?, ?>>> {
		...
		private GenericJacksonJsonValkeySerializerBuilder(Supplier<B> builderFactory) {
		 ...
		 */
		@Contract("-> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> enableSpringCacheNullValueSupport() {
		 ...
		 */
		@Contract("_ -> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> enableSpringCacheNullValueSupport(String typePropertyName) {
		 ...
		 */
		@Contract("-> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> enableUnsafeDefaultTyping() {
		 ...
		 */
		@Contract("_ -> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> enableDefaultTyping(PolymorphicTypeValidator typeValidator) {
		 ...
		 */
		@Contract("_ -> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> typeValidator(PolymorphicTypeValidator typeValidator) {
		 ...
		 */
		@Contract("_ -> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> typePropertyName(String typePropertyName) {
		 ...
		 */
		@Contract("_ -> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> writer(JacksonObjectWriter writer) {
		 ...
		 */
		@Contract("_ -> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> reader(JacksonObjectReader reader) {
		 ...
		 */
		@Contract("_ -> this")
		public GenericJacksonJsonValkeySerializerBuilder<B> customize(Consumer<B> mapperBuilderCustomizer) {
		...
		/**
		 * Build a new {@link GenericJacksonJsonValkeySerializer} instance using the configured settings.
		 *
		 * @return a new {@link GenericJacksonJsonValkeySerializer} instance.
		 */
		@Contract("-> new")
		public GenericJacksonJsonValkeySerializer build() {
			...
			if (cacheNullValueSupportEnabled) {
				...
				mapperBuilder.addModules(new GenericJacksonValkeySerializerModule(() -> {
			...
			if (defaultTyping) {
				...
				GenericJacksonJsonValkeySerializer.TypeResolverBuilder resolver = new GenericJacksonJsonValkeySerializer.TypeResolverBuilder(
			...
			return new GenericJacksonJsonValkeySerializer(mapperBuilder.build(), reader, writer);
		}
	...
	private static class GenericJacksonValkeySerializerModule extends JacksonModule {

		private final Supplier<String> classIdentifier;

		GenericJacksonValkeySerializerModule(Supplier<String> classIdentifier) {
			this.classIdentifier = classIdentifier;
		}

		@Override
		public String getModuleName() {
			return "spring-data-valkey-generic-serializer-module";
		}

		@Override
		public Version version() {
			return new Version(4, 0, 0, null, "org.springframework.data", "spring-data-valkey");
		}
