...
public class StreamInfo {
    ...
    public static class XInfoGroups implements Streamable<XInfoGroup> {
        ...
        /**
         * Performs the given {@literal action} on every available {@link XInfoGroup} of this {@link
         * XInfoGroups}.
         *
         * @param action
         */
    ...
    public static class XInfoGroup extends XInfoObject {
        ...
        /**
         * The total number of consumers in the {@literal consumer group}. Corresponds to {@literal
         * consumers}.
         *
         * @return
         */
        ...
        /**
         * The total number of pending messages in the {@literal consumer group}. Corresponds to
         * {@literal pending}.
         *
         * @return
         */
    ...
    public static class XInfoConsumers implements Streamable<XInfoConsumer> {
        ...
        /**
         * Performs the given {@literal action} on every available {@link XInfoConsumer} of this {@link
         * XInfoConsumers}.
         *
         * @param action
         */
