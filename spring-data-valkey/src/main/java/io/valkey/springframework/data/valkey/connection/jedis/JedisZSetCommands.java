...
class JedisZSetCommands implements ValkeyZSetCommands {
	...
	private Long zRangeStoreByLex(byte @NonNull [] dstKey, byte @NonNull [] srcKey,
			org.springframework.data.domain.@NonNull Range<byte[]> range,
			io.valkey.springframework.data.valkey.connection.@NonNull Limit limit, boolean rev) {
	...
	static ZRangeParams toZRangeParams(Protocol.Keyword by, byte[] min, byte[] max,
			io.valkey.springframework.data.valkey.connection.Limit limit, boolean rev) {
