...
class JedisZSetCommands implements ValkeyZSetCommands {
    ...
    public Double zIncrBy(byte[] key, double increment, byte[] value) {
        ...
        return connection
                .invoke()
                .just(Jedis::zincrby, PipelineBinaryCommands::zincrby, key, increment, value);
    }
    ...
    public List<byte[]> zRandMember(byte[] key, long count) {
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zrandmember, PipelineBinaryCommands::zrandmember, key, count)
                .toList();
    }
    ...
    public Tuple zRandMemberWithScore(byte[] key) {
        ...
        return connection
                .invoke()
                .from(Jedis::zrandmemberWithScores, PipelineBinaryCommands::zrandmemberWithScores, key, 1L)
                .get(
                        it -> {
                            if (it.isEmpty()) {
                                return null;
    ...
    public List<Tuple> zRandMemberWithScore(byte[] key, long count) {
        ...
        return connection
                .invoke()
                .fromMany(
                        Jedis::zrandmemberWithScores, PipelineBinaryCommands::zrandmemberWithScores, key, count)
    ...
    public Set<byte[]> zRange(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zrange, PipelineBinaryCommands::zrange, key, start, end)
                .toSet();
    }
    ...
    public Set<Tuple> zRangeWithScores(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .fromMany(
                        Jedis::zrangeWithScores, PipelineBinaryCommands::zrangeWithScores, key, start, end)
    ...
    public Set<Tuple> zRangeByScoreWithScores(
        ...
        byte[] min =
                JedisConverters.boundaryToBytesForZRange(
                        range.getLowerBound(), JedisConverters.NEGATIVE_INFINITY_BYTES);
        byte[] max =
                JedisConverters.boundaryToBytesForZRange(
                        range.getUpperBound(), JedisConverters.POSITIVE_INFINITY_BYTES);
        ...
        if (!limit.isUnlimited()) {
            return connection
                    ...
                    .fromMany(
                            ...
                            PipelineBinaryCommands::zrangeByScoreWithScores,
                            key,
                            min,
                            max,
                            limit.getOffset(),
    ...
    public Set<byte[]> zRevRange(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zrevrange, PipelineBinaryCommands::zrevrange, key, start, end)
                .toSet();
    }
    ...
    public Set<Tuple> zRevRangeWithScores(byte[] key, long start, long end) {
        ...
        return connection
                ...
                .fromMany(
                        ...
                        PipelineBinaryCommands::zrevrangeWithScores,
                        key,
                        start,
                        end)
                .toSet(JedisConverters::toTuple);
    ...
    public Set<byte[]> zRevRangeByScore(
        ...
        if (!limit.isUnlimited()) {
            return connection
                    ...
                    .fromMany(
                            ...
                            PipelineBinaryCommands::zrevrangeByScore,
                            key,
                            max,
                            min,
                            limit.getOffset(),
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zrevrangeByScore, PipelineBinaryCommands::zrevrangeByScore, key, max, min)
                .toSet();
    }
        ...
        if (!limit.isUnlimited()) {
            return connection
                    ...
                    .fromMany(
                            ...
                            PipelineBinaryCommands::zrevrangeByScoreWithScores,
                            key,
                            max,
                            min,
                            limit.getOffset(),
    ...
    public Long zLexCount(byte[] key, org.springframework.data.domain.Range<byte[]> range) {
        ...
        byte[] min =
                JedisConverters.boundaryToBytesForZRangeByLex(
                        range.getLowerBound(), JedisConverters.MINUS_BYTES);
        byte[] max =
                JedisConverters.boundaryToBytesForZRangeByLex(
                        range.getUpperBound(), JedisConverters.PLUS_BYTES);

        return connection
                .invoke()
                .just(Jedis::zlexcount, PipelineBinaryCommands::zlexcount, key, min, max);
    }
    ...
    public Tuple zPopMin(byte[] key) {
        ...
        return connection
                .invoke()
                .from(Jedis::zpopmin, PipelineBinaryCommands::zpopmin, key)
    ...
    public Tuple bZPopMin(byte[] key, long timeout, TimeUnit unit) {
        ...
        return connection
                ...
                .from(
                        Jedis::bzpopmin,
                        PipelineBinaryCommands::bzpopmin,
                        JedisConverters.toSeconds(timeout, unit),
                        key)
    ...
    public Tuple zPopMax(byte[] key) {
        ...
        return connection
                .invoke()
                .from(Jedis::zpopmax, PipelineBinaryCommands::zpopmax, key)
                .get(JedisConverters::toTuple);
    }
    ...
    public Tuple bZPopMax(byte[] key, long timeout, TimeUnit unit) {
        ...
        return connection
                ...
                .from(
                        Jedis::bzpopmax,
                        PipelineBinaryCommands::bzpopmax,
                        JedisConverters.toSeconds(timeout, unit),
                        key)
                .get(JedisZSetCommands::toTuple);
    }
    ...
    public Long zRemRange(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .just(Jedis::zremrangeByRank, PipelineBinaryCommands::zremrangeByRank, key, start, end);
    }
    ...
    public Long zRemRangeByLex(byte[] key, org.springframework.data.domain.Range<byte[]> range) {
        ...
        return connection
                .invoke()
                .just(Jedis::zremrangeByLex, PipelineBinaryCommands::zremrangeByLex, key, min, max);
    }
    ...
    public Long zRemRangeByScore(
        ...
        return connection
                .invoke()
                .just(Jedis::zremrangeByScore, PipelineBinaryCommands::zremrangeByScore, key, min, max);
    }
    ...
    public Set<Tuple> zDiffWithScores(byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zdiffWithScores, PipelineBinaryCommands::zdiffWithScores, sets)
                .toSet(JedisConverters::toTuple);
    }
    ...
    public Long zDiffStore(byte[] destKey, byte[]... sets) {
        ...
        return connection
                .invoke()
                .just(Jedis::zdiffStore, PipelineBinaryCommands::zdiffStore, destKey, sets);
    }
    ...
    public Set<byte[]> zInter(byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zinter, PipelineBinaryCommands::zinter, new ZParams(), sets)
                .toSet();
    }
    ...
    public Set<Tuple> zInterWithScores(byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(
                        Jedis::zinterWithScores, PipelineBinaryCommands::zinterWithScores, new ZParams(), sets)
                .toSet(JedisConverters::toTuple);
    }
    ...
    public Set<Tuple> zInterWithScores(Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        Assert.isTrue(
                ...
                "The number of weights (%d) must match the number of source sets (%d)"
                        .formatted(weights.size(), sets.length));

        return connection
                .invoke()
                .fromMany(
                        Jedis::zinterWithScores,
                        PipelineBinaryCommands::zinterWithScores,
                        toZParams(aggregate, weights),
                        sets)
                .toSet(JedisConverters::toTuple);
    }
    ...
    public Long zInterStore(byte[] destKey, Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        return connection
                .invoke()
                .just(Jedis::zinterstore, PipelineBinaryCommands::zinterstore, destKey, zparams, sets);
    }
    ...
    public Long zInterStore(byte[] destKey, byte[]... sets) {
        ...
        return connection
                .invoke()
                .just(Jedis::zinterstore, PipelineBinaryCommands::zinterstore, destKey, sets);
    }
    ...
    public Set<byte[]> zUnion(byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zunion, PipelineBinaryCommands::zunion, new ZParams(), sets)
                .toSet();
    }
    ...
    public Set<Tuple> zUnionWithScores(byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(
                        Jedis::zunionWithScores, PipelineBinaryCommands::zunionWithScores, new ZParams(), sets)
                .toSet(JedisConverters::toTuple);
    }
    ...
    public Set<Tuple> zUnionWithScores(Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(
                        Jedis::zunionWithScores,
                        PipelineBinaryCommands::zunionWithScores,
                        toZParams(aggregate, weights),
                        sets)
                .toSet(JedisConverters::toTuple);
    }
    ...
    public Long zUnionStore(byte[] destKey, Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        return connection
                .invoke()
                .just(Jedis::zunionstore, PipelineBinaryCommands::zunionstore, destKey, zparams, sets);
    }
    ...
    public Long zUnionStore(byte[] destKey, byte[]... sets) {
        ...
        return connection
                .invoke()
                .just(Jedis::zunionstore, PipelineBinaryCommands::zunionstore, destKey, sets);
    }
        ...
        return new KeyBoundCursor<Tuple>(key, cursorId, options) {
            ...
            protected ScanIteration<Tuple> doScan(byte[] key, CursorId cursorId, ScanOptions options) {
                ...
                ScanResult<redis.clients.jedis.resps.Tuple> result =
                        connection.getJedis().zscan(key, JedisConverters.toBytes(cursorId), params);
                return new ScanIteration<>(
                        CursorId.of(result.getCursor()),
    ...
    public Set<byte[]> zRangeByScore(byte[] key, String min, String max) {
        ...
        return connection
                ...
                .fromMany(
                        Jedis::zrangeByScore,
                        PipelineBinaryCommands::zrangeByScore,
                        key,
                        JedisConverters.toBytes(min),
                        JedisConverters.toBytes(max))
                .toSet();
    }
    ...
    public Set<byte[]> zRangeByScore(
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zrangeByScore, PipelineBinaryCommands::zrangeByScore, key, min, max)
                .toSet();
    }
    ...
    public Set<byte[]> zRangeByLex(
        ...
        if (!limit.isUnlimited()) {
            return connection
                    ...
                    .fromMany(
                            Jedis::zrangeByLex,
                            PipelineBinaryCommands::zrangeByLex,
                            key,
                            min,
                            max,
                            limit.getOffset(),
        ...
        return connection
                .invoke()
                .fromMany(Jedis::zrangeByLex, PipelineBinaryCommands::zrangeByLex, key, min, max)
                .toSet();
    }
    ...
    public Set<byte[]> zRevRangeByLex(
        ...
        if (!limit.isUnlimited()) {
            return connection
                    ...
                    .from(
                            ...
                            PipelineBinaryCommands::zrevrangeByLex,
                            key,
                            max,
                            min,
                            limit.getOffset(),
        ...
        return connection
                .invoke()
                .from(Jedis::zrevrangeByLex, PipelineBinaryCommands::zrevrangeByLex, key, max, min)
                .get(LinkedHashSet::new);
    }
    ...
    private Long zRangeStoreByLex(
        ...
        return connection
                .invoke()
                .just(
                        Jedis::zrangestore, PipelineBinaryCommands::zrangestore, dstKey, srcKey, zRangeParams);
    }
    ...
    private Long zRangeStoreByScore(
            byte[] dstKey,
            byte[] srcKey,
            org.springframework.data.domain.Range<? extends Number> range,
            io.valkey.springframework.data.valkey.connection.Limit limit,
    ...
    static ZRangeParams toZRangeParams(
            Protocol.Keyword by,
            byte[] min,
            byte[] max,
            io.valkey.springframework.data.valkey.connection.Limit limit,
