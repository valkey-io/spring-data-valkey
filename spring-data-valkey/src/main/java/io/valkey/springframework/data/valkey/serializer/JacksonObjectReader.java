...
/**
 * Defines the contract for Object Mapping readers. Implementations of this interface can
 * deserialize a given byte array holding JSON to an Object considering the target type.
 *
 * <p>Reader functions can customize how the actual JSON is being deserialized by e.g. obtaining a
 * customized {@link com.fasterxml.jackson.databind.ObjectReader} applying serialization features,
...
public interface JacksonObjectReader {
    ...
    /**
     * Read an object graph from the given root JSON into a Java object considering the {@link
     * JavaType}.
     *
    ...
    /**
     * Create a default {@link JacksonObjectReader} delegating to {@link
