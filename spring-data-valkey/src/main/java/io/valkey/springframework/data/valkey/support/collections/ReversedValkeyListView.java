...
/**
 * Implementation and view of an existing {@link ValkeyList} where the elements in the list (deque)
            ...
            if (position < 0 || position > size) {
                throw new IndexOutOfBoundsException(
                        ("Position [%d] is out of bounds;"
                                        + " position must be greater than equal to 0 and less than size %d")
