...
class LettuceZSetCommands implements ValkeyZSetCommands {
    ...
    public Tuple zRandMemberWithScore(byte[] key) {
        ...
        return connection
                .invoke()
                .from(RedisSortedSetAsyncCommands::zrandmemberWithScores, key)
    ...
    public List<Tuple> zRandMemberWithScore(byte[] key, long count) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zrandmemberWithScores, key, count)
    ...
    public Set<byte[]> zRange(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zrange, key, start, end)
                .toSet();
    }
    ...
    public Set<Tuple> zRangeWithScores(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zrangeWithScores, key, start, end)
    ...
    public Set<byte[]> zRevRange(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zrevrange, key, start, end)
    ...
    public Set<Tuple> zRevRangeWithScores(byte[] key, long start, long end) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zrevrangeWithScores, key, start, end)
                .toSet(LettuceConverters::toTuple);
    }
    ...
    public Set<byte[]> zRevRangeByScore(
        ...
        if (limit.isUnlimited()) {
            ...
            return connection
                    .invoke()
                    .fromMany(
                            RedisSortedSetAsyncCommands::zrevrangebyscore, key, LettuceConverters.toRange(range))
                    .toSet();
        }
    ...
    public Long zCount(byte[] key, org.springframework.data.domain.Range<? extends Number> range) {
        ...
        return connection
                .invoke()
                .just(RedisSortedSetAsyncCommands::zcount, key, LettuceConverters.toRange(range));
    }
    ...
    public Long zLexCount(byte[] key, org.springframework.data.domain.Range<byte[]> range) {
        ...
        return connection
                .invoke()
                .just(RedisSortedSetAsyncCommands::zlexcount, key, LettuceConverters.toRange(range, true));
    }
    ...
    public Tuple zPopMin(byte[] key) {
        ...
        return connection
                .invoke()
                .from(RedisSortedSetAsyncCommands::zpopmin, key)
                .get(LettuceConverters::toTuple);
    }
    ...
    public Set<Tuple> zPopMin(byte[] key, long count) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zpopmin, key, count)
                .toSet(LettuceConverters::toTuple);
    }
    ...
    public Tuple bZPopMin(byte[] key, long timeout, TimeUnit unit) {
        ...
        if (TimeUnit.MILLISECONDS == unit) {
            ...
            return connection
                    .invoke(connection.getAsyncDedicatedConnection())
                    .from(
                            RedisSortedSetAsyncCommands::bzpopmin,
                            TimeoutUtils.toDoubleSeconds(timeout, unit),
                            key)
    ...
    public Tuple zPopMax(byte[] key) {
        ...
        return connection
                .invoke()
                .from(RedisSortedSetAsyncCommands::zpopmax, key)
                .get(LettuceConverters::toTuple);
    }
    ...
    public Set<Tuple> zPopMax(byte[] key, long count) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zpopmax, key, count)
                .toSet(LettuceConverters::toTuple);
    }
    ...
    public Tuple bZPopMax(byte[] key, long timeout, TimeUnit unit) {
        ...
        if (TimeUnit.MILLISECONDS == unit) {
            ...
            return connection
                    .invoke(connection.getAsyncDedicatedConnection())
                    .from(
                            RedisSortedSetAsyncCommands::bzpopmax,
                            TimeoutUtils.toDoubleSeconds(timeout, unit),
                            key)
                    .get(it -> it.map(LettuceConverters::toTuple).getValueOrElse(null));
        }
    ...
    public Long zRemRangeByScore(
        ...
        return connection
                .invoke()
                .just(RedisSortedSetAsyncCommands::zremrangebyscore, key, LettuceConverters.toRange(range));
    }
    ...
    public Set<Tuple> zDiffWithScores(byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zdiffWithScores, sets)
                .toSet(LettuceConverters::toTuple);
    }
    ...
    public Set<Tuple> zInterWithScores(byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zinterWithScores, sets)
                .toSet(LettuceConverters::toTuple);
    }
    ...
    public Set<Tuple> zInterWithScores(Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zinterWithScores, zAggregateArgs, sets)
                .toSet(LettuceConverters::toTuple);
    }
    ...
    public Long zInterStore(byte[] destKey, Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        return connection
                .invoke()
                .just(RedisSortedSetAsyncCommands::zinterstore, destKey, storeArgs, sets);
    }
    ...
    public Set<Tuple> zUnionWithScores(byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zunionWithScores, sets)
                .toSet(LettuceConverters::toTuple);
    }
    ...
    public Set<Tuple> zUnionWithScores(Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zunionWithScores, zAggregateArgs, sets)
                .toSet(LettuceConverters::toTuple);
    }
    ...
    public Long zUnionStore(byte[] destKey, Aggregate aggregate, Weights weights, byte[]... sets) {
        ...
        return connection
                .invoke()
                .just(RedisSortedSetAsyncCommands::zunionstore, destKey, storeArgs, sets);
    }
        ...
        return new KeyBoundCursor<Tuple>(key, cursorId, options) {
            ...
            protected ScanIteration<Tuple> doScan(byte[] key, CursorId cursorId, ScanOptions options) {
                ...
                ScoredValueScanCursor<byte[]> scoredValueScanCursor =
                        connection.invoke().just(RedisSortedSetAsyncCommands::zscan, key, scanCursor, scanArgs);
                String nextCursorId = scoredValueScanCursor.getCursor();

                List<ScoredValue<byte[]>> result = scoredValueScanCursor.getValues();

                List<Tuple> values =
                        connection.failsafeReadScanValues(result, LettuceConverters.scoredValuesToTupleList());
    ...
    public Set<byte[]> zRangeByScore(byte[] key, String min, String max) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zrangebyscore, key, min, max)
                .toSet();
    }
    ...
    public Set<byte[]> zRangeByScore(byte[] key, String min, String max, long offset, long count) {
        ...
        return connection
                .invoke()
                .fromMany(RedisSortedSetAsyncCommands::zrangebyscore, key, min, max, offset, count)
                .toSet();
    }
    ...
    public Set<byte[]> zRangeByScore(
        ...
        if (limit.isUnlimited()) {
            return connection
                    .invoke()
                    .fromMany(
                            RedisSortedSetAsyncCommands::zrangebyscore, key, LettuceConverters.toRange(range))
                    .toSet();
        }
    ...
    public Set<byte[]> zRangeByLex(
        ...
        if (limit.isUnlimited()) {
            return connection
                    .invoke()
                    .fromMany(
                            RedisSortedSetAsyncCommands::zrangebylex, key, LettuceConverters.toRange(range, true))
                    .toSet();
        }
    ...
    public Long zRangeStoreByLex(
        ...
        return connection
                .invoke()
                .just(
                        RedisSortedSetAsyncCommands::zrangestorebylex,
                        dstKey,
                        srcKey,
                        LettuceConverters.toRange(range),
                        LettuceConverters.toLimit(limit));
    ...
    public Long zRangeStoreRevByLex(
        ...
        return connection
                .invoke()
                .just(
                        RedisSortedSetAsyncCommands::zrevrangestorebylex,
                        dstKey,
                        srcKey,
                        LettuceConverters.toRange(range),
                        LettuceConverters.toLimit(limit));
    ...
    public Long zRangeStoreByScore(
        ...
        return connection
                .invoke()
                .just(
                        RedisSortedSetAsyncCommands::zrangestorebyscore,
                        dstKey,
                        srcKey,
                        LettuceConverters.toRange(range),
                        LettuceConverters.toLimit(limit));
    ...
    public Long zRangeStoreRevByScore(
        ...
        return connection
                .invoke()
                .just(
                        RedisSortedSetAsyncCommands::zrevrangestorebyscore,
                        dstKey,
                        srcKey,
                        LettuceConverters.toRange(range),
                        LettuceConverters.toLimit(limit));
