...
/**
 * {@link ValkeyEntityInformation} implementation using a {@link ValkeyPersistentEntity} instance to
 * lookup the necessary information. Can be configured with a custom collection to be returned which
 * will trump the one returned by the {@link ValkeyPersistentEntity} if given.
 *
    ...
    public MappingValkeyEntityInformation(ValkeyPersistentEntity<T> entity) {
        ...
        if (!entity.hasIdProperty()) {
            throw new MappingException(
                    ("Entity %s requires to have an explicit id field;"
