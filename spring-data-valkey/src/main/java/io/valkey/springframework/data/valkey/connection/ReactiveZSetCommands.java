...
import static io.valkey.springframework.data.valkey.connection.ReactiveValkeyConnection.*;

import io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.ZAddArgs.Flag;
...
public interface ReactiveZSetCommands {
    ...
    class ZAddCommand extends KeyCommand {
        ...
        private ZAddCommand(
                @Nullable ByteBuffer key, List<Tuple> tuples, Set<Flag> flags, boolean incr) {
        ...
        /**
         * Applies {@literal xx} mode (Only update elements that already exist. Never add elements).
         * Constructs a new command instance with all previously configured properties.
         *
        ...
        /**
         * Applies {@literal nx} mode (Don't update already existing elements. Always add new elements).
         * Constructs a new command instance with all previously configured properties.
         *
        ...
        /**
         * Applies {@literal ch} mode (Modify the return value from the number of new elements added, to
         * the total number of elements changed). Constructs a new command instance with all previously
        ...
        /**
         * Applies {@literal incr} mode (When this option is specified ZADD acts like ZINCRBY).
         * Constructs a new command instance with all previously configured properties. Note that the
         * command result returns the score of the member.
         *
        ...
        /**
         * Applies {@literal GT} mode. Constructs a new command instance with all previously configured
         * properties.
         *
         * @return a new {@link ZAddCommand} with {@literal incr} applied.
         * @since 2.5
        ...
        /**
         * Applies {@literal LT} mode. Constructs a new command instance with all previously configured
         * properties.
         *
         * @return a new {@link ZAddCommand} with {@literal incr} applied.
         * @since 2.5
    ...
    /**
     * Add {@literal value} to a sorted set at {@literal key}, or update its {@literal score} if it
     * already exists.
     *
     * @param key must not be {@literal null}.
    ...
    default Mono<Long> zAdd(ByteBuffer key, Double score, ByteBuffer value) {
        ...
        return zAdd(Mono.just(
                        ZAddCommand.tuple(new DefaultTuple(ByteUtils.getBytes(value), score)).to(key)))
                .next()
                .map(resp -> resp.getOutput().longValue());
    }

    /**
     * Add a {@literal tuples} to a sorted set at {@literal key}, or update their score if it already
     * exists.
     *
     * @param key must not be {@literal null}.
     * @param tuples must not be {@literal null}.
    ...
    default Mono<Long> zAdd(ByteBuffer key, Collection<? extends Tuple> tuples) {
        ...
        return zAdd(Mono.just(ZAddCommand.tuples(tuples).to(key)))
                .next()
                .map(resp -> resp.getOutput().longValue());
    }

    /**
     * Add {@link ZAddCommand#getTuples()} to a sorted set at {@link ZAddCommand#getKey()}, or update
     * its {@literal score} if it already exists.
     *
    ...
    default Mono<Long> zRem(ByteBuffer key, Collection<ByteBuffer> values) {
        ...
        return zRem(Mono.just(ZRemCommand.values(values).from(key)))
                .next()
    ...
    class ZIncrByCommand extends KeyCommand {
        ...
        /**
         * Applies the numeric {@literal increment}. Constructs a new command instance with all
    ...
    default Mono<Double> zIncrBy(ByteBuffer key, Number increment, ByteBuffer value) {
        ...
        return zIncrBy(Mono.just(ZIncrByCommand.scoreOf(value).by(increment).storedWithin(key)))
                .next()
                .map(NumericResponse::getOutput);
    }

    /**
     * Increment the score of element with {@link ZIncrByCommand#getValue()} in sorted set by {@link
     * ZIncrByCommand#getIncrement()}.
     *
     * @param commands must not be {@literal null}.
     * @return
     * @see <a href="https://valkey.io/commands/zincrby">Valkey Documentation: ZINCRBY</a>
    ...
    default Mono<ByteBuffer> zRandMember(ByteBuffer key) {
        return zRandMember(Mono.just(ZRandMemberCommand.singleValue().from(key)))
     ...
     *
     * @param key must not be {@literal null}.
     * @param count if the provided {@code count} argument is positive, return a list of distinct
     *     fields, capped either at {@code count} or the set size. If {@code count} is negative, the
     *     behavior changes and the command is allowed to return the same value multiple times. In
     *     this case, the number of returned values is the absolute value of the specified count.
     * @return
     * @since 2.6
     * @see <a href="https://valkey.io/commands/zrandmember">Valkey Documentation: ZRANDMEMBER</a>
     */
    default Flux<ByteBuffer> zRandMember(ByteBuffer key, long count) {
        return zRandMember(Mono.just(ZRandMemberCommand.valueCount(count).from(key)))
                .flatMap(CommandResponse::getOutput);
    }
     ...
     * @see <a href="https://valkey.io/commands/zrandmember">Valkey Documentation: ZRANDMEMBER</a>
     */
    Flux<CommandResponse<ZRandMemberCommand, Flux<ByteBuffer>>> zRandMember(
     ...
     * @see <a href="https://valkey.io/commands/zrandmember">Valkey Documentation: ZRANDMEMBER</a>
     */
    Flux<CommandResponse<ZRandMemberCommand, Flux<Tuple>>> zRandMemberWithScore(
            Publisher<ZRandMemberCommand> commands);
    ...
    class ZRankCommand extends KeyCommand {
        ...
        /**
         * Creates a new {@link ZRankCommand} given a {@link ByteBuffer member} to obtain its rank
        ...
        /**
         * Creates a new {@link ZIncrByCommand} given a {@link ByteBuffer member} to obtain its reversed
    ...
    default Mono<Long> zRank(ByteBuffer key, ByteBuffer value) {
        ...
        return zRank(Mono.just(ZRankCommand.indexOf(value).storedWithin(key)))
                .next()
                .map(NumericResponse::getOutput);
    }
    ...
    default Mono<Long> zRevRank(ByteBuffer key, ByteBuffer value) {
        ...
        return zRank(Mono.just(ZRankCommand.reverseIndexOf(value).storedWithin(key)))
                .next()
                .map(NumericResponse::getOutput);
    }

    /**
     * Determine the index of element with {@literal value} in a sorted set when scored by {@link
     * ZRankCommand#getDirection()}.
     *
     * @param commands must not be {@literal null}.
     * @return
     * @see <a href="https://valkey.io/commands/zrank">Valkey Documentation: ZRANK</a>
    ...
    class ZRangeCommand extends KeyCommand {
        ...
        private ZRangeCommand(
                @Nullable ByteBuffer key, Range<Long> range, Direction direction, boolean withScores) {
        ...
        /**
         * Creates a new {@link ZRangeCommand} given a {@link Range} to obtain elements ordered from the
        ...
        /**
         * Return the score along with each returned element. Constructs a new command instance with all
         * previously configured properties.
         *
    ...
    default Flux<ByteBuffer> zRevRange(ByteBuffer key, Range<Long> range) {
        ...
        return zRange(Mono.just(ZRangeCommand.reverseValuesWithin(range).from(key)))
                .flatMap(CommandResponse::getOutput)
                .map(tuple -> ByteBuffer.wrap(tuple.getValue()));
    }

    /**
     * Get set of {@link Tuple}s in {@literal range} from sorted set in reverse {@literal score}
     * ordering.
     *
     * @param key must not be {@literal null}.
     * @param range must not be {@literal null}.
    ...
    class ZRangeStoreCommand extends KeyCommand {
        ...
        private ZRangeStoreCommand(
                @Nullable ByteBuffer srcKey,
                @Nullable ByteBuffer destKey,
                RangeMode rangeMode,
                Range<?> range,
                Direction direction,
                Limit limit) {
        ...
        /**
         * Creates a new {@link ZRangeStoreCommand} given a {@link Range} to obtain elements ordered
        ...
        public static ZRangeStoreCommand scoreWithin(Range<Double> range) {
            ...
            return new ZRangeStoreCommand(
                    null, null, RangeMode.ByScore, range, Direction.ASC, Limit.unlimited());
        }
        ...
        public static ZRangeStoreCommand reverseScoreWithin(Range<Double> range) {
            ...
            return new ZRangeStoreCommand(
                    null, null, RangeMode.ByScore, range, Direction.DESC, Limit.unlimited());
        }

        /**
         * Creates a new {@link ZRangeStoreCommand} given a {@link Range} to obtain elements ordered
         * from the lowest to the highest lexicographical value.
         *
         * @param range must not be {@literal null}.
         * @return a new {@link ZRangeCommand} for {@link Tuple}.
         */
        public static ZRangeStoreCommand valueWithin(Range<String> range) {
            ...
            return new ZRangeStoreCommand(
                    null, null, RangeMode.ByLex, range, Direction.ASC, Limit.unlimited());
        }

        /**
         * Creates a new {@link ZRangeStoreCommand} given a {@link Range} to obtain elements ordered
         * from the highest to the lowest lexicographical value.
         *
         * @param range must not be {@literal null}.
         * @return a new {@link ZRangeStoreCommand} for {@link Tuple}.
         */
        public static ZRangeStoreCommand reverseValueWithin(Range<String> range) {
            ...
            return new ZRangeStoreCommand(
                    null, null, RangeMode.ByLex, range, Direction.DESC, Limit.unlimited());
        }
        ...
        /**
         * Applies the {@literal limit}. Constructs a new command instance with all previously
         * configured properties.
         *
     ...
     * @see <a href="https://valkey.io/commands/zrangestore">Valkey Documentation: ZRANGESTORE</a>
     */
    default Mono<Long> zRangeStoreByScore(
            ByteBuffer srcKey, ByteBuffer destKey, Range<Double> range, Limit limit) {
        ...
        return zRangeStore(
                        Mono.just(
                                ZRangeStoreCommand.scoreWithin(range).from(srcKey).to(destKey).limit(limit))) //
                .flatMap(CommandResponse::getOutput)
                .next();
    }
     ...
     * @see <a href="https://valkey.io/commands/zrangestore">Valkey Documentation: ZRANGESTORE</a>
     */
    default Mono<Long> zRangeStoreByLex(
            ByteBuffer srcKey, ByteBuffer destKey, Range<String> range, Limit limit) {
        ...
        return zRangeStore(
                        Mono.just(
                                ZRangeStoreCommand.valueWithin(range).from(srcKey).to(destKey).limit(limit))) //
                .flatMap(CommandResponse::getOutput)
                .next();
    }
     ...
     * @see <a href="https://valkey.io/commands/zrangestore">Valkey Documentation: ZRANGESTORE</a>
     */
    default Mono<Long> zRangeStoreRevByScore(
            ByteBuffer srcKey, ByteBuffer destKey, Range<Double> range, Limit limit) {
        ...
        return zRangeStore(
                        Mono.just(
                                ZRangeStoreCommand.reverseScoreWithin(range)
                                        .from(srcKey)
                                        .to(destKey)
                                        .limit(limit))) //
                .flatMap(CommandResponse::getOutput)
    ...
    /**
     * Add elements from {@code srcKey} by reverse lexicographical {@literal range} to {@code
     * destKey}.
     *
     * @param srcKey must not be {@literal null}.
     * @param destKey must not be {@literal null}.
     ...
     * @see <a href="https://valkey.io/commands/zrangestore">Valkey Documentation: ZRANGESTORE</a>
     */
    default Mono<Long> zRangeStoreRevByLex(
            ByteBuffer srcKey, ByteBuffer destKey, Range<String> range, Limit limit) {
        ...
        return zRangeStore(
                        Mono.just(
                                ZRangeStoreCommand.reverseValueWithin(range)
                                        .from(srcKey)
                                        .to(destKey)
                                        .limit(limit))) //
                .flatMap(CommandResponse::getOutput)
     ...
     * @see <a href="https://valkey.io/commands/zrangestore">Valkey Documentation: ZRANGESTORE</a>
     */
    Flux<CommandResponse<ZRangeStoreCommand, Mono<Long>>> zRangeStore(
            Publisher<ZRangeStoreCommand> commands);
     ...
     * @see <a href="https://valkey.io/commands/zrevrangebyscore">Valkey Documentation:
     *     ZREVRANGEBYSCORE</a>
     */
    class ZRangeByScoreCommand extends KeyCommand {
        ...
        /**
         * Creates a new {@link ZRangeByScoreCommand} given a {@link Range} to obtain elements ordered
         * from the lowest to the highest score.
         *
         * @param range must not be {@literal null}.
        ...
        /**
         * Applies the {@link Limit}. Constructs a new command instance with all previously configured
         * properties.
         *
         * @param limit must not be {@literal null}.
    ...
    default Flux<ByteBuffer> zRangeByScore(ByteBuffer key, Range<Double> range, Limit limit) {
        ...
        return zRangeByScore(
                        Mono.just(ZRangeByScoreCommand.scoresWithin(range).from(key).limitTo(limit))) //
                .flatMap(CommandResponse::getOutput) //
                .map(tuple -> ByteBuffer.wrap(tuple.getValue()));
    }
    ...
    default Flux<Tuple> zRangeByScoreWithScores(ByteBuffer key, Range<Double> range, Limit limit) {
        ...
        return zRangeByScore(
                        Mono.just(
                                ZRangeByScoreCommand.scoresWithin(range).withScores().from(key).limitTo(limit)))
                .flatMap(CommandResponse::getOutput);
    }
    ...
    default Flux<ByteBuffer> zRevRangeByScore(ByteBuffer key, Range<Double> range, Limit limit) {
        ...
        return zRangeByScore(
                        Mono.just(ZRangeByScoreCommand.reverseScoresWithin(range).from(key).limitTo(limit))) //
                .flatMap(CommandResponse::getOutput) //
                .map(tuple -> ByteBuffer.wrap(tuple.getValue()));
    }
    ...
    default Flux<Tuple> zRevRangeByScoreWithScores(ByteBuffer key, Range<Double> range) {
        ...
        return zRangeByScore(
                        Mono.just(ZRangeByScoreCommand.reverseScoresWithin(range).withScores().from(key)))
                .flatMap(CommandResponse::getOutput);
    }
    ...
    default Flux<Tuple> zRevRangeByScoreWithScores(ByteBuffer key, Range<Double> range, Limit limit) {
        ...
        return zRangeByScore(
                        Mono.just(
                                ZRangeByScoreCommand.reverseScoresWithin(range)
                                        .withScores()
                                        .from(key)
                                        .limitTo(limit)))
                .flatMap(CommandResponse::getOutput);
     ...
     *     ZREVRANGEBYSCORE</a>
     */
    Flux<CommandResponse<ZRangeByScoreCommand, Flux<Tuple>>> zRangeByScore(
            Publisher<ZRangeByScoreCommand> commands);

    /**
     * Use a {@link Flux} to iterate over members in the sorted set at {@code key}. The resulting
     * {@link Flux} acts as a cursor and issues {@code ZSCAN} commands itself as long as the
    ...
    /**
     * Use a {@link Flux} to iterate over members in the sorted set at {@code key} given {@link
     * ScanOptions}. The resulting {@link Flux} acts as a cursor and issues {@code ZSCAN} commands
     * itself as long as the subscriber signals.
     *
     * @param key must not be {@literal null}.
    ...
    default Flux<Tuple> zScan(ByteBuffer key, ScanOptions options) {
        ...
        return zScan(Mono.just(KeyScanCommand.key(key).withOptions(options)))
     ...
     * <b>NOTE</b> please use {@link Double#NEGATIVE_INFINITY} for {@literal -inf} and {@link
     * Double#POSITIVE_INFINITY} for {@literal +inf}.
     *
     * @param key must not be {@literal null}.
     * @param range must not be {@literal null}.
     * @return
    ...
    default Mono<Long> zCount(ByteBuffer key, Range<Double> range) {
        ...
        return zCount(Mono.just(ZCountCommand.scoresWithin(range).forKey(key)))
                .next()
                .map(NumericResponse::getOutput);
    }
    ...
    class ZLexCountCommand extends KeyCommand {
        ...
        /**
         * Creates a new {@link ZLexCountCommand} given a {@link Range} of {@link String} to retrieve
         * elements count.
         *
         * @param range must not be {@literal null}.
    ...
    /**
     * Count number of elements within sorted set with value between {@code Range#min} and {@code
     * Range#max} applying lexicographical ordering.
     *
     * @param key must not be {@literal null}.
     * @param range must not be {@literal null}.
     * @return
    ...
    default Mono<Long> zLexCount(ByteBuffer key, Range<String> range) {
        return zLexCount(Mono.just(ZLexCountCommand.stringsWithin(range).forKey(key)))
                .next()
                .map(NumericResponse::getOutput);
    }
    ...
    class BZPopCommand extends KeyCommand {
        ...
        /**
         * Applies a {@link Duration timeout}. Constructs a new command instance with all previously
         * configured properties.
         *
    ...
    /**
     * Remove and return the value with its score having the lowest score from sorted set at {@code
     * key}.
     *
     * @param key must not be {@literal null}.
     * @return
    ...
    default Mono<Tuple> zPopMin(ByteBuffer key) {
        return zPop(Mono.just(ZPopCommand.min().from(key)))
                .map(CommandResponse::getOutput)
                .flatMap(Flux::next)
                .next();
    }
    ...
    /**
     * Remove and return {@code count} values with their score having the lowest score from sorted set
     * at {@code key}.
     *
     * @param key must not be {@literal null}.
    ...
    default Flux<Tuple> zPopMin(ByteBuffer key, long count) {
        return zPop(Mono.just(ZPopCommand.min().from(key).count(count)))
                .map(CommandResponse::getOutput)
    ...
    /**
     * Remove and return the value with its score having the lowest score from sorted set at {@code
     * key}. <b>Blocks connection</b> until element available or {@code timeout} reached.
     *
     * @param key must not be {@literal null}.
     * @param timeout must not be {@literal null}.
     * @return
    ...
    default Mono<Tuple> bZPopMin(ByteBuffer key, Duration timeout) {
        ...
        return bZPop(Mono.just(BZPopCommand.min().from(key).blockingFor(timeout)))
                .map(CommandResponse::getOutput)
                .flatMap(Flux::next)
                .next();
    }
    ...
    /**
     * Remove and return the value with its score having the highest score from sorted set at {@code
     * key}.
     *
     * @param key must not be {@literal null}.
     * @return
    ...
    default Mono<Tuple> zPopMax(ByteBuffer key) {
        return zPop(Mono.just(ZPopCommand.max().from(key)))
                .map(CommandResponse::getOutput)
                .flatMap(Flux::next)
                .next();
    }
    ...
    /**
     * Remove and return {@code count} values with their score having the highest score from sorted
     * set at {@code key}.
     *
     * @param key must not be {@literal null}.
     * @param count number of elements to pop.
    ...
    default Flux<Tuple> zPopMax(ByteBuffer key, long count) {
        return zPop(Mono.just(ZPopCommand.max().from(key).count(count)))
                .map(CommandResponse::getOutput)
                .flatMap(Function.identity());
    }
    ...
    default Mono<Tuple> bZPopMax(ByteBuffer key, Duration timeout) {
        ...
        return bZPop(Mono.just(BZPopCommand.max().from(key).blockingFor(timeout)))
                .map(CommandResponse::getOutput)
                .flatMap(Flux::next)
                .next();
    }
    ...
    default Mono<Double> zScore(ByteBuffer key, ByteBuffer value) {
        ...
        return zScore(Mono.just(ZScoreCommand.scoreOf(value).forKey(key)))
                .next()
                .map(NumericResponse::getOutput);
    }

    /**
     * Get the score of element with {@link ZScoreCommand#getValue()} from sorted set with key {@link
     * ZScoreCommand#getKey()}
     *
     * @param commands must not be {@literal null}.
     * @return
     * @see <a href="https://valkey.io/commands/zscore">Valkey Documentation: ZSCORE</a>
    ...
    default Mono<List<Double>> zMScore(ByteBuffer key, Collection<ByteBuffer> values) {
        ...
        return zMScore(Mono.just(ZMScoreCommand.scoreOf(values).forKey(key)))
                .next()
     ...
     *
     * @author Christoph Strobl
     * @see <a href="https://valkey.io/commands/zremrangebyrank">Valkey Documentation:
     *     ZREMRANGEBYRANK</a>
     */
    ...
    default Mono<Long> zRemRangeByRank(ByteBuffer key, Range<Long> range) {
        ...
        return zRemRangeByRank(Mono.just(ZRemRangeByRankCommand.valuesWithin(range).from(key)))
                .next()
                .map(NumericResponse::getOutput);
    }
     ...
     *     ZREMRANGEBYRANK</a>
     */
    Flux<NumericResponse<ZRemRangeByRankCommand, Long>> zRemRangeByRank(
     ...
     *
     * @author Christoph Strobl
     * @see <a href="https://valkey.io/commands/zremrangebyscore">Valkey Documentation:
     *     ZREMRANGEBYSCORE</a>
     */
    ...
    default Mono<Long> zRemRangeByScore(ByteBuffer key, Range<Double> range) {
        ...
        return zRemRangeByScore(Mono.just(ZRemRangeByScoreCommand.scoresWithin(range).from(key)))
                .next()
                .map(NumericResponse::getOutput);
    }
     ...
     *     ZREMRANGEBYSCORE</a>
     */
    Flux<NumericResponse<ZRemRangeByScoreCommand, Long>> zRemRangeByScore(
     ...
     * @author Christoph Strobl
     * @since 2.5
     * @see <a href="https://valkey.io/commands/zremrangebylex">Valkey Documentation:
     *     ZREMRANGEBYLEX</a>
     */
    ...
    default Mono<Long> zRemRangeByLex(ByteBuffer key, Range<String> range) {
        ...
        return zRemRangeByLex(Mono.just(ZRemRangeByLexCommand.lexWithin(range).from(key)))
                .next()
                .map(NumericResponse::getOutput);
    }
     ...
     *     ZREMRANGEBYLEX</a>
     */
    Flux<NumericResponse<ZRemRangeByLexCommand, Long>> zRemRangeByLex(
            Publisher<ZRemRangeByLexCommand> commands);
     ...
     * @see <a href="https://valkey.io/commands/zdiff">Valkey Documentation: ZDIFF</a>
     */
    Flux<CommandResponse<ZDiffCommand, Flux<ByteBuffer>>> zDiff(
            Publisher<? extends ZDiffCommand> commands);
     ...
     * @see <a href="https://valkey.io/commands/zdiff">Valkey Documentation: ZDIFF</a>
     */
    Flux<CommandResponse<ZDiffCommand, Flux<Tuple>>> zDiffWithScores(
            Publisher<? extends ZDiffCommand> commands);
    ...
    class ZDiffStoreCommand extends KeyCommand {
        ...
        /**
         * Applies the {@literal key} at which the result is stored. Constructs a new command instance
         * with all previously configured properties.
         *
         * @param key must not be {@literal null}.
    ...
    default Mono<Long> zDiffStore(ByteBuffer destinationKey, List<ByteBuffer> sets) {
        ...
        return zDiffStore(Mono.just(ZDiffStoreCommand.sourceKeys(sets).storeAs(destinationKey)))
                .next()
                .map(NumericResponse::getOutput);
    }
    ...
    class ZAggregateCommand implements Command {
        ...
        private ZAggregateCommand(
                List<ByteBuffer> sourceKeys, List<Double> weights, @Nullable Aggregate aggregate) {
        ...
        /**
         * Applies the {@link List} of weights. Constructs a new command instance with all previously
         * configured properties.
         *
        ...
        /**
         * Applies the {@link Weights}. Constructs a new command instance with all previously configured
         * properties.
         *
         * @param weights must not be {@literal null}.
         * @return a new {@link ZAggregateCommand} with {@literal weights} applied.
        ...
        /**
         * Applies a specific {@link Aggregate} function. Constructs a new command instance with all
         * previously configured properties.
         *
    ...
    class ZAggregateStoreCommand extends KeyCommand {
        ...
        private ZAggregateStoreCommand(
                @Nullable ByteBuffer key,
                List<ByteBuffer> sourceKeys,
                List<Double> weights,
    ...
    /**
     * Intersect sorted {@literal sets} by applying {@literal aggregateFunction} and apply weights to
     * individual sets.
     *
     * @param commands
     * @return
     ...
     * @see <a href="https://valkey.io/commands/zinter">Valkey Documentation: ZINTER</a>
     */
    Flux<CommandResponse<ZAggregateCommand, Flux<ByteBuffer>>> zInter(
     ...
     * @see <a href="https://valkey.io/commands/zinter">Valkey Documentation: ZINTER</a>
     */
    default Flux<Tuple> zInterWithScores(
            List<ByteBuffer> sets, List<Double> weights, @Nullable Aggregate aggregateFunction) {

        Assert.notNull(sets, "Sets must not be null");

        return zInterWithScores(
                        Mono.just(
                                ZAggregateCommand.sets(sets)
                                        .aggregateUsing(aggregateFunction)
     ...
     */
    default Flux<Tuple> zInterWithScores(
            List<ByteBuffer> sets, Weights weights, @Nullable Aggregate aggregateFunction) {
    ...
    class ZInterStoreCommand extends ZAggregateStoreCommand {
        ...
        /**
         * Applies the {@link Collection} of weights. Constructs a new command instance with all
         * previously configured properties.
         *
         * @param weights must not be {@literal null}.
        ...
        public ZInterStoreCommand applyWeights(List<Double> weights) {
            return new ZInterStoreCommand(
                    getKey(), getSourceKeys(), weights, getAggregateFunction().orElse(null));
        }
        ...
        public ZInterStoreCommand storeAs(ByteBuffer key) {
            ...
            return new ZInterStoreCommand(
                    key, getSourceKeys(), getWeights(), getAggregateFunction().orElse(null));
        }
    }
    ...
    /**
     * Intersect sorted {@literal sets} and store result in destination {@literal destinationKey} and
     * apply weights to individual sets.
     *
     * @param destinationKey must not be {@literal null}.
     * @param sets must not be {@literal null}.
     * @param weights must not be {@literal null}.
     ...
     * @see <a href="https://valkey.io/commands/zinterstore">Valkey Documentation: ZINTERSTORE</a>
     */
    default Mono<Long> zInterStore(
            ByteBuffer destinationKey, List<ByteBuffer> sets, List<Double> weights) {
     ...
     */
    default Mono<Long> zInterStore(
            ByteBuffer destinationKey, List<ByteBuffer> sets, Weights weights) {
        return zInterStore(destinationKey, sets, weights, null);
    }

    /**
     * Intersect sorted {@literal sets} by applying {@literal aggregateFunction} and store result in
     * destination {@literal destinationKey} and apply weights to individual sets.
     *
     * @param destinationKey must not be {@literal null}.
     * @param sets must not be {@literal null}.
     * @param weights must not be {@literal null}.
    ...
    default Mono<Long> zInterStore(
        ...
        return zInterStore(
                        Mono.just(
                                ZInterStoreCommand.sets(sets)
                                        .aggregateUsing(aggregateFunction)
                                        .applyWeights(weights)
                                        .storeAs(destinationKey)))
                .next()
                .map(NumericResponse::getOutput);
    }
     ...
     * @see <a href="https://valkey.io/commands/zinterstore">Valkey Documentation: ZINTERSTORE</a>
     */
    Flux<NumericResponse<ZAggregateStoreCommand, Long>> zInterStore(
    ...
    /**
     * Union sorted {@literal sets} by applying {@literal aggregateFunction} and apply weights to
     * individual sets.
     *
     * @param sets must not be {@literal null}.
     ...
     * @see <a href="https://valkey.io/commands/zunion">Valkey Documentation: ZUNION</a>
     */
    default Flux<Tuple> zUnionWithScores(
            List<ByteBuffer> sets, List<Double> weights, @Nullable Aggregate aggregateFunction) {
     ...
     * @see <a href="https://valkey.io/commands/zunion">Valkey Documentation: ZUNION</a>
     */
    Flux<CommandResponse<ZAggregateCommand, Flux<ByteBuffer>>> zUnion(
            Publisher<? extends ZAggregateCommand> commands);
    ...
    /**
     * Union sorted {@literal sets} and store result in destination {@literal destinationKey} and
     * apply weights to individual sets.
     *
     * @param destinationKey must not be {@literal null}.
     * @param sets must not be {@literal null}.
    ...
    /**
     * Union sorted {@literal sets} by applying {@literal aggregateFunction} and store result in
     * destination {@literal destinationKey} and apply weights to individual sets.
     *
     * @param destinationKey must not be {@literal null}.
     * @param sets must not be {@literal null}.
    ...
    default Mono<Long> zUnionStore(
        ...
        return zUnionStore(
                        Mono.just(
                                ZAggregateStoreCommand.sets(sets)
                                        .aggregateUsing(aggregateFunction)
                                        .applyWeights(weights)
                                        .storeAs(destinationKey)))
                .next()
     ...
     * @see <a href="https://valkey.io/commands/zunionstore">Valkey Documentation: ZUNIONSTORE</a>
     */
    Flux<NumericResponse<ZAggregateStoreCommand, Long>> zUnionStore(
            Publisher<? extends ZAggregateStoreCommand> commands);
     ...
     * @see <a href="https://valkey.io/commands/zrevrangebylex">Valkey Documentation:
     *     ZREVRANGEBYLEX</a>
     */
    class ZRangeByLexCommand extends KeyCommand {
        ...
        private ZRangeByLexCommand(
                @Nullable ByteBuffer key, Range<String> range, Direction direction, Limit limit) {
        ...
        /**
         * Creates a new {@link ZRangeByLexCommand} given a {@link Range} of {@link String} to retrieve
         * elements lexicographical ordering.
         *
         * @param range must not be {@literal null}.
        ...
        /**
         * Creates a new {@link ZRangeByLexCommand} given a {@link Range} of {@link String} to obtain
         * elements in reverse lexicographical ordering.
         *
         * @param range must not be {@literal null}.
         * @return a new {@link ZRangeByLexCommand} for {@link Tuple}.
         */
    ...
    /**
     * Get all elements in {@link Range} from the sorted set at {@literal key} in lexicographical
     * ordering.
     *
     * @param key must not be {@literal null}.
     * @param range must not be {@literal null}.
    ...
    /**
     * Get all elements in {@link Range} from the sorted set at {@literal key} in lexicographical
     * ordering. Result is limited via {@link Limit}.
     *
     * @param key must not be {@literal null}.
     * @param range must not be {@literal null}.
    ...
    default Flux<ByteBuffer> zRevRangeByLex(ByteBuffer key, Range<String> range, Limit limit) {
        ...
        return zRangeByLex(
                        Mono.just(ZRangeByLexCommand.reverseStringsWithin(range).from(key).limitTo(limit)))
                .flatMap(CommandResponse::getOutput);
    }

    /**
     * Get all elements in {@link Range} from the sorted set at {@literal key} in lexicographical
     * ordering. Result is limited via {@link Limit} and sorted by {@link
     * ZRangeByLexCommand#getDirection()}.
     *
     * @param commands must not be {@literal null}.
     * @return
     * @see <a href="https://valkey.io/commands/zrangebylex">Valkey Documentation: ZRANGEBYLEX</a>
     ...
     *     ZREVRANGEBYLEX</a>
     */
    Flux<CommandResponse<ZRangeByLexCommand, Flux<ByteBuffer>>> zRangeByLex(
