...
class LettuceListCommands implements ValkeyListCommands {
    ...
    public List<Long> lPos(
        ...
        return connection
                .invoke()
                .from(RedisListAsyncCommands::lpos, key, element, args)
    ...
    public Long lInsert(byte[] key, Position where, byte[] pivot, byte[] value) {
        ...
        return connection
                .invoke()
                .just(
                        RedisListAsyncCommands::linsert, key, LettuceConverters.toBoolean(where), pivot, value);
    }
    ...
    public byte[] bRPopLPush(int timeout, byte[] srcKey, byte[] dstKey) {
        ...
        return connection
                .invoke(connection.getAsyncDedicatedConnection())
                .just(RedisListAsyncCommands::brpoplpush, timeout, srcKey, dstKey);
    }
