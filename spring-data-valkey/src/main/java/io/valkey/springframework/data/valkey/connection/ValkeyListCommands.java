...
public interface ValkeyListCommands {
     ...
     * @param start
     * @param end
     * @return empty {@link List} if key does not exists or range does not contain values. {@literal
     ...
     *
     * @param key must not be {@literal null}.
     * @param index zero based index value. Use negative number to designate elements starting at the
     *     tail.
     ...
     * @return empty {@link List} when no element could be popped and the timeout was reached.
