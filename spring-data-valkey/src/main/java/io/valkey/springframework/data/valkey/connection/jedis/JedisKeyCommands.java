...
class JedisKeyCommands implements ValkeyKeyCommands {
    ...
    public Boolean exists(byte[] key) {
        ...
        return connection
                .invoke()
                .just(JedisBinaryCommands::exists, PipelineBinaryCommands::exists, key);
    }
    ...
    public Long exists(byte[]... keys) {
        ...
        return connection
                .invoke()
                .just(JedisBinaryCommands::exists, PipelineBinaryCommands::exists, keys);
    }
    ...
    public Boolean copy(byte[] sourceKey, byte[] targetKey, boolean replace) {
        ...
        return connection
                .invoke()
                .just(
                        JedisBinaryCommands::copy, PipelineBinaryCommands::copy, sourceKey, targetKey, replace);
    }
    ...
    public Long unlink(byte[]... keys) {
        ...
        return connection
                .invoke()
                .just(JedisBinaryCommands::unlink, PipelineBinaryCommands::unlink, keys);
    }
    ...
    public DataType type(byte[] key) {
        ...
        return connection
                .invoke()
                .from(JedisBinaryCommands::type, PipelineBinaryCommands::type, key)
    ...
    public Long touch(byte[]... keys) {
        ...
        return connection
                .invoke()
                .just(JedisBinaryCommands::touch, PipelineBinaryCommands::touch, keys);
    }
    ...
    public Set<byte[]> keys(byte[] pattern) {
        ...
        return connection
                .invoke()
                .just(JedisBinaryCommands::keys, PipelineBinaryCommands::keys, pattern);
    }
    ...
    public byte[] randomKey() {
        return connection
                .invoke()
                .just(JedisBinaryCommands::randomBinaryKey, PipelineBinaryCommands::randomBinaryKey);
    }
    ...
    public void rename(byte[] oldKey, byte[] newKey) {
        ...
        connection
                .invokeStatus()
                .just(JedisBinaryCommands::rename, PipelineBinaryCommands::rename, oldKey, newKey);
    }
    ...
    public Boolean expire(byte[] key, long seconds, ExpirationOptions.Condition condition) {
        ...
        if (condition == ExpirationOptions.Condition.ALWAYS) {
            return connection
                    .invoke()
                    .from(JedisBinaryCommands::expire, PipelineBinaryCommands::expire, key, seconds)
                    .get(JedisConverters.longToBoolean());
        }
        ...
        return connection
                .invoke()
                .from(JedisBinaryCommands::expire, PipelineBinaryCommands::expire, key, seconds, option)
                .get(JedisConverters.longToBoolean());
    }
    ...
    public Boolean pExpire(byte[] key, long millis, ExpirationOptions.Condition condition) {
        ...
        if (condition == ExpirationOptions.Condition.ALWAYS) {
            return connection
                    .invoke()
                    .from(JedisBinaryCommands::pexpire, PipelineBinaryCommands::pexpire, key, millis)
                    .get(JedisConverters.longToBoolean());
        }
        ...
        return connection
                .invoke()
                .from(JedisBinaryCommands::pexpire, PipelineBinaryCommands::pexpire, key, millis, option)
                .get(JedisConverters.longToBoolean());
    }
    ...
    public Boolean expireAt(byte[] key, long unixTime, ExpirationOptions.Condition condition) {
        ...
        if (condition == ExpirationOptions.Condition.ALWAYS) {
            return connection
                    .invoke()
                    .from(JedisBinaryCommands::expireAt, PipelineBinaryCommands::expireAt, key, unixTime)
                    .get(JedisConverters.longToBoolean());
        }
        ...
        return connection
                .invoke()
                .from(
                        JedisBinaryCommands::expireAt, PipelineBinaryCommands::expireAt, key, unixTime, option)
                .get(JedisConverters.longToBoolean());
    }
    ...
    public Boolean pExpireAt(
        ...
        if (condition == ExpirationOptions.Condition.ALWAYS) {
            return connection
                    .invoke()
                    .from(
                            JedisBinaryCommands::pexpireAt,
                            PipelineBinaryCommands::pexpireAt,
                            key,
                            unixTimeInMillis)
                    .get(JedisConverters.longToBoolean());
        }
    ...
    public Boolean persist(byte[] key) {
        ...
        return connection
                .invoke()
                .from(JedisBinaryCommands::persist, PipelineBinaryCommands::persist, key)
                .get(JedisConverters.longToBoolean());
    }
    ...
    public Long ttl(byte[] key, TimeUnit timeUnit) {
        ...
        return connection
                .invoke()
                .from(JedisBinaryCommands::ttl, PipelineBinaryCommands::ttl, key)
    ...
    public Long pTtl(byte[] key, TimeUnit timeUnit) {
        ...
        return connection
                .invoke()
                .from(JedisBinaryCommands::pttl, PipelineBinaryCommands::pttl, key)
    ...
    public List<byte[]> sort(byte[] key, SortParameters params) {
        ...
        if (sortParams != null) {
            return connection
                    .invoke()
                    .just(JedisBinaryCommands::sort, PipelineBinaryCommands::sort, key, sortParams);
        }
    ...
    public Long sort(byte[] key, @Nullable SortParameters params, byte[] storeKey) {
        ...
        if (sortParams != null) {
            return connection
                    .invoke()
                    .just(JedisBinaryCommands::sort, PipelineBinaryCommands::sort, key, sortParams, storeKey);
        }

        return connection
                .invoke()
                .just(JedisBinaryCommands::sort, PipelineBinaryCommands::sort, key, storeKey);
    }
    ...
    public void restore(byte[] key, long ttlInMillis, byte[] serializedValue, boolean replace) {
        ...
        if (replace) {
            ...
            connection
                    .invokeStatus()
                    .just(
                            JedisBinaryCommands::restore,
                            PipelineBinaryCommands::restore,
                            key,
                            (int) ttlInMillis,
                            serializedValue,
        ...
        if (ttlInMillis > Integer.MAX_VALUE) {
            throw new IllegalArgumentException(
                    "TtlInMillis must be less than Integer.MAX_VALUE for restore in Jedis");
        }
    ...
    public ValueEncoding encodingOf(byte[] key) {
        ...
        return connection
                .invoke()
                .from(JedisBinaryCommands::objectEncoding, PipelineBinaryCommands::objectEncoding, key)
    ...
    public Duration idletime(byte[] key) {
        ...
        return connection
                .invoke()
                .from(JedisBinaryCommands::objectIdletime, PipelineBinaryCommands::objectIdletime, key)
    ...
    public Long refcount(byte[] key) {
        ...
        return connection
                .invoke()
                .just(JedisBinaryCommands::objectRefcount, PipelineBinaryCommands::objectRefcount, key);
    }
