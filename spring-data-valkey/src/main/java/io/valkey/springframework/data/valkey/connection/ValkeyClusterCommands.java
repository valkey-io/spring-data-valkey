...
/**
 * Interface for the {@literal cluster} commands supported by Valkey. A {@link ValkeyClusterNode}
 * can be obtained from {@link #clusterGetNodes()} or it can be constructed using either {@link
 * ValkeyClusterNode#getHost() host} and {@link ValkeyClusterNode#getPort()} or the {@link
 * ValkeyClusterNode#getId() node Id}.
 *
