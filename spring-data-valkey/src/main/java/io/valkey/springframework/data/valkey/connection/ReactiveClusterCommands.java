...
/**
 * Interface for the {@literal cluster} commands supported by Valkey executed using reactive
 * infrastructure. A {@link ValkeyClusterNode} can be obtained from {@link #clusterGetNodes()} or it
 * can be constructed using either {@link ValkeyClusterNode#getHost() host} and {@link
...
public interface ReactiveClusterCommands {
    ...
    /**
     * Retrieve cluster node information such as {@literal id}, {@literal host}, {@literal port} and
     * {@literal slots}.
     *
     * @return a {@link Flux} emitting {@link ValkeyClusterNode cluster nodes}, an {@link Flux#empty()
     *     empty one} if none found.
     ...
     * @return a {@link Flux} emitting {@link ValkeyClusterNode cluster nodes}, an {@link Flux#empty()
     *     empty one} if none found.
     * @see <a href="https://valkey.io/commands/cluster-replicas">Valkey Documentation: CLUSTER
     *     REPLICAS</a>
     */
     ...
     * @see <a href="https://valkey.io/commands/cluster-keyslot">Valkey Documentation: CLUSTER
     *     KEYSLOT</a>
     */
     ...
     *
     * @param key must not be {@literal null}.
     * @return a {@link Mono} emitting the {@link ValkeyClusterNode} handling the slot for the given
     *     key.
     */
     ...
     * @see <a href="https://valkey.io/commands/cluster-addslots">Valkey Documentation: CLUSTER
     *     ADDSLOTS</a>
     */
     ...
     * @see <a href="https://valkey.io/commands/cluster-countkeysinslot">Valkey Documentation: CLUSTER
     *     COUNTKEYSINSLOT</a>
     */
     ...
     * @param node must not be {@literal null}.
     * @return a {@link Mono} signaling completion.
     * @see <a href="https://valkey.io/commands/cluster-delslots">Valkey Documentation: CLUSTER
     *     DELSLOTS</a>
     */
     ...
     * @param node must not be {@literal null}.
     * @return a {@link Mono} signaling completion.
     * @see <a href="https://valkey.io/commands/cluster-forget">Valkey Documentation: CLUSTER
     *     FORGET</a>
     */
     ...
     *
     * @param node must contain {@link ValkeyClusterNode#getHost() host} and {@link
     *     ValkeyClusterNode#getPort()} and must not be {@literal null}.
     * @return a {@link Mono} signaling completion.
     ...
     * @return a {@link Mono} signaling completion.
     * @see <a href="https://valkey.io/commands/cluster-setslot">Valkey Documentation: CLUSTER
     *     SETSLOT</a>
     */
     ...
     * @return a {@link Flux} emitting the number of requested keys in the given slot, or signalling
     *     completion if none found.
     * @see <a href="https://valkey.io/commands/cluster-getkeysinslot">Valkey Documentation: CLUSTER
     *     GETKEYSINSLOT</a>
     */
     ...
     * @return a {@link Mono} signaling completion.
     * @see <a href="https://valkey.io/commands/cluster-replicate">Valkey Documentation: CLUSTER
     *     REPLICATE</a>
     */
