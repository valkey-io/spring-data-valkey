...
/**
 * {@link MessageConverter} adapter for {@link ValkeySerializer}.
 *
 * @author Mark Paluch
 * @since 4.1
 */
public class SerializerMessageConverter extends AbstractMessageConverter implements MessageConverter {
	...
	private final ValkeySerializer<Object> serializer;

	public SerializerMessageConverter(ValkeySerializer<?> serializer) {
		this.serializer = (ValkeySerializer<Object>) serializer;
	}

	public SerializerMessageConverter(ValkeySerializer<?> serializer, MimeType... supportedMimeTypes) {
		this(serializer);
