...
class LettuceGeoCommands implements ValkeyGeoCommands {
    ...
    public Long geoAdd(byte[] key, Point point, byte[] member) {
        ...
        return connection
                .invoke()
                .just(RedisGeoAsyncCommands::geoadd, key, point.getX(), point.getY(), member);
    }
    ...
    public Distance geoDist(byte[] key, byte[] member1, byte[] member2, Metric metric) {
        ...
        return connection
                .invoke()
                .from(RedisGeoAsyncCommands::geodist, key, member1, member2, geoUnit)
    ...
    public List<String> geoHash(byte[] key, byte[]... members) {
        ...
        return connection
                .invoke()
                .fromMany(RedisGeoAsyncCommands::geohash, key, members)
    ...
    public List<Point> geoPos(byte[] key, byte[]... members) {
        ...
        return connection
                .invoke()
                .fromMany(RedisGeoAsyncCommands::geopos, key, members)
    ...
    public GeoResults<GeoLocation<byte[]>> geoRadius(byte[] key, Circle within) {
        ...
        Converter<Set<byte[]>, GeoResults<GeoLocation<byte[]>>> geoResultsConverter =
                LettuceConverters.bytesSetToGeoResultsConverter();
    ...
    public GeoResults<GeoLocation<byte[]>> geoRadius(
        ...
        Converter<List<GeoWithin<byte[]>>, GeoResults<GeoLocation<byte[]>>> geoResultsConverter =
                LettuceConverters.geoRadiusResponseToGeoResultsConverter(within.getRadius().getMetric());
    ...
    public GeoResults<GeoLocation<byte[]>> geoRadiusByMember(
        ...
        Converter<Set<byte[]>, GeoResults<GeoLocation<byte[]>>> converter =
                LettuceConverters.bytesSetToGeoResultsConverter();

        return connection
                .invoke()
                .from(RedisGeoAsyncCommands::georadiusbymember, key, member, radius.getValue(), geoUnit)
                .get(converter);
    }
    ...
    public GeoResults<GeoLocation<byte[]>> geoRadiusByMember(
        ...
        GeoArgs geoArgs = LettuceConverters.toGeoArgs(args);
        Converter<List<GeoWithin<byte[]>>, GeoResults<GeoLocation<byte[]>>> geoResultsConverter =
                LettuceConverters.geoRadiusResponseToGeoResultsConverter(radius.getMetric());

        return connection
                .invoke()
                .from(
                        RedisGeoAsyncCommands::georadiusbymember,
                        key,
                        member,
                        radius.getValue(),
                        geoUnit,
    ...
    public GeoResults<GeoLocation<byte[]>> geoSearch(
        ...
        return connection
                .invoke()
                .from(RedisGeoAsyncCommands::geosearch, key, ref, lettucePredicate, geoArgs)
                ...
                .just(
                        connection ->
                                connection.geosearchstore(
                                        destKey, key, ref, lettucePredicate, geoArgs, args.isStoreDistance()));
    }
}
