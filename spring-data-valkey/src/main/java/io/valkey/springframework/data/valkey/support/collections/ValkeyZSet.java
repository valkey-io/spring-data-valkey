...
/**
 * Valkey ZSet (or sorted set (by weight)). Acts as a {@link SortedSet} based on the given
 * priorities or weights associated with each item.
 *
 * <p>Since using a {@link Comparator} does not apply, a ZSet implements the {@link SortedSet}
...
public interface ValkeyZSet<E> extends ValkeyCollection<E>, Set<E> {
     ...
     * @since 2.6
     */
    static <E> ValkeyZSet<E> create(
            String key, ValkeyOperations<String, E> operations, double defaultScore) {
    ...
    /**
     * Create a new {@link ValkeyZSet} by diffing this sorted set and {@link ValkeyZSet} and store
    ...
    /**
     * Create a new {@link ValkeyZSet} by diffing this sorted set and the collection {@link
     * ValkeyZSet} and store result in destination {@code destKey}.
     *
     * @param sets must not be {@literal null}.
     * @param destKey must not be {@literal null}.
     * @return a new {@link ValkeyZSet} pointing at {@code destKey}.
    ...
    /**
     * Create a new {@link ValkeyZSet} by intersecting this sorted set and {@link ValkeyZSet} and
     * store result in destination {@code destKey}.
     *
     * @param set must not be {@literal null}.
     * @param destKey must not be {@literal null}.
     * @return a new {@link ValkeyZSet} pointing at {@code destKey}
    ...
    /**
     * Create a new {@link ValkeyZSet} by intersecting this sorted set and the collection {@link
     * ValkeyZSet} and store result in destination {@code destKey}.
     *
     * @param sets must not be {@literal null}.
     * @param destKey must not be {@literal null}.
    ...
    /**
     * Create a new {@link ValkeyZSet} by union this sorted set and {@link ValkeyZSet} and store
     * result in destination {@code destKey}.
     *
     * @param set must not be {@literal null}.
     * @param destKey must not be {@literal null}.
    ...
    /**
     * Create a new {@link ValkeyZSet} by union this sorted set and the collection {@link ValkeyZSet}
     * and store result in destination {@code destKey}.
     *
     * @param sets must not be {@literal null}.
     * @param destKey must not be {@literal null}.
     * @return a new {@link ValkeyZSet} pointing at {@code destKey}
     ...
     */
    @Deprecated(since = "3.0", forRemoval = true)
    default Set<E> reverseRangeByLex(
            io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
     ...
     * @since 3.0
     */
    ValkeyZSet<E> reverseRangeAndStoreByScore(
            String dstKey, Range<? extends Number> range, Limit limit);
    ...
    /**
     * Adds an element to the set with a default score. Equivalent to {@code add(e,
     * getDefaultScore())}. The score value is implementation specific. {@inheritDoc}
     */
    boolean add(E e);

    /**
     * Adds an element to the set using the {@link #getDefaultScore() default score} if the element
    ...
    /**
     * Returns the score of the given element. Returns null if the element is not contained by the
     * set.
     *
     * @param o object
    ...
    /**
     * Returns the rank (position) of the given element in the set, in ascending order. Returns null
     * if the element is not contained by the set.
     *
     * @param o object
    ...
    /**
     * Returns the rank (position) of the given element in the set, in descending order. Returns null
     * if the element is not contained by the set.
     *
     * @param o object
    ...
    /**
     * Removes the first (lowest) object at the top of this sorted set and returns that object as the
    ...
    /**
     * Removes the first (lowest) object at the top of this sorted set and returns that object as the
     * value of this function. <b>Blocks connection</b> until element available or {@code timeout}
     * reached.
     *
     * @param timeout
    ...
    /**
     * Removes the last (highest) object at the top of this sorted set and returns that object as the
     * value of this function.
     *
     * @return the last (highest) element currently in this sorted set.
     * @throws NoSuchElementException sorted set is empty.
