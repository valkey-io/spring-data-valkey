...
/**
 * {@link MessageConverter} adapter for {@link JdkSerializationValkeySerializer}. Useful to inherit supported mimetype
 * defaults.
 *
 * @author Mark Paluch
 * @since 4.1
...
public class JdkSerializerMessageConverter extends SerializerMessageConverter implements MessageConverter {
	...
	public JdkSerializerMessageConverter(@Nullable ClassLoader classLoader) {
		this(new JdkSerializationValkeySerializer(classLoader));
	}

	/**
	 * Create a new {@code JdkSerializerMessageConverter} given {@link JdkSerializationValkeySerializer}.
	 *
	 * @param serializer the serializer to use.
	 */
	public JdkSerializerMessageConverter(JdkSerializationValkeySerializer serializer) {
		super(serializer);
