...
/**
 * Valkey connection using reactive infrastructure declaring entry points for reactive command
 * execution.
 *
 * <p>{@link ReactiveValkeyConnection} is typically implemented by a stateful object that requires
 * to be {@link #close() closed} once it is no longer required.
 *
 * <p>Commands can be either executed by passing plain arguments like {@code key}, {@code value} or
 * wrapped inside a command stream. Streaming command execution accepts {@link
 * org.reactivestreams.Publisher} of a particular {@link Command}. Commands are executed at the time
 * their emission.
 *
 * <p>Arguments are binary-safe by using {@link ByteBuffer} arguments. Expect {@link ByteBuffer} to
 * be consumed by {@link ReactiveValkeyConnection} invocation or during execution. Any {@link
 * ByteBuffer} used as method parameter should not be altered after invocation.
 *
...
public interface ReactiveValkeyConnection extends Closeable {
    ...
    /**
     * {@link Command} for key-bound scan operations like {@code SCAN}, {@code HSCAN}, {@code SSCAN}
     * and {@code ZSCAN}.
     *
     * @author Mark Paluch
     * @author Christoph Strobl
    ...
    class KeyScanCommand extends KeyCommand {
        ...
        /**
         * Applies {@link ScanOptions}. Constructs a new command instance with all previously configured
         * properties.
         *
    ...
    class RangeCommand extends KeyCommand {
        ...
        /**
         * Applies a lower bound to the {@link Range}. Constructs a new command instance with all
        ...
        /**
         * Applies an upper bound to the {@link Range}. Constructs a new command instance with all
         * previously configured properties.
         *
         * @param end
    ...
    class CommandResponse<I, O> {
        ...
        /**
         * @return {@literal true} if the response is present. An absent {@link CommandResponse} maps to
         *     Valkey {@literal (nil)}.
         */
        ...
        public String toString() {
            return "ReactiveValkeyConnection.CommandResponse(input="
                    + this.getInput()
                    + ", output="
                    + this.getOutput()
                    + ")";
