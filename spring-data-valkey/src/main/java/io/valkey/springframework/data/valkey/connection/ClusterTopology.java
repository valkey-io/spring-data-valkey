...
public class ClusterTopology {
    ...
    /**
     * Get all nodes (master and replica) in cluster where {@code link-state} is {@literal connected}
     * and {@code flags} does not contain {@literal fail} or {@literal fail?}.
     *
     * @return never {@literal null}.
     */
    ...
    /**
     * Get all master nodes in cluster where {@code link-state} is {@literal connected} and {@code
     * flags} does not contain {@literal fail} or {@literal fail?}.
     *
     * @return never {@literal null}.
     */
    ...
    public ValkeyClusterNode getKeyServingMasterNode(byte[] key) {
        ...
        throw new ClusterStateFailureException(
                "Could not find master node serving slot %s for key '%s',"
    ...
    /**
     * Get the {@link ValkeyClusterNode} matching matching either {@link ValkeyClusterNode#getHost()
     * host} and {@link ValkeyClusterNode#getPort() port} or {@link ValkeyClusterNode#getId() nodeId}
     *
    ...
    public ValkeyClusterNode lookup(ValkeyClusterNode node) {
        ...
        throw new ClusterStateFailureException(
                ("Could not find node at %s;" + " Have you provided either host and port or the nodeId")
                        .formatted(node));
    }
