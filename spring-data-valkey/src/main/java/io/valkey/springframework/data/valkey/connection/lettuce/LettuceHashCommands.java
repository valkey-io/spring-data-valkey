...
class LettuceHashCommands implements ValkeyHashCommands {
    ...
    public Entry<byte[], byte[]> hRandFieldWithValues(byte[] key) {
        ...
        return connection
                .invoke()
                .from(RedisHashAsyncCommands::hrandfieldWithvalues, key)
    ...
    public List<Entry<byte[], byte[]>> hRandFieldWithValues(byte[] key, long count) {
        ...
        return connection
                .invoke()
                .fromMany(RedisHashAsyncCommands::hrandfieldWithvalues, key, count)
    ...
    public List<byte[]> hMGet(byte[] key, byte[]... fields) {
        ...
        return connection
                .invoke()
                .fromMany(RedisHashAsyncCommands::hmget, key, fields)
    ...
    public List<Long> hExpire(
        ...
        return connection
                .invoke()
                .fromMany(RedisHashAsyncCommands::hexpire, key, seconds, getExpireArgs(condition), fields)
                .toList();
    }
    ...
    public List<Long> hpExpire(
        ...
        return connection
                .invoke()
                .fromMany(RedisHashAsyncCommands::hpexpire, key, millis, getExpireArgs(condition), fields)
                .toList();
    }
    ...
    public List<Long> hExpireAt(
        ...
        return connection
                .invoke()
                .fromMany(
                        RedisHashAsyncCommands::hexpireat, key, unixTime, getExpireArgs(condition), fields)
                .toList();
    }
    ...
    public List<Long> hpExpireAt(
        ...
        return connection
                .invoke()
                .fromMany(
                        RedisHashAsyncCommands::hpexpireat,
                        key,
                        unixTimeInMillis,
                        getExpireArgs(condition),
                        fields)
                .toList();
    }
    ...
    public List<Long> hTtl(byte[] key, TimeUnit timeUnit, byte[]... fields) {
        return connection
                .invoke()
                .fromMany(RedisHashAsyncCommands::httl, key, fields)
        ...
        return new KeyBoundCursor<Entry<byte[], byte[]>>(key, cursorId, options) {
            ...
            protected ScanIteration<Entry<byte[], byte[]>> doScan(
                ...
                MapScanCursor<byte[], byte[]> mapScanCursor =
                        connection.invoke().just(RedisHashAsyncCommands::hscan, key, scanCursor, scanArgs);
