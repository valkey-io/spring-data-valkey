 ...
 *
 * <p>This context provides {@link SerializationPair}s for key, value, hash-key (field), hash-value
 * and {@link String} serialization and deserialization.
 *
 * @author Mark Paluch
...
public interface ValkeySerializationContext<K, V> {
    ...
    /**
     * Creates a new {@link ValkeySerializationContextBuilder} using a given default {@link
     * ValkeySerializer}.
     *
     ...
     */
    static <K, V> ValkeySerializationContextBuilder<K, V> newSerializationContext(
            ValkeySerializer<?> defaultSerializer) {
    ...
    static <K, V> ValkeySerializationContextBuilder<K, V> newSerializationContext(
        ...
        return new DefaultValkeySerializationContext.DefaultValkeySerializationContextBuilder() //
                .key(serializationPair)
                .value(serializationPair) //
                .hashKey(serializationPair)
                .hashValue(serializationPair);
    }

    /**
     * Creates a new {@link ValkeySerializationContext} using a {@link ValkeySerializer#byteArray()
     * byte[]} serialization pair.
     *
    ...
    /**
     * Creates a new {@link ValkeySerializationContext} using a {@link SerializationPair#byteBuffer()
    ...
    /**
     * Creates a new {@link ValkeySerializationContext} using a {@link
    ...
    /**
     * Creates a new {@link ValkeySerializationContext} using a {@link
     * JdkSerializationValkeySerializer} with given {@link ClassLoader} to resolves {@link Class type}
     * of the keys and values stored in Valkey.
     *
     * @param classLoader {@link ClassLoader} used to resolve {@link Class types} of keys and value
     *     stored in Valkey during deserialization; can be {@literal null}.
     * @return a new {@link ValkeySerializationContext} using JDK Serializaton.
     * @since 2.1
     */
     ...
     *
     * @param <T> {@link Class Type} of {@link Object} being de/serialized by the {@link
     *     ValkeySerializer}.
     * @param serializer {@link ValkeySerializer} used to de/serialize keys and value stored in
     *     Valkey; must not be {@literal null}.
     ...
     * @param serializationPair {@link SerializationPair} used to de/serialize keys and values stored
     *     in Valkey; must not be {@literal null}.
    ...
    interface SerializationPair<T> {
        ...
        /**
         * Creates a {@link SerializationPair} adapter given {@link ValkeyElementReader} and {@link
         * ValkeyElementWriter}.
         *
         * @param reader must not be {@literal null}.
         * @param writer must not be {@literal null}.
         * @return a {@link SerializationPair} encapsulating {@link ValkeyElementReader} and {@link
         *     ValkeyElementWriter}.
         */
        static <T> SerializationPair<T> just(
    ...
    interface ValkeySerializationContextBuilder<K, V> {
         ...
         * @return {@literal this} builder.
         */
        default ValkeySerializationContextBuilder<K, V> key(
                ValkeyElementReader<K> reader, ValkeyElementWriter<K> writer) {
         ...
         * @return {@literal this} builder.
         */
        default ValkeySerializationContextBuilder<K, V> value(
                ValkeyElementReader<V> reader, ValkeyElementWriter<V> writer) {
         ...
         * @return {@literal this} builder.
         */
        default ValkeySerializationContextBuilder<K, V> hashKey(
                ValkeyElementReader<?> reader, ValkeyElementWriter<?> writer) {
         ...
         * @return {@literal this} builder.
         */
        default ValkeySerializationContextBuilder<K, V> hashValue(
                ValkeyElementReader<?> reader, ValkeyElementWriter<?> writer) {
         ...
         * @return {@literal this} builder.
         */
        default ValkeySerializationContextBuilder<K, V> string(
                ValkeyElementReader<String> reader, ValkeyElementWriter<String> writer) {
