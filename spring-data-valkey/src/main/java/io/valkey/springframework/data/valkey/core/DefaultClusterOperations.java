 ...
 * @param <V>
 */
class DefaultClusterOperations<K, V> extends AbstractOperations<K, V>
    ...
    <T> T doInCluster(ValkeyClusterCallback<T> callback) {
        ...
        try (ValkeyClusterConnection connection =
                template.getConnectionFactory().getClusterConnection()) {
