...
public interface BoundListOperations<K, V> extends BoundKeyOperations<K> {
     ...
     * argument) of the list stored at the bound key, and pushes the element at the first/last element
    ...
    /**
     * Removes the first {@code count} occurrences of {@code value} from the list stored at the bound
     * key.
     *
     * @param count
     * @param value
