...
/**
 * Reference point for {@code GEOSEARCH} and {@code GEOSEARCHSTORE} commands. Provides factory
 * methods to create {@link GeoReference} from geo-set members or reference points.
 *
 * @param <T>
 * @author Mark Paluch
