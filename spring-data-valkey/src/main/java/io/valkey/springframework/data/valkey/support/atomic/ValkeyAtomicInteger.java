...
/**
 * Atomic integer backed by Valkey. Uses Valkey atomic increment/decrement and watch/multi/exec
 ...
 */
public class ValkeyAtomicInteger extends Number
    ...
    /**
     * Constructs a new {@link ValkeyAtomicInteger} instance. Uses the value existing in Valkey or
    ...
    /**
     * Constructs a new {@link ValkeyAtomicInteger} instance with a {@code initialValue} that
     ...
     */
    public ValkeyAtomicInteger(
            String valkeyCounter, ValkeyConnectionFactory factory, int initialValue) {
    ...
    /**
     * Constructs a new {@link ValkeyAtomicInteger} instance instance with a {@code initialValue} that
     * overwrites the existing value.
     *
     * <p>Note: You need to configure the given {@code template} with appropriate {@link
     * ValkeySerializer} for the key and value.
     *
     * <p>As an alternative one could use the {@link #ValkeyAtomicInteger(String,
     * ValkeyConnectionFactory, Integer)} constructor which uses appropriate default serializers.
     *
     * @param valkeyCounter Valkey key of this counter.
     * @param template the template.
     ...
     */
    public ValkeyAtomicInteger(
            String valkeyCounter, ValkeyOperations<String, Integer> template, int initialValue) {
        this(valkeyCounter, template, Integer.valueOf(initialValue));
    }

    private ValkeyAtomicInteger(
            String valkeyCounter, ValkeyConnectionFactory factory, @Nullable Integer initialValue) {
    ...
    private ValkeyAtomicInteger(
            ...
            ValkeyOperations<String, Integer> template,
    ...
    /**
     * Atomically update the current value using the given {@link IntBinaryOperator accumulator
