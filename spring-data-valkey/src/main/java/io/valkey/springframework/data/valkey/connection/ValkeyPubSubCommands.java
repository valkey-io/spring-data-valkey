...
public interface ValkeyPubSubCommands {
    ...
    /**
     * Returns the current subscription for this connection or null if the connection is not
     * subscribed.
     *
     ...
     * @return the number of clients that received the message or {@literal null} when used in
