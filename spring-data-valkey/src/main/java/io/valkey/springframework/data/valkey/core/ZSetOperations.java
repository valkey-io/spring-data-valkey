...
public interface ZSetOperations<K, V> {
	...
	default Long lexCount(K key, io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Long removeRangeByLex(K key, io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<V> rangeByLex(K key, io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	...
	@Nullable
	@Deprecated(since = "3.0", forRemoval = true)
	default Set<V> reverseRangeByLex(K key, io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
	 ...
	 * between {@link io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range#getMin()} and
	 * {@link io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range#getMax()}.
	 *
	 * @param key must not be {@literal null}.
	 * @param range must not be {@literal null}.
