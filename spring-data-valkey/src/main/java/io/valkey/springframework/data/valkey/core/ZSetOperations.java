...
public interface ZSetOperations<K, V> {
     ...
     */
    @Nullable
    Set<TypedTuple<V>> reverseRangeByScoreWithScores(
    ...
    default Long lexCount(
            K key, io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range range) {
     ...
     */
    @Nullable
    default Set<TypedTuple<V>> intersectWithScores(
     ...
     */
    @Nullable
    Set<TypedTuple<V>> unionWithScores(
            K key, Collection<K> otherKeys, Aggregate aggregate, Weights weights);
     ...
     * ZSET} at {@code key} with a value between {@link
     * io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range#getMin()} and {@link
     * io.valkey.springframework.data.valkey.connection.ValkeyZSetCommands.Range#getMax()}.
     *
     * @param key must not be {@literal null}.
