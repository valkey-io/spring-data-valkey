 ...
 *
 * <p>This {@link CacheManager} creates {@link Cache caches} on first write, by default. Empty
 * {@link Cache caches} are not visible in Valkey due to how Valkey represents empty data
 * structures.
 *
 * <p>{@link Cache Caches} requiring a different {@link ValkeyCacheConfiguration cache
 * configuration} than the {@link ValkeyCacheConfiguration#defaultCacheConfig() default cache
 * configuration} can be specified via {@link
 * ValkeyCacheManagerBuilder#withInitialCacheConfigurations(Map)} or individually using {@link
 * ValkeyCacheManagerBuilder#withCacheConfiguration(String, ValkeyCacheConfiguration)}.
 *
...
public class ValkeyCacheManager extends AbstractTransactionSupportingCacheManager {
     ...
     * and default {@link ValkeyCacheConfiguration}.
     *
     * <p>Allows {@link ValkeyCache cache} creation at runtime.
     *
     * @param cacheWriter {@link ValkeyCacheWriter} used to perform {@link ValkeyCache} operations by
     *     executing appropriate Valkey commands; must not be {@literal null}.
     * @param defaultCacheConfiguration {@link ValkeyCacheConfiguration} applied to new {@link
     *     ValkeyCache Valkey caches} by default when no cache-specific {@link
     *     ValkeyCacheConfiguration} is provided; must not be {@literal null}.
     * @throws IllegalArgumentException if either the given {@link ValkeyCacheWriter} or {@link
     *     ValkeyCacheConfiguration} are {@literal null}.
     * @see io.valkey.springframework.data.valkey.cache.ValkeyCacheConfiguration
     * @see io.valkey.springframework.data.valkey.cache.ValkeyCacheWriter
     */
    public ValkeyCacheManager(
            ValkeyCacheWriter cacheWriter, ValkeyCacheConfiguration defaultCacheConfiguration) {
        this(cacheWriter, defaultCacheConfiguration, DEFAULT_ALLOW_RUNTIME_CACHE_CREATION);
    }

    /**
     * Creates a new {@link ValkeyCacheManager} initialized with the given {@link ValkeyCacheWriter}
     * and default {@link ValkeyCacheConfiguration} along with whether to allow cache creation at
     * runtime.
     *
     * @param cacheWriter {@link ValkeyCacheWriter} used to perform {@link ValkeyCache} operations by
     *     executing appropriate Valkey commands; must not be {@literal null}.
     ...
     *     ValkeyCache Valkey caches} by default when no cache-specific {@link
     *     ValkeyCacheConfiguration} is provided; must not be {@literal null}.
     * @param allowRuntimeCacheCreation boolean specifying whether to allow creation of undeclared
     *     caches at runtime; {@literal true} by default. Maybe just use {@link
     ...
     * @since 2.0.4
     */
    private ValkeyCacheManager(
            ValkeyCacheWriter cacheWriter,
            ValkeyCacheConfiguration defaultCacheConfiguration,
    ...
    /**
     * Creates a new {@link ValkeyCacheManager} initialized with the given {@link ValkeyCacheWriter}
     * and a default {@link ValkeyCacheConfiguration} along with an optional, initial set of {@link
     * String cache names} used to create {@link ValkeyCache Valkey caches} on startup.
     *
     * <p>Allows {@link ValkeyCache cache} creation at runtime.
     *
     * @param cacheWriter {@link ValkeyCacheWriter} used to perform {@link ValkeyCache} operations by
     ...
     *     ValkeyCache Valkey caches} by default when no cache-specific {@link
     *     ValkeyCacheConfiguration} is provided; must not be {@literal null}.
     * @param initialCacheNames optional set of {@link String cache names} used to create {@link
     *     ValkeyCache Valkey caches} on startup. The default {@link ValkeyCacheConfiguration} will be
     *     applied to each cache.
     * @throws IllegalArgumentException if either the given {@link ValkeyCacheWriter} or {@link
     *     ValkeyCacheConfiguration} are {@literal null}.
     * @see io.valkey.springframework.data.valkey.cache.ValkeyCacheConfiguration
     * @see io.valkey.springframework.data.valkey.cache.ValkeyCacheWriter
     ...
     * runtime.
     *
     * <p>Additionally, the optional, initial set of {@link String cache names} will be used to create
    ...
    /**
     * Creates new {@link ValkeyCacheManager} using given {@link ValkeyCacheWriter} and default {@link
     * ValkeyCacheConfiguration}.
     *
     * <p>Additionally, an initial {@link ValkeyCache} will be created and configured using the
     * associated {@link ValkeyCacheConfiguration} for each {@link String named} {@link ValkeyCache}
     ...
     *     ValkeyCache Valkey caches} by default when no cache-specific {@link
     *     ValkeyCacheConfiguration} is provided; must not be {@literal null}.
     * @param initialCacheConfigurations {@link Map} of declared, known {@link String cache names}
     *     along with associated {@link ValkeyCacheConfiguration} used to create and configure {@link
     *     ValkeyCache Reds caches} on startup; must not be {@literal null}.
     * @throws IllegalArgumentException if either the given {@link ValkeyCacheWriter} or {@link
     *     ValkeyCacheConfiguration} are {@literal null}.
     * @see io.valkey.springframework.data.valkey.cache.ValkeyCacheConfiguration
     * @see io.valkey.springframework.data.valkey.cache.ValkeyCacheWriter
    ...
    /**
     * Creates a new {@link ValkeyCacheManager} initialized with the given {@link ValkeyCacheWriter}
     * and a default {@link ValkeyCacheConfiguration}, and whether to allow {@link ValkeyCache}
     * creation at runtime.
     *
     * <p>Additionally, an initial {@link ValkeyCache} will be created and configured using the
     * associated {@link ValkeyCacheConfiguration} for each {@link String named} {@link ValkeyCache}
     ...
     *     ValkeyCacheConfiguration#defaultCacheConfig()}.
     * @param initialCacheConfigurations {@link Map} of declared, known {@link String cache names}
     *     along with the associated {@link ValkeyCacheConfiguration} used to create and configure
     *     {@link ValkeyCache Valkey caches} on startup; must not be {@literal null}.
     * @throws IllegalArgumentException if either the given {@link ValkeyCacheWriter} or {@link
     *     ValkeyCacheConfiguration} are {@literal null}.
     * @see io.valkey.springframework.data.valkey.cache.ValkeyCacheConfiguration
     * @see io.valkey.springframework.data.valkey.cache.ValkeyCacheWriter
    ...
    /**
     * @deprecated since 3.2. Use {@link ValkeyCacheManager#ValkeyCacheManager(ValkeyCacheWriter,
     *     ValkeyCacheConfiguration, boolean, Map)} instead.
     */
    ...
    /**
     * Factory method returning a {@literal Builder} used to construct and configure a {@link
     * ValkeyCacheManager}.
     *
    ...
    /**
     * Factory method returning a {@literal Builder} used to construct and configure a {@link
     * ValkeyCacheManager} initialized with the given {@link ValkeyCacheWriter}.
     *
     * @param cacheWriter {@link ValkeyCacheWriter} used to perform {@link ValkeyCache} operations by
     *     executing appropriate Valkey commands; must not be {@literal null}.
     * @return new {@link ValkeyCacheManagerBuilder}.
    ...
    /**
     * Factory method returning a {@literal Builder} used to construct and configure a {@link
     * ValkeyCacheManager} initialized with the given {@link ValkeyConnectionFactory}.
     *
     * @param connectionFactory {@link ValkeyConnectionFactory} used by the {@link ValkeyCacheManager}
     *     to acquire connections to Valkey when performing {@link ValkeyCache} operations; must not
     *     be {@literal null}.
     * @return new {@link ValkeyCacheManagerBuilder}.
     * @throws IllegalArgumentException if the given {@link ValkeyConnectionFactory} is {@literal
     *     null}.
     * @see io.valkey.springframework.data.valkey.connection.ValkeyConnectionFactory
     */
     ...
     * {@link ValkeyConnectionFactory} and using {@link ValkeyCacheConfiguration#defaultCacheConfig()
     ...
     *   <dd>disabled
     *   <dt>batch strategy
     *   <dd>{@link BatchStrategies#keys()}
     *   <dt>cache configuration
     *   <dd>{@link ValkeyCacheConfiguration#defaultCacheConfig()}
     *   <dt>initial caches
     *   <dd>none
     ...
     *
     * @return a boolean value indicating whether {@link ValkeyCache Valkey caches} are allowed to be
     *     created at runtime.
     */
    ...
    /**
     * Return an {@link Collections#unmodifiableMap(Map) unmodifiable Map} containing {@link String
     * caches name} mapped to the {@link ValkeyCache} {@link ValkeyCacheConfiguration configuration}.
     *
     * @return unmodifiable {@link Map} containing {@link String cache name} / {@link
     *     ValkeyCacheConfiguration configuration} pairs.
     */
    public Map<String, ValkeyCacheConfiguration> getCacheConfigurations() {

        Map<String, ValkeyCacheConfiguration> cacheConfigurationMap =
                ...
                .forEach(
                        cacheName -> {
                            ...
                            ValkeyCacheConfiguration cacheConfiguration =
                                    cache != null ? cache.getCacheConfiguration() : null;
    ...
    /**
     * Gets the default {@link ValkeyCacheConfiguration} applied to new {@link ValkeyCache} instances
     * on creation when custom, non-specific {@link ValkeyCacheConfiguration} was not provided.
     *
    ...
    /**
     * Gets a {@link Map} of {@link String cache names} to {@link ValkeyCacheConfiguration} objects as
     * the initial set of {@link ValkeyCache Valkey caches} to create on startup.
     *
     * @return a {@link Map} of {@link String cache names} to {@link ValkeyCacheConfiguration}
     *     objects.
     */
    ...
    /**
     * Returns a reference to the configured {@link ValkeyCacheWriter} used to perform {@link
     * ValkeyCache} operations, such as reading from and writing to the cache.
     *
    ...
    protected ValkeyCache getMissingCache(String name) {
        return isAllowRuntimeCacheCreation()
                ? createValkeyCache(name, getDefaultCacheConfiguration())
                : null;
    }

    /**
     * Creates a new {@link ValkeyCache} with given {@link String name} and {@link
     * ValkeyCacheConfiguration}.
     *
     * @param name {@link String name} for the {@link ValkeyCache}; must not be {@literal null}.
     * @param cacheConfiguration {@link ValkeyCacheConfiguration} used to configure the {@link
     *     ValkeyCache}; resolves to the {@link #getDefaultCacheConfiguration()} if {@literal null}.
     * @return a new {@link ValkeyCache} instance; never {@literal null}.
     */
    protected ValkeyCache createValkeyCache(
            String name, @Nullable ValkeyCacheConfiguration cacheConfiguration) {
    ...
    protected Collection<ValkeyCache> loadCaches() {
        ...
        return getInitialCacheConfiguration().entrySet().stream()
                .map(entry -> createValkeyCache(entry.getKey(), entry.getValue()))
                .toList();
    }

    private ValkeyCacheConfiguration resolveCacheConfiguration(
            @Nullable ValkeyCacheConfiguration cacheConfiguration) {
    ...
    public static class ValkeyCacheManagerBuilder {
        ...
        /**
         * Factory method returning a new {@literal Builder} used to create and configure a {@link
         * ValkeyCacheManager} using the given {@link ValkeyCacheWriter}.
         *
        ...
        /**
         * Factory method returning a new {@literal Builder} used to create and configure a {@link
         * ValkeyCacheManager} using the given {@link ValkeyConnectionFactory}.
         *
         * @param connectionFactory {@link ValkeyConnectionFactory} used by the {@link
         *     ValkeyCacheManager} to acquire connections to Valkey when performing {@link ValkeyCache}
         *     operations; must not be {@literal null}.
         * @return new {@link ValkeyCacheManagerBuilder}.
         * @throws IllegalArgumentException if the given {@link ValkeyConnectionFactory} is {@literal
         *     null}.
         * @see io.valkey.springframework.data.valkey.connection.ValkeyConnectionFactory
         */
        public static ValkeyCacheManagerBuilder fromConnectionFactory(
        ...
        private ValkeyCacheConfiguration defaultCacheConfiguration =
                ValkeyCacheConfiguration.defaultCacheConfig();
         ...
         *
         * <p>{@link ValkeyCacheManager#getMissingCache(String)} returns {@literal null} for any
         * non-configured, undeclared {@link Cache} instead of a new {@link ValkeyCache} instance. This
         * allows the {@link org.springframework.cache.support.CompositeCacheManager} to participate.
         *
         * @return this {@link ValkeyCacheManagerBuilder}.
        ...
        /**
         * Define a default {@link ValkeyCacheConfiguration} applied to dynamically created {@link
         * ValkeyCache}s.
         *
         * @param defaultCacheConfiguration must not be {@literal null}.
         * @return this {@link ValkeyCacheManagerBuilder}.
         */
        public ValkeyCacheManagerBuilder cacheDefaults(
                ValkeyCacheConfiguration defaultCacheConfiguration) {
         ...
         * ValkeyCacheConfiguration}. <strong>NOTE:</strong> This calls depends on {@link
         * #cacheDefaults(ValkeyCacheConfiguration)} using whatever default {@link
         * ValkeyCacheConfiguration} is present at the time of invoking this method.
         *
        ...
        /**
         * Enable {@link ValkeyCache}s to synchronize cache put/evict operations with ongoing
        ...
        /**
         * Registers the given {@link String cache name} and {@link ValkeyCacheConfiguration} used to
         * create and configure a {@link ValkeyCache} on startup.
         *
         * @param cacheName {@link String name} of the cache to register for creation on startup.
         * @param cacheConfiguration {@link ValkeyCacheConfiguration} used to configure the new cache on
         *     startup.
         * @return this {@link ValkeyCacheManagerBuilder}.
         * @since 2.2
         */
        public ValkeyCacheManagerBuilder withCacheConfiguration(
                String cacheName, ValkeyCacheConfiguration cacheConfiguration) {
        ...
        /**
         * Append a {@link Map} of cache name/{@link ValkeyCacheConfiguration} pairs to be pre
         * initialized.
         *
            ...
            cacheConfigurations.forEach(
                    (cacheName, configuration) ->
                            Assert.notNull(
                                    configuration,
                                    String.format(
                                            "ValkeyCacheConfiguration for cache %s must not be null!", cacheName)));
         ...
         * @return {@link Optional#empty()} if no {@link ValkeyCacheConfiguration} set for the given
         *     cache name.
         * @since 2.2
         */
         ...
         * ValkeyCacheConfiguration configuration}.
         *
         * @return an unmodifiable {@link Set} holding the name of caches for which a {@link
         *     ValkeyCacheConfiguration configuration} has been set.
         * @since 2.2
         */
        ...
        public ValkeyCacheManager build() {
            ...
            Assert.state(
                    cacheWriter != null,
                    "CacheWriter must not be null; You can provide one via"
                            + " 'ValkeyCacheManagerBuilder#cacheWriter(ValkeyCacheWriter)'");

            ValkeyCacheWriter resolvedCacheWriter =
                    !CacheStatisticsCollector.none().equals(this.statisticsCollector)
        ...
        private ValkeyCacheManager newValkeyCacheManager(ValkeyCacheWriter cacheWriter) {
            return new ValkeyCacheManager(
                    cacheWriter, cacheDefaults(), this.allowRuntimeCacheCreation, this.initialCaches);
        }
    }
}
