...
/**
 * {@link ValkeySerializer} that can read and write JSON using <a
 ...
 *
 * <p>This serializer can be used to bind to typed beans, or untyped {@link java.util.HashMap
 * HashMap} instances. <b>Note:</b>Null objects are serialized as empty arrays and vice versa.
 *
 * <p>JSON reading and writing can be customized by configuring {@link JacksonObjectReader}
 * respective {@link JacksonObjectWriter}.
 *
...
public class Jackson2JsonValkeySerializer<T> implements ValkeySerializer<T> {
     ...
     * @since 3.0
     */
    public Jackson2JsonValkeySerializer(
            ObjectMapper mapper,
            JavaType javaType,
     ...
     *
     * @deprecated since 3.0, use {@link #Jackson2JsonValkeySerializer(ObjectMapper, Class)
     *     constructor creation} to configure the object mapper.
     */
    @Deprecated(since = "3.0", forRemoval = true)
     ...
     *
     * <p>Default implementation returns {@link TypeFactory#constructType(java.lang.reflect.Type)},
