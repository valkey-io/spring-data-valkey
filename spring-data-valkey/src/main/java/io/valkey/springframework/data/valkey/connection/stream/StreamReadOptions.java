...
public class StreamReadOptions {
    ...
    /**
     * Enable auto-acknowledgement by setting the {@code NOACK} flag when reading in the context of a
     * consumer group. This method is an alias for {@link #autoAcknowledge()} for readability reasons.
     *
    ...
    /**
     * Enable auto-acknowledgement by setting the {@code NOACK} flag when reading in the context of a
     * consumer group. This method is an alias for {@link #noack()} for readability reasons.
     *
    ...
    /**
     * Use a blocking read and supply the {@link Duration timeout} after which the call will terminate
     * if no message was read.
     *
    ...
    public boolean equals(@Nullable Object o) {
        ...
        if (noack != that.noack) return false;
