...
/**
 * Atomic long backed by Valkey. Uses Valkey atomic increment/decrement and watch/multi/exec
...
public class ValkeyAtomicLong extends Number implements Serializable, BoundKeyOperations<String> {
    ...
    /**
     * Constructs a new {@link ValkeyAtomicLong} instance. Uses the value existing in Valkey or {@code
     * 0} if none is found.
     *
    ...
    /**
     * Constructs a new {@link ValkeyAtomicLong} instance with a {@code initialValue} that overwrites
     * the existing value at {@code valkeyCounter}.
     *
     * @param valkeyCounter Valkey key of this counter.
     * @param factory connection factory.
     * @param initialValue initial value to set.
     */
    public ValkeyAtomicLong(
            String valkeyCounter, ValkeyConnectionFactory factory, long initialValue) {
        this(valkeyCounter, factory, Long.valueOf(initialValue));
    }

    private ValkeyAtomicLong(
            String valkeyCounter, ValkeyConnectionFactory factory, @Nullable Long initialValue) {
     ...
     * ValkeySerializer} for the key and value. The key serializer must be able to deserialize to a
     * {@link String} and the value serializer must be able to deserialize to a {@link Long}.
     *
     * <p>As an alternative one could use the {@link #ValkeyAtomicLong(String,
     * ValkeyConnectionFactory, Long)} constructor which uses appropriate default serializers, in this
     * case {@link StringValkeySerializer} for the key and {@link GenericToStringSerializer} for the
     * value.
     *
     * @param valkeyCounter Valkey key of this counter.
     * @param template the template
     ...
     */
    public ValkeyAtomicLong(
            String valkeyCounter, ValkeyOperations<String, Long> template, long initialValue) {
        this(valkeyCounter, template, Long.valueOf(initialValue));
    }

    private ValkeyAtomicLong(
            String valkeyCounter, ValkeyOperations<String, Long> template, @Nullable Long initialValue) {
    ...
    /**
     * Atomically update the current value using the given {@link LongBinaryOperator accumulator
