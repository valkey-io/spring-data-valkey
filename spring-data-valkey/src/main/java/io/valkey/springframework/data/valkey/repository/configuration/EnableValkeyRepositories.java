...
/**
 * Annotation to activate Valkey repositories. If no base package is configured through either
 * {@link #value()}, {@link #basePackages()} or {@link #basePackageClasses()} it will trigger
...
public @interface EnableValkeyRepositories {
     ...
     * declarations e.g.: {@code @EnableValkeyRepositories("org.my.pkg")} instead of
     ...
     *
     * @return the {@link BeanNameGenerator} to be used or the base {@link BeanNameGenerator}
     *     interface to indicate context default.
     * @since 3.4
     */
    ...
    /**
     * Configures the bean name of the {@link ValkeyOperations} to be used. Defaulted to {@literal
     * valkeyTemplate}.
     *
     * @return
     */
     ...
     * @return
     */
    Class<? extends KeyspaceConfiguration> keyspaceConfiguration() default
            KeyspaceConfiguration.class;
    ...
    /**
     * Configure the name of the {@link
     * io.valkey.springframework.data.valkey.listener.ValkeyMessageListenerContainer} bean to be used
     * for keyspace event subscriptions. Defaults to use an anonymous managed instance by {@link
     ...
     * read them later when publishing {@link
     * io.valkey.springframework.data.valkey.core.ValkeyKeyspaceEvent keyspace events}.
     *
     * @return
     * @since 2.4
     */
