...
public @interface EnableValkeyRepositories {
	...
	/**
	 * Configure the name of the {@link io.valkey.springframework.data.valkey.listener.ValkeyMessageListenerContainer} bean to be
	 * used for keyspace event subscriptions. Defaults to use an anonymous managed instance by
	 * {@link io.valkey.springframework.data.valkey.core.ValkeyKeyValueAdapter}.
	 *
	 * @return
	 * @since 2.7.2
	 */
	 ...
	 * publishing {@link io.valkey.springframework.data.valkey.core.ValkeyKeyspaceEvent keyspace events}.
	 *
	 * @return
	 * @since 2.4
	 */
