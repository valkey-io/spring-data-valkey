...
/**
 * The actual {@code BITFIELD} command representation holding several {@link BitFieldSubCommand}s to
 * execute.
 *
...
public class BitFieldSubCommands implements Iterable<BitFieldSubCommand> {
    ...
    /**
     * Obtain a new {@link BitFieldGetBuilder} for creating and adding a {@link BitFieldGet} sub
     * command.
     *
    ...
    /**
     * Obtain a new {@link BitFieldSetBuilder} for creating and adding a {@link BitFieldSet} sub
     * command.
     *
     * @param type must not be {@literal null}.
     * @return
    ...
    /**
     * Obtain a new {@link BitFieldIncrByBuilder} for creating and adding a {@link BitFieldIncrBy} sub
     * command.
     *
     * @param type must not be {@literal null}.
     * @return
    ...
    public class BitFieldIncrByBuilder {
        ...
        /**
         * Set the {@link BitFieldIncrBy.Overflow} to be used for this and any subsequent {@link
         * BitFieldIncrBy} commands.
         *
         * @param overflow
         * @return
         */
    ...
    /**
     * Offset used inside a {@link BitFieldSubCommand}. Can be zero or type based. See <a
     * href="https://valkey.io/commands/bitfield#bits-and-positional-offsets">Bits and positional
     * offsets</a> in the Valkey reference.
     *
     * @author Christoph Strobl
     * @author Mark Paluch
     * @since 2.1
    ...
    public static class BitFieldIncrBy extends AbstractBitFieldSubCommand {
         ...
         * @return
         */
        public static BitFieldIncrBy create(
                BitFieldType type, Offset offset, long value, @Nullable Overflow overflow) {
