...
public interface BoundSetOperations<K, V> extends BoundKeyOperations<K> {
     ...
     * @deprecated since 3.0, use {@link #difference(Object)} instead to follow a consistent method
     *     naming scheme.
     */
    @Nullable
     ...
     * @return {@literal null} when used in pipeline / transaction.
     * @see <a href="https://valkey.io/commands/sdiff">Valkey Documentation: SDIFF</a>
     * @deprecated since 3.0, use {@link #difference(Collection)} instead to follow a consistent
     ...
     * @deprecated since 3.0, use {@link #differenceAndStore(Object, Object)} instead to follow a
     *     consistent method naming scheme..
     */
    @Deprecated
     ...
     * @param destKey must not be {@literal null}.
     * @see <a href="https://valkey.io/commands/sdiffstore">Valkey Documentation: SDIFFSTORE</a>
     * @deprecated since 3.0, use {@link #differenceAndStore(Collection, Object)} instead to follow a
     *     consistent method naming scheme.
     */
    @Deprecated
