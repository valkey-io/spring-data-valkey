...
/**
 * A {@link ValkeyListenerEndpoint} providing the method invocation mechanism for a specific bean method.
 *
 ...
 */
public class MethodValkeyListenerEndpoint extends AbstractValkeyListenerEndpoint {
	...
	public MethodValkeyListenerEndpoint(Object bean, Method method) {
		this.bean = bean;
		this.method = method;
	}
