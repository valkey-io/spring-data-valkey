...
public class StreamRecords {
    ...
    public static class RecordBuilder<S> {
        ...
        /**
         * Configure a record Id given a {@link String}. Associates a user-supplied record id instead of
         * using server-generated record Id's.
         *
        ...
        /**
         * Configure a {@link RecordId}. Associates a user-supplied record id instead of using
        ...
        public ByteBufferRecord ofBuffer(Map<ByteBuffer, ByteBuffer> value) {
            ...
            if (stream instanceof ByteBuffer) {
                ...
                throw new IllegalArgumentException(
                        "Stream key %s cannot be converted to byte buffer".formatted(stream));
            }
    ...
    static class ByteMapBackedRecord extends MapBackedRecord<byte[], byte[], byte[]>
    ...
    static class ByteBufferMapBackedRecord extends MapBackedRecord<ByteBuffer, ByteBuffer, ByteBuffer>
        ...
        ByteBufferMapBackedRecord(
                @Nullable ByteBuffer stream, @Nullable RecordId recordId, Map<ByteBuffer, ByteBuffer> map) {
            super(stream, recordId, map);
        }
    ...
    static class StringMapBackedRecord extends MapBackedRecord<String, String, String>
            implements StringRecord {

        StringMapBackedRecord(
                @Nullable String stream, @Nullable RecordId recordId, Map<String, String> stringStringMap) {
