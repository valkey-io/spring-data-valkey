...
/**
 * {@link IndexResolver} extracts secondary index structures to be applied on a given path, {@link
 * PersistentProperty} and value.
 *
...
public interface IndexResolver {
     ...
     * @return never {@literal null}.
     */
    Set<IndexedData> resolveIndexesFor(
            String keyspace, String path, TypeInformation<?> typeInformation, @Nullable Object value);
}
