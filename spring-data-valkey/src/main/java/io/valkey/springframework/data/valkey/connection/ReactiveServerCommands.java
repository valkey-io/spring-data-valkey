...
public interface ReactiveServerCommands {
     ...
     *
     * @return {@link Mono} indicating command received by server. Operation success needs to be
     *     checked via {@link #lastSave()}.
     ...
     * @throws IllegalArgumentException when {@code pattern} / {@code value} is {@literal null} or
     *     {@literal empty}.
