    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<MapRecord<String, Object, Object>> records =
                    template.opsForStream().range(streamKey, Range.unbounded());
            records.forEach(
                    record -> {
            ...
            records =
                    template.opsForStream().range(streamKey, Range.closed(id1.getValue(), id2.getValue()));
            records.forEach(
                    record -> {
            ...
            @SuppressWarnings("unchecked")
            List<MapRecord<String, Object, Object>> groupRecords =
                    template
                            .opsForStream()
                            .read(
