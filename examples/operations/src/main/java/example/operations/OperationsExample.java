...
public class OperationsExample {
    ...
    public static void main(String[] args) {
        ...
        AnnotationConfigApplicationContext context =
                new AnnotationConfigApplicationContext(OperationsExample.class);
        ...
        template
                .opsForStream()
                .add("mystream", java.util.Map.of("sensor", "temperature", "value", "23.5"));
        ...
        template.delete(
                Arrays.asList(
                        "mylist", "myset", "myhash", "leaderboard", "locations", "visitors", "mystream"));
