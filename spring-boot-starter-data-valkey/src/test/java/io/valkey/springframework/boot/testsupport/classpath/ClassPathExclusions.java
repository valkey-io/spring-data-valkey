...
public @interface ClassPathExclusions {
     ...
     *
     * <p>One or more Ant-style patterns that identify entries to be excluded from the class path.
     * Matching is performed against an entry's {@link File#getName() file name}. For example, to
     * exclude Hibernate Validator from the classpath, {@code "hibernate-validator-*.jar"} can be
     * used.
     *
