...
class ValkeyUrlSyntaxFailureAnalyzerTests {
    ...
    void analyzeInvalidUrlSyntax() {
        ...
        assertThat(analysis.getAction())
                .contains("Review the value of the property 'spring.data.valkey.url'");
    }

    @Test
    void analyzeValkeyHttpUrl() {
        ValkeyUrlSyntaxException exception =
                new ValkeyUrlSyntaxException("http://127.0.0.1:26379/mymaster");
        FailureAnalysis analysis = new ValkeyUrlSyntaxFailureAnalyzer().analyze(exception);
        assertThat(analysis.getDescription())
                .contains("The URL 'http://127.0.0.1:26379/mymaster' is not valid")
                .contains("The scheme 'http' is not supported");
        assertThat(analysis.getAction())
                .contains("Use the scheme 'valkey://' for insecure or 'valkeys://' for secure");
    }

    @Test
    void analyzeValkeySentinelUrl() {
        ValkeyUrlSyntaxException exception =
                new ValkeyUrlSyntaxException(
                        "valkey-sentinel://username:password@127.0.0.1:26379,127.0.0.1:26380/mymaster");
        FailureAnalysis analysis = new ValkeyUrlSyntaxFailureAnalyzer().analyze(exception);
        assertThat(analysis.getDescription())
                .contains(
                        "The URL 'valkey-sentinel://username:password@127.0.0.1:26379,127.0.0.1:26380/mymaster'"
                                + " is not valid")
    ...
    void analyzeValkeySocketUrl() {
        ValkeyUrlSyntaxException exception =
                new ValkeyUrlSyntaxException("valkey-socket:///valkey/valkey.sock");
        FailureAnalysis analysis = new ValkeyUrlSyntaxFailureAnalyzer().analyze(exception);
        assertThat(analysis.getDescription())
                .contains("The URL 'valkey-socket:///valkey/valkey.sock' is not valid")
                .contains("The scheme 'valkey-socket' is not supported");
        assertThat(analysis.getAction())
                .contains("Configure the appropriate Spring Data Valkey connection beans");
    }
}
