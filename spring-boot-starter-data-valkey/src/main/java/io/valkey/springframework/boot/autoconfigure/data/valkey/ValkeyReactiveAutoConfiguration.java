...
/**
 * {@link EnableAutoConfiguration Auto-configuration} for Spring Data's reactive Valkey support.
 *
 * @author Mark Paluch
...
@ConditionalOnClass({
    ReactiveValkeyConnectionFactory.class,
    ReactiveValkeyTemplate.class,
    Flux.class
})
public class ValkeyReactiveAutoConfiguration {
    ...
    public ReactiveValkeyTemplate<Object, Object> reactiveValkeyTemplate(
        ...
        ValkeySerializer<Object> javaSerializer =
                ValkeySerializer.java(resourceLoader.getClassLoader());
        ValkeySerializationContext<Object, Object> serializationContext =
