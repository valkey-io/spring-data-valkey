...
/**
 * {@link ContainerConnectionDetailsFactory} to create {@link ValkeyConnectionDetails} from a {@link
 * ServiceConnection @ServiceConnection}-annotated {@link GenericContainer} using the {@code
 * "valkey"} image.
 *
...
class ValkeyContainerConnectionDetailsFactory
    ...
    @Override
    protected ValkeyConnectionDetails getContainerConnectionDetails(
    ...
    private static final class ValkeyContainerConnectionDetails
            extends ContainerConnectionDetails<Container<?>> implements ValkeyConnectionDetails {
        ...
        public Standalone getStandalone() {
            return Standalone.of(
                    ...
                    getContainer().getMappedPort(VALKEY_PORT),
                    super.getSslBundle());
        }
    }
}
