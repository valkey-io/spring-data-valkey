 ...
 * @since 1.0.0
 */
@ConfigurationProperties("spring.data.valkey")
public class ValkeyProperties {
    ...
    public static class Pool {
        ...
        /**
         * Whether to enable the pool. Enabled automatically if "commons-pool2" is available. With
         * Jedis, pooling is implicitly enabled in sentinel mode and this setting only applies to single
         * node setup.
         */
         ...
         * has an effect if both it and time between eviction runs are positive.
         */
        ...
        /**
         * Time between runs of the idle object evictor thread. When positive, the idle object evictor
         * thread starts, otherwise no idle object eviction is performed.
         */
    ...
    public static class Cluster {
        ...
        /**
         * List of "host:port" pairs to bootstrap from. This represents an "initial" list of cluster
    ...
    public static class Ssl {
        ...
        /**
         * Whether to enable SSL support. Enabled automatically if "bundle" is provided unless specified
         * otherwise.
         */
        private Boolean enabled;
    ...
    public static class Lettuce {
        ...
        public static class Cluster {
            ...
            public static class Refresh {
                ...
                /**
                 * Whether to discover and query all cluster nodes for obtaining the cluster topology. When
                 * set to false, only the initial seed nodes are used as sources for topology discovery.
                 */
     ...
     *
     * <p>Note: BackoffStrategy (reconnect strategy) is not supported via properties. Use a
     * ValkeyGlideClientConfigurationBuilderCustomizer bean for advanced configuration.
     */
