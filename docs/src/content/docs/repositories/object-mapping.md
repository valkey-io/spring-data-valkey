...
description: Spring Data object mapping fundamentals including object creation, property population, and Kotlin support
---
...
2. If the type is a Kotlin data class the primary constructor is used.
...
In all other cases you can exclude synthetic fields for delegated properties by annotating the property with `@Transient`.
:::
