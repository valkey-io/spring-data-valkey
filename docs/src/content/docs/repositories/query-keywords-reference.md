...
description: Reference guide for supported query method keywords, reserved methods, and predicate modifiers
---
...
See also "[Defining Query Methods](/repositories/query-methods-details#reserved-method-names)".
