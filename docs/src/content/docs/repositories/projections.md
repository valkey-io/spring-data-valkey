---
title: Projections
description: Spring Data projections including interface-based, class-based, and dynamic projections
---
...
:::note
When using [Class-based projection](#class-based-projections-dtos), types must declare a single constructor so that Spring Data can determine their input properties.
