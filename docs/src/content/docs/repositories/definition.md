...
description: Guide to defining repository interfaces including fine-tuning, multiple Spring Data modules, and configuration
---
...
The [base package in XML-based configuration](/repositories/create-instances#xml-configuration) is mandatory.
