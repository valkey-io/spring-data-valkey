			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Publishing Messages', slug: 'valkey/pubsub-sending' },
						{ label: 'Receiving Messages', slug: 'valkey/pubsub-receiving' },
						{ label: 'Annotation-driven Listeners', slug: 'valkey/pubsub-annotated' },
